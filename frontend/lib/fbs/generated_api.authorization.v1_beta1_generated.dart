...
library api.authorization.v1_beta1;

import 'dart:typed_data' show Uint8List;
import 'package:flat_buffers/flat_buffers.dart' as fb;

import './generated_api.authorization.v1_beta1.subject_access_review_spec__generated.dart' as api_authorization_v1_beta1_subject_access_review_spec_;
...
class SubjectAccessReviewSpec {
  ...
  List<String>? get group => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 10);
  List<api_authorization_v1_beta1_subject_access_review_spec_.ExtraEntry>? get extra => const fb.ListReader<api_authorization_v1_beta1_subject_access_review_spec_.ExtraEntry>(api_authorization_v1_beta1_subject_access_review_spec_.ExtraEntry.reader).vTableGetNullable(_bc, _bcOffset, 12);
  String? get uid => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 14);

  @override
  String toString() {
    return 'SubjectAccessReviewSpec{resourceAttributes: ${resourceAttributes}, nonResourceAttributes: ${nonResourceAttributes}, user: ${user}, group: ${group}, extra: ${extra}, uid: ${uid}}';
  }
}
...
class SubjectAccessReviewSpecObjectBuilder extends fb.ObjectBuilder {
  ...
  final List<api_authorization_v1_beta1_subject_access_review_spec_.ExtraEntryObjectBuilder>? _extra;
  final String? _uid;
  ...
  SubjectAccessReviewSpecObjectBuilder({
    ...
    String? user,
    List<String>? group,
    List<api_authorization_v1_beta1_subject_access_review_spec_.ExtraEntryObjectBuilder>? extra,
    String? uid,
  })
      : _resourceAttributes = resourceAttributes,
        _nonResourceAttributes = nonResourceAttributes,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? groupOffset = _group == null ? null
        : fbBuilder.writeList(_group!.map(fbBuilder.writeString).toList());
