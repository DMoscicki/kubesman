...
library api.core.v1.csipersistent_volume_source_;
...
class VolumeAttributesEntry {
  VolumeAttributesEntry._(this._bc, this._bcOffset);
  factory VolumeAttributesEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<VolumeAttributesEntry> reader = _VolumeAttributesEntryReader();
  ...
  @override
  String toString() {
    return 'VolumeAttributesEntry{key: ${key}, value: ${value}}';
  }
}

class _VolumeAttributesEntryReader extends fb.TableReader<VolumeAttributesEntry> {
  const _VolumeAttributesEntryReader();

  @override
  VolumeAttributesEntry createObject(fb.BufferContext bc, int offset) => 
    VolumeAttributesEntry._(bc, offset);
}

class VolumeAttributesEntryBuilder {
  VolumeAttributesEntryBuilder(this.fbBuilder);
...
class VolumeAttributesEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final String? _value;

  VolumeAttributesEntryObjectBuilder({
    String? key,
    String? value,
  })
      : _key = key,
