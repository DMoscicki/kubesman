...
library api.core.v1.flex_persistent_volume_source_;
...
class OptionsEntry {
  OptionsEntry._(this._bc, this._bcOffset);
  factory OptionsEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OptionsEntry> reader = _OptionsEntryReader();
  ...
  @override
  String toString() {
    return 'OptionsEntry{key: ${key}, value: ${value}}';
  }
}

class _OptionsEntryReader extends fb.TableReader<OptionsEntry> {
  const _OptionsEntryReader();

  @override
  OptionsEntry createObject(fb.BufferContext bc, int offset) => 
    OptionsEntry._(bc, offset);
}

class OptionsEntryBuilder {
  OptionsEntryBuilder(this.fbBuilder);
...
class OptionsEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final String? _value;

  OptionsEntryObjectBuilder({
    String? key,
    String? value,
  })
      : _key = key,
