...
library api.core.v1.persistent_volume_claim_status_;
...
class CapacityEntry {
  CapacityEntry._(this._bc, this._bcOffset);
  factory CapacityEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CapacityEntry> reader = _CapacityEntryReader();
  ...
  @override
  String toString() {
    return 'CapacityEntry{key: ${key}, value: ${value}}';
  }
}

class _CapacityEntryReader extends fb.TableReader<CapacityEntry> {
  const _CapacityEntryReader();

  @override
  CapacityEntry createObject(fb.BufferContext bc, int offset) => 
    CapacityEntry._(bc, offset);
}

class CapacityEntryBuilder {
  CapacityEntryBuilder(this.fbBuilder);
...
class CapacityEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final apimachinery_pkg_api_resource.QuantityObjectBuilder? _value;

  CapacityEntryObjectBuilder({
    String? key,
...
class AllocatedResourcesEntry {
  AllocatedResourcesEntry._(this._bc, this._bcOffset);
  factory AllocatedResourcesEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AllocatedResourcesEntry> reader = _AllocatedResourcesEntryReader();
  ...
  @override
  String toString() {
    return 'AllocatedResourcesEntry{key: ${key}, value: ${value}}';
  }
}

class _AllocatedResourcesEntryReader extends fb.TableReader<AllocatedResourcesEntry> {
  const _AllocatedResourcesEntryReader();

  @override
  AllocatedResourcesEntry createObject(fb.BufferContext bc, int offset) => 
    AllocatedResourcesEntry._(bc, offset);
}

class AllocatedResourcesEntryBuilder {
  AllocatedResourcesEntryBuilder(this.fbBuilder);
...
class AllocatedResourcesEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final apimachinery_pkg_api_resource.QuantityObjectBuilder? _value;

  AllocatedResourcesEntryObjectBuilder({
    String? key,
    apimachinery_pkg_api_resource.QuantityObjectBuilder? value,
  })
      : _key = key,
...
class AllocatedResourceStatusesEntry {
  AllocatedResourceStatusesEntry._(this._bc, this._bcOffset);
  factory AllocatedResourceStatusesEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AllocatedResourceStatusesEntry> reader = _AllocatedResourceStatusesEntryReader();
  ...
  @override
  String toString() {
    return 'AllocatedResourceStatusesEntry{key: ${key}, value: ${value}}';
  }
}

class _AllocatedResourceStatusesEntryReader extends fb.TableReader<AllocatedResourceStatusesEntry> {
  const _AllocatedResourceStatusesEntryReader();

  @override
  AllocatedResourceStatusesEntry createObject(fb.BufferContext bc, int offset) => 
    AllocatedResourceStatusesEntry._(bc, offset);
}

class AllocatedResourceStatusesEntryBuilder {
  AllocatedResourceStatusesEntryBuilder(this.fbBuilder);
...
class AllocatedResourceStatusesEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final String? _value;

  AllocatedResourceStatusesEntryObjectBuilder({
    String? key,
    String? value,
  })
      : _key = key,
