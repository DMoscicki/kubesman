...
library api.discovery.v1.endpoint_;
...
import './generated_api.discovery.v1_generated.dart' as api_discovery_v1;
...
class DeprecatedTopologyEntry {
  DeprecatedTopologyEntry._(this._bc, this._bcOffset);
  factory DeprecatedTopologyEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DeprecatedTopologyEntry> reader = _DeprecatedTopologyEntryReader();
  ...
  @override
  String toString() {
    return 'DeprecatedTopologyEntry{key: ${key}, value: ${value}}';
  }
}

class _DeprecatedTopologyEntryReader extends fb.TableReader<DeprecatedTopologyEntry> {
  const _DeprecatedTopologyEntryReader();

  @override
  DeprecatedTopologyEntry createObject(fb.BufferContext bc, int offset) => 
    DeprecatedTopologyEntry._(bc, offset);
}

class DeprecatedTopologyEntryBuilder {
  DeprecatedTopologyEntryBuilder(this.fbBuilder);
...
class DeprecatedTopologyEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final String? _value;

  DeprecatedTopologyEntryObjectBuilder({
    String? key,
    String? value,
  })
      : _key = key,
