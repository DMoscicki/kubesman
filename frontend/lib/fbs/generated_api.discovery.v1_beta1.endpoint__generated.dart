...
library api.discovery.v1_beta1.endpoint_;
...
import './generated_api.discovery.v1_beta1_generated.dart' as api_discovery_v1_beta1;
...
class TopologyEntry {
  TopologyEntry._(this._bc, this._bcOffset);
  factory TopologyEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TopologyEntry> reader = _TopologyEntryReader();
  ...
  @override
  String toString() {
    return 'TopologyEntry{key: ${key}, value: ${value}}';
  }
}

class _TopologyEntryReader extends fb.TableReader<TopologyEntry> {
  const _TopologyEntryReader();

  @override
  TopologyEntry createObject(fb.BufferContext bc, int offset) => 
    TopologyEntry._(bc, offset);
}

class TopologyEntryBuilder {
  TopologyEntryBuilder(this.fbBuilder);
...
class TopologyEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final String? _value;

  TopologyEntryObjectBuilder({
    String? key,
    String? value,
  })
      : _key = key,
