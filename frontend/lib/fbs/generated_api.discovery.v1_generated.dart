...
import './generated_api.discovery.v1.endpoint__generated.dart' as api_discovery_v1_endpoint_;
...
class Endpoint {
  ...
  List<api_discovery_v1_endpoint_.DeprecatedTopologyEntry>? get deprecatedTopology => const fb.ListReader<api_discovery_v1_endpoint_.DeprecatedTopologyEntry>(api_discovery_v1_endpoint_.DeprecatedTopologyEntry.reader).vTableGetNullable(_bc, _bcOffset, 12);
  String? get nodeName => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 14);
  String? get zone => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 16);
  EndpointHints? get hints => EndpointHints.reader.vTableGetNullable(_bc, _bcOffset, 18);

  @override
  String toString() {
    return 'Endpoint{addresses: ${addresses}, conditions: ${conditions}, hostname: ${hostname}, targetRef: ${targetRef}, deprecatedTopology: ${deprecatedTopology}, nodeName: ${nodeName}, zone: ${zone}, hints: ${hints}}';
  }
}
...
class EndpointBuilder {
  ...
  int addDeprecatedTopologyOffset(int? offset) {
...
class EndpointObjectBuilder extends fb.ObjectBuilder {
  ...
  final List<api_discovery_v1_endpoint_.DeprecatedTopologyEntryObjectBuilder>? _deprecatedTopology;
  ...
  EndpointObjectBuilder({
    ...
    List<api_discovery_v1_endpoint_.DeprecatedTopologyEntryObjectBuilder>? deprecatedTopology,
    String? nodeName,
    String? zone,
    EndpointHintsObjectBuilder? hints,
      ...
      : _addresses = addresses,
        ...
        _deprecatedTopology = deprecatedTopology,
        _nodeName = nodeName,
        _zone = zone,
        _hints = hints;
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? deprecatedTopologyOffset = _deprecatedTopology == null ? null
        : fbBuilder.writeList(_deprecatedTopology!.map((b) => b.getOrCreateOffset(fbBuilder)).toList());
    final int? nodeNameOffset = _nodeName == null ? null
        : fbBuilder.writeString(_nodeName!);
    final int? zoneOffset = _zone == null ? null
        : fbBuilder.writeString(_zone!);
    ...
    fbBuilder.addOffset(4, deprecatedTopologyOffset);
    fbBuilder.addOffset(5, nodeNameOffset);
    fbBuilder.addOffset(6, zoneOffset);
    fbBuilder.addOffset(7, hintsOffset);
    return fbBuilder.endTable();
  }
