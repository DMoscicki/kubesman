...
library api.extensions.v1_beta1.deployment_rollback_;
...
import './generated_api.extensions.v1_beta1_generated.dart' as api_extensions_v1_beta1;
...
class UpdatedAnnotationsEntry {
  UpdatedAnnotationsEntry._(this._bc, this._bcOffset);
  factory UpdatedAnnotationsEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<UpdatedAnnotationsEntry> reader = _UpdatedAnnotationsEntryReader();
  ...
  @override
  String toString() {
    return 'UpdatedAnnotationsEntry{key: ${key}, value: ${value}}';
  }
}

class _UpdatedAnnotationsEntryReader extends fb.TableReader<UpdatedAnnotationsEntry> {
  const _UpdatedAnnotationsEntryReader();

  @override
  UpdatedAnnotationsEntry createObject(fb.BufferContext bc, int offset) => 
    UpdatedAnnotationsEntry._(bc, offset);
}

class UpdatedAnnotationsEntryBuilder {
  UpdatedAnnotationsEntryBuilder(this.fbBuilder);
...
class UpdatedAnnotationsEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final String? _value;

  UpdatedAnnotationsEntryObjectBuilder({
    String? key,
    String? value,
  })
      : _key = key,
