...
library api.flowcontrol.v1_beta2;
...
class LimitedPriorityLevelConfiguration {
  ...
  int get assuredConcurrencyShares => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 4, 0);
  ...
  @override
  String toString() {
    return 'LimitedPriorityLevelConfiguration{assuredConcurrencyShares: ${assuredConcurrencyShares}, limitResponse: ${limitResponse}, lendablePercent: ${lendablePercent}, borrowingLimitPercent: ${borrowingLimitPercent}}';
  }
}
...
class LimitedPriorityLevelConfigurationBuilder {
  ...
  int addAssuredConcurrencyShares(int? assuredConcurrencyShares) {
    fbBuilder.addInt32(0, assuredConcurrencyShares);
    return fbBuilder.offset;
  }
...
class LimitedPriorityLevelConfigurationObjectBuilder extends fb.ObjectBuilder {
  final int? _assuredConcurrencyShares;
  ...
  LimitedPriorityLevelConfigurationObjectBuilder({
    ...
    int? borrowingLimitPercent,
      ...
      : _assuredConcurrencyShares = assuredConcurrencyShares,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.startTable(4);
    fbBuilder.addInt32(0, _assuredConcurrencyShares);
