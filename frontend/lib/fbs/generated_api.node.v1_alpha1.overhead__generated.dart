...
library api.node.v1_alpha1.overhead_;
...
import './generated_api.node.v1_alpha1_generated.dart' as api_node_v1_alpha1;
...
class PodFixedEntry {
  PodFixedEntry._(this._bc, this._bcOffset);
  factory PodFixedEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PodFixedEntry> reader = _PodFixedEntryReader();
  ...
  @override
  String toString() {
    return 'PodFixedEntry{key: ${key}, value: ${value}}';
  }
}

class _PodFixedEntryReader extends fb.TableReader<PodFixedEntry> {
  const _PodFixedEntryReader();

  @override
  PodFixedEntry createObject(fb.BufferContext bc, int offset) => 
    PodFixedEntry._(bc, offset);
}

class PodFixedEntryBuilder {
  PodFixedEntryBuilder(this.fbBuilder);
...
class PodFixedEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final apimachinery_pkg_api_resource.QuantityObjectBuilder? _value;

  PodFixedEntryObjectBuilder({
    String? key,
