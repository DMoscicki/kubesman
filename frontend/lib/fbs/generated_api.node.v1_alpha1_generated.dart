...
import './generated_api.node.v1_alpha1.overhead__generated.dart' as api_node_v1_alpha1_overhead_;
import './generated_api.node.v1_alpha1.scheduling__generated.dart' as api_node_v1_alpha1_scheduling_;
...
class Overhead {
  ...
  List<api_node_v1_alpha1_overhead_.PodFixedEntry>? get podFixed => const fb.ListReader<api_node_v1_alpha1_overhead_.PodFixedEntry>(api_node_v1_alpha1_overhead_.PodFixedEntry.reader).vTableGetNullable(_bc, _bcOffset, 4);
...
class OverheadObjectBuilder extends fb.ObjectBuilder {
  final List<api_node_v1_alpha1_overhead_.PodFixedEntryObjectBuilder>? _podFixed;

  OverheadObjectBuilder({
    List<api_node_v1_alpha1_overhead_.PodFixedEntryObjectBuilder>? podFixed,
  })
      : _podFixed = podFixed;
...
class RuntimeClass {
  ...
  RuntimeClassSpec? get spec => RuntimeClassSpec.reader.vTableGetNullable(_bc, _bcOffset, 6);

  @override
  String toString() {
    return 'RuntimeClass{metadata: ${metadata}, spec: ${spec}}';
  }
}
...
class RuntimeClassSpec {
  RuntimeClassSpec._(this._bc, this._bcOffset);
  factory RuntimeClassSpec(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RuntimeClassSpec> reader = _RuntimeClassSpecReader();

  final fb.BufferContext _bc;
  final int _bcOffset;

  String? get runtimeHandler => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 4);
  Overhead? get overhead => Overhead.reader.vTableGetNullable(_bc, _bcOffset, 6);
  Scheduling? get scheduling => Scheduling.reader.vTableGetNullable(_bc, _bcOffset, 8);

  @override
  String toString() {
    return 'RuntimeClassSpec{runtimeHandler: ${runtimeHandler}, overhead: ${overhead}, scheduling: ${scheduling}}';
  }
}

class _RuntimeClassSpecReader extends fb.TableReader<RuntimeClassSpec> {
  const _RuntimeClassSpecReader();

  @override
  RuntimeClassSpec createObject(fb.BufferContext bc, int offset) => 
    RuntimeClassSpec._(bc, offset);
}

class RuntimeClassSpecBuilder {
  RuntimeClassSpecBuilder(this.fbBuilder);
  ...
  int addRuntimeHandlerOffset(int? offset) {
    fbBuilder.addOffset(0, offset);
    return fbBuilder.offset;
  }
...
class RuntimeClassSpecObjectBuilder extends fb.ObjectBuilder {
  final String? _runtimeHandler;
  final OverheadObjectBuilder? _overhead;
  final SchedulingObjectBuilder? _scheduling;

  RuntimeClassSpecObjectBuilder({
  ...
  @override
  int finish(fb.Builder fbBuilder) {
    final int? runtimeHandlerOffset = _runtimeHandler == null ? null
        : fbBuilder.writeString(_runtimeHandler!);
    ...
    fbBuilder.startTable(3);
    fbBuilder.addOffset(0, runtimeHandlerOffset);
    fbBuilder.addOffset(1, overheadOffset);
    fbBuilder.addOffset(2, schedulingOffset);
    return fbBuilder.endTable();
  }
...
class Scheduling {
  ...
  List<api_node_v1_alpha1_scheduling_.NodeSelectorEntry>? get nodeSelector => const fb.ListReader<api_node_v1_alpha1_scheduling_.NodeSelectorEntry>(api_node_v1_alpha1_scheduling_.NodeSelectorEntry.reader).vTableGetNullable(_bc, _bcOffset, 4);
...
class SchedulingObjectBuilder extends fb.ObjectBuilder {
  final List<api_node_v1_alpha1_scheduling_.NodeSelectorEntryObjectBuilder>? _nodeSelector;
  final List<api_core_v1.TolerationObjectBuilder>? _tolerations;

  SchedulingObjectBuilder({
    List<api_node_v1_alpha1_scheduling_.NodeSelectorEntryObjectBuilder>? nodeSelector,
