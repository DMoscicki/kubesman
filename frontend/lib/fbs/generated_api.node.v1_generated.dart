...
import './generated_api.node.v1.overhead__generated.dart' as api_node_v1_overhead_;
import './generated_api.node.v1.scheduling__generated.dart' as api_node_v1_scheduling_;
...
class Overhead {
  ...
  List<api_node_v1_overhead_.PodFixedEntry>? get podFixed => const fb.ListReader<api_node_v1_overhead_.PodFixedEntry>(api_node_v1_overhead_.PodFixedEntry.reader).vTableGetNullable(_bc, _bcOffset, 4);
...
class OverheadObjectBuilder extends fb.ObjectBuilder {
  final List<api_node_v1_overhead_.PodFixedEntryObjectBuilder>? _podFixed;

  OverheadObjectBuilder({
    List<api_node_v1_overhead_.PodFixedEntryObjectBuilder>? podFixed,
  })
      : _podFixed = podFixed;
...
class Scheduling {
  ...
  List<api_node_v1_scheduling_.NodeSelectorEntry>? get nodeSelector => const fb.ListReader<api_node_v1_scheduling_.NodeSelectorEntry>(api_node_v1_scheduling_.NodeSelectorEntry.reader).vTableGetNullable(_bc, _bcOffset, 4);
...
class SchedulingObjectBuilder extends fb.ObjectBuilder {
  final List<api_node_v1_scheduling_.NodeSelectorEntryObjectBuilder>? _nodeSelector;
  final List<api_core_v1.TolerationObjectBuilder>? _tolerations;

  SchedulingObjectBuilder({
    List<api_node_v1_scheduling_.NodeSelectorEntryObjectBuilder>? nodeSelector,
