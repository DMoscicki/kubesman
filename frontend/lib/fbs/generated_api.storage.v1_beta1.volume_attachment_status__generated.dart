...
library api.storage.v1_beta1.volume_attachment_status_;
...
class AttachmentMetadataEntry {
  AttachmentMetadataEntry._(this._bc, this._bcOffset);
  factory AttachmentMetadataEntry(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AttachmentMetadataEntry> reader = _AttachmentMetadataEntryReader();
  ...
  @override
  String toString() {
    return 'AttachmentMetadataEntry{key: ${key}, value: ${value}}';
  }
}

class _AttachmentMetadataEntryReader extends fb.TableReader<AttachmentMetadataEntry> {
  const _AttachmentMetadataEntryReader();

  @override
  AttachmentMetadataEntry createObject(fb.BufferContext bc, int offset) => 
    AttachmentMetadataEntry._(bc, offset);
}

class AttachmentMetadataEntryBuilder {
  AttachmentMetadataEntryBuilder(this.fbBuilder);
...
class AttachmentMetadataEntryObjectBuilder extends fb.ObjectBuilder {
  final String? _key;
  final String? _value;

  AttachmentMetadataEntryObjectBuilder({
    String? key,
    String? value,
  })
      : _key = key,
