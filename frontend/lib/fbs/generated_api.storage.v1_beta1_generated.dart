...
import './generated_api.storage.v1_beta1.storage_class__generated.dart' as api_storage_v1_beta1_storage_class_;
...
class StorageClass {
  ...
  List<api_storage_v1_beta1_storage_class_.ParametersEntry>? get parameters => const fb.ListReader<api_storage_v1_beta1_storage_class_.ParametersEntry>(api_storage_v1_beta1_storage_class_.ParametersEntry.reader).vTableGetNullable(_bc, _bcOffset, 8);
...
class StorageClassObjectBuilder extends fb.ObjectBuilder {
  ...
  final List<api_storage_v1_beta1_storage_class_.ParametersEntryObjectBuilder>? _parameters;
  ...
  StorageClassObjectBuilder({
    apimachinery_pkg_apis_meta_v1.ObjectMetaObjectBuilder? metadata,
    String? provisioner,
    List<api_storage_v1_beta1_storage_class_.ParametersEntryObjectBuilder>? parameters,
...
class VolumeAttachmentStatus {
  ...
  List<api_storage_v1_beta1_volume_attachment_status_.AttachmentMetadataEntry>? get attachmentMetadata => const fb.ListReader<api_storage_v1_beta1_volume_attachment_status_.AttachmentMetadataEntry>(api_storage_v1_beta1_volume_attachment_status_.AttachmentMetadataEntry.reader).vTableGetNullable(_bc, _bcOffset, 6);
...
class VolumeAttachmentStatusObjectBuilder extends fb.ObjectBuilder {
  ...
  final List<api_storage_v1_beta1_volume_attachment_status_.AttachmentMetadataEntryObjectBuilder>? _attachmentMetadata;
  ...
  VolumeAttachmentStatusObjectBuilder({
    bool? attached,
    List<api_storage_v1_beta1_volume_attachment_status_.AttachmentMetadataEntryObjectBuilder>? attachmentMetadata,
