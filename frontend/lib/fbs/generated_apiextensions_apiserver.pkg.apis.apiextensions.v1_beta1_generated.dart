...
library apiextensions_apiserver.pkg.apis.apiextensions.v1_beta1;

import 'dart:typed_data' show Uint8List;
import 'package:flat_buffers/flat_buffers.dart' as fb;

import './generated_apiextensions_apiserver.pkg.apis.apiextensions.v1_beta1.jsonschema_props__generated.dart' as apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_;
...
class CustomResourceConversion {
  ...
  WebhookClientConfig? get webhookClientConfig => WebhookClientConfig.reader.vTableGetNullable(_bc, _bcOffset, 6);
  List<String>? get conversionReviewVersions => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 8);

  @override
  String toString() {
    return 'CustomResourceConversion{strategy: ${strategy}, webhookClientConfig: ${webhookClientConfig}, conversionReviewVersions: ${conversionReviewVersions}}';
  }
}
...
class CustomResourceConversionBuilder {
  ...
  int addWebhookClientConfigOffset(int? offset) {
    fbBuilder.addOffset(1, offset);
    return fbBuilder.offset;
  }
...
class CustomResourceConversionObjectBuilder extends fb.ObjectBuilder {
  ...
  final WebhookClientConfigObjectBuilder? _webhookClientConfig;
  final List<String>? _conversionReviewVersions;

  CustomResourceConversionObjectBuilder({
    String? strategy,
    WebhookClientConfigObjectBuilder? webhookClientConfig,
    List<String>? conversionReviewVersions,
  })
      : _strategy = strategy,
        _webhookClientConfig = webhookClientConfig,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? webhookClientConfigOffset = _webhookClientConfig?.getOrCreateOffset(fbBuilder);
    ...
    fbBuilder.addOffset(1, webhookClientConfigOffset);
    fbBuilder.addOffset(2, conversionReviewVersionsOffset);
    return fbBuilder.endTable();
  }
...
class CustomResourceDefinitionSpec {
  ...
  CustomResourceDefinitionNames? get names => CustomResourceDefinitionNames.reader.vTableGetNullable(_bc, _bcOffset, 8);
  String? get scope => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 10);
  CustomResourceValidation? get validation => CustomResourceValidation.reader.vTableGetNullable(_bc, _bcOffset, 12);
  CustomResourceSubresources? get subresources => CustomResourceSubresources.reader.vTableGetNullable(_bc, _bcOffset, 14);
  List<CustomResourceDefinitionVersion>? get versions => const fb.ListReader<CustomResourceDefinitionVersion>(CustomResourceDefinitionVersion.reader).vTableGetNullable(_bc, _bcOffset, 16);
  ...
  CustomResourceConversion? get conversion => CustomResourceConversion.reader.vTableGetNullable(_bc, _bcOffset, 22);
  bool get preserveUnknownFields => const fb.BoolReader().vTableGet(_bc, _bcOffset, 24, false);

  @override
  String toString() {
    return 'CustomResourceDefinitionSpec{group: ${group}, version: ${version}, names: ${names}, scope: ${scope}, validation: ${validation}, subresources: ${subresources}, versions: ${versions}, additionalPrinterColumns: ${additionalPrinterColumns}, selectableFields: ${selectableFields}, conversion: ${conversion}, preserveUnknownFields: ${preserveUnknownFields}}';
  }
}
...
class CustomResourceDefinitionSpecBuilder {
  ...
  int addPreserveUnknownFields(bool? preserveUnknownFields) {
    fbBuilder.addBool(10, preserveUnknownFields);
    return fbBuilder.offset;
  }
...
class CustomResourceDefinitionSpecObjectBuilder extends fb.ObjectBuilder {
  ...
  final String? _scope;
  final CustomResourceValidationObjectBuilder? _validation;
  ...
  CustomResourceDefinitionSpecObjectBuilder({
    ...
    String? scope,
    CustomResourceValidationObjectBuilder? validation,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(4, validationOffset);
    fbBuilder.addOffset(5, subresourcesOffset);
    fbBuilder.addOffset(6, versionsOffset);
    fbBuilder.addOffset(7, additionalPrinterColumnsOffset);
    fbBuilder.addOffset(8, selectableFieldsOffset);
    fbBuilder.addOffset(9, conversionOffset);
    fbBuilder.addBool(10, _preserveUnknownFields);
    return fbBuilder.endTable();
  }
...
class JsonschemaProps {
  ...
  List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PropertiesEntry>? get properties => const fb.ListReader<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PropertiesEntry>(apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PropertiesEntry.reader).vTableGetNullable(_bc, _bcOffset, 60);
  JsonschemaPropsOrBool? get additionalProperties => JsonschemaPropsOrBool.reader.vTableGetNullable(_bc, _bcOffset, 62);
  List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PatternPropertiesEntry>? get patternProperties => const fb.ListReader<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PatternPropertiesEntry>(apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PatternPropertiesEntry.reader).vTableGetNullable(_bc, _bcOffset, 64);
  List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DependenciesEntry>? get dependencies => const fb.ListReader<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DependenciesEntry>(apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DependenciesEntry.reader).vTableGetNullable(_bc, _bcOffset, 66);
  JsonschemaPropsOrBool? get additionalItems => JsonschemaPropsOrBool.reader.vTableGetNullable(_bc, _bcOffset, 68);
  List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DefinitionsEntry>? get definitions => const fb.ListReader<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DefinitionsEntry>(apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DefinitionsEntry.reader).vTableGetNullable(_bc, _bcOffset, 70);
...
class JsonschemaPropsObjectBuilder extends fb.ObjectBuilder {
  ...
  final List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PropertiesEntryObjectBuilder>? _properties;
  final JsonschemaPropsOrBoolObjectBuilder? _additionalProperties;
  final List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PatternPropertiesEntryObjectBuilder>? _patternProperties;
  final List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DependenciesEntryObjectBuilder>? _dependencies;
  final JsonschemaPropsOrBoolObjectBuilder? _additionalItems;
  final List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DefinitionsEntryObjectBuilder>? _definitions;
  ...
  JsonschemaPropsObjectBuilder({
    ...
    List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PropertiesEntryObjectBuilder>? properties,
    JsonschemaPropsOrBoolObjectBuilder? additionalProperties,
    List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.PatternPropertiesEntryObjectBuilder>? patternProperties,
    List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DependenciesEntryObjectBuilder>? dependencies,
    JsonschemaPropsOrBoolObjectBuilder? additionalItems,
    List<apiextensions_apiserver_pkg_apis_apiextensions_v1_beta1_jsonschema_props_.DefinitionsEntryObjectBuilder>? definitions,
