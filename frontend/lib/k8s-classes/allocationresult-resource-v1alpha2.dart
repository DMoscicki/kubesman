...
part 'allocationresult_resource_v1_alpha2.g.dart';


///AllocationResult contains attributes of an allocated resource.
@JsonSerializable()
class AllocationresultResourceV1Alpha2 {
    ...
    AllocationresultResourceV1Alpha2({
        this.availableOnNodes,
        this.resourceHandles,
        this.shareable,
    });

    factory AllocationresultResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$AllocationresultResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$AllocationresultResourceV1Alpha2ToJson(this);
}
