...
part 'apigroup_meta_v1.g.dart';


///APIGroup contains the name, the supported versions, and the preferred version of a group.
@JsonSerializable()
class ApigroupMetaV1 {
    ...
    factory ApigroupMetaV1.fromJson(Map<String, dynamic> json) => _$ApigroupMetaV1FromJson(json);

    Map<String, dynamic> toJson() => _$ApigroupMetaV1ToJson(this);
}
