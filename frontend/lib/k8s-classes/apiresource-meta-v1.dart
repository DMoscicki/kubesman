...
part 'apiresource_meta_v1.g.dart';


///APIResource specifies the name of a resource and whether it is namespaced.
@JsonSerializable()
class ApiresourceMetaV1 {
    ...
    factory ApiresourceMetaV1.fromJson(Map<String, dynamic> json) => _$ApiresourceMetaV1FromJson(json);

    Map<String, dynamic> toJson() => _$ApiresourceMetaV1ToJson(this);
}
