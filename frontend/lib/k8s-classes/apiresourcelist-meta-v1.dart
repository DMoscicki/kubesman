...
class ApiresourcelistMetaV1 {
    ...
    factory ApiresourcelistMetaV1.fromJson(Map<String, dynamic> json) => _$ApiresourcelistMetaV1FromJson(json);
...
final kindValues = EnumValues({
    "APIResourceList": Kind.API_RESOURCE_LIST
});
...
class IoK8SApimachineryPkgApisMetaV1ApiResource {
    ...
    factory IoK8SApimachineryPkgApisMetaV1ApiResource.fromJson(Map<String, dynamic> json) => _$IoK8SApimachineryPkgApisMetaV1ApiResourceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApimachineryPkgApisMetaV1ApiResourceToJson(this);
}
