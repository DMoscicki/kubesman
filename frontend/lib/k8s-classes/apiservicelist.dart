...
class Apiservicelist {
    ...
    factory Apiservicelist.fromJson(Map<String, dynamic> json) => _$ApiservicelistFromJson(json);

    Map<String, dynamic> toJson() => _$ApiservicelistToJson(this);
}
...
class IoK8SKubeAggregatorPkgApisApiregistrationV1ApiService {
    ...
    factory IoK8SKubeAggregatorPkgApisApiregistrationV1ApiService.fromJson(Map<String, dynamic> json) => _$IoK8SKubeAggregatorPkgApisApiregistrationV1ApiServiceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SKubeAggregatorPkgApisApiregistrationV1ApiServiceToJson(this);
}
...
final itemKindValues = EnumValues({
    "APIService": ItemKind.API_SERVICE
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ApiservicelistKind {
    @JsonValue("APIServiceList")
    API_SERVICE_LIST
}

final apiservicelistKindValues = EnumValues({
    "APIServiceList": ApiservicelistKind.API_SERVICE_LIST
});
