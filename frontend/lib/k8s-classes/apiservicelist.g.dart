...
part of 'apiservicelist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Apiservicelist _$ApiservicelistFromJson(Map<String, dynamic> json) =>
    Apiservicelist(
...
Map<String, dynamic> _$ApiservicelistToJson(Apiservicelist instance) =>
    <String, dynamic>{
      ...
      'kind': _$ApiservicelistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ApiservicelistKindEnumMap = {
  ApiservicelistKind.API_SERVICE_LIST: 'APIServiceList',
};

IoK8SKubeAggregatorPkgApisApiregistrationV1ApiService
    _$IoK8SKubeAggregatorPkgApisApiregistrationV1ApiServiceFromJson(
...
Map<String, dynamic>
    _$IoK8SKubeAggregatorPkgApisApiregistrationV1ApiServiceToJson(
            IoK8SKubeAggregatorPkgApisApiregistrationV1ApiService instance) =>
        <String, dynamic>{
          'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.API_SERVICE: 'APIService',
};
