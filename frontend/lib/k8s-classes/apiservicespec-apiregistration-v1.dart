...
part 'apiservicespec_apiregistration_v1.g.dart';
...
@JsonSerializable()
class ApiservicespecApiregistrationV1 {
    ...
    ApiservicespecApiregistrationV1({
        this.caBundle,
        this.group,
    ...
    factory ApiservicespecApiregistrationV1.fromJson(Map<String, dynamic> json) => _$ApiservicespecApiregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ApiservicespecApiregistrationV1ToJson(this);
}
