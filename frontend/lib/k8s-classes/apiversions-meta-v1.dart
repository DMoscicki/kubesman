...
part 'apiversions_meta_v1.g.dart';
...
class ApiversionsMetaV1 {
    ...
    factory ApiversionsMetaV1.fromJson(Map<String, dynamic> json) => _$ApiversionsMetaV1FromJson(json);

    Map<String, dynamic> toJson() => _$ApiversionsMetaV1ToJson(this);
}
