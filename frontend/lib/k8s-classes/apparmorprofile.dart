...
class Apparmorprofile {
    ...
    factory Apparmorprofile.fromJson(Map<String, dynamic> json) => _$ApparmorprofileFromJson(json);

    Map<String, dynamic> toJson() => _$ApparmorprofileToJson(this);
}
