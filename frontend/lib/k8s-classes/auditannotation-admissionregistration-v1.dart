...
part 'auditannotation_admissionregistration_v1.g.dart';


///AuditAnnotation describes how to produce an audit annotation for an API request.
@JsonSerializable()
class AuditannotationAdmissionregistrationV1 {
    ...
    AuditannotationAdmissionregistrationV1({
        required this.key,
        required this.valueExpression,
    });

    factory AuditannotationAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$AuditannotationAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$AuditannotationAdmissionregistrationV1ToJson(this);
}
