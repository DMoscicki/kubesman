...
part 'auditannotation_admissionregistration_v1_beta1.g.dart';


///AuditAnnotation describes how to produce an audit annotation for an API request.
@JsonSerializable()
class AuditannotationAdmissionregistrationV1Beta1 {
    ...
    AuditannotationAdmissionregistrationV1Beta1({
        required this.key,
        required this.valueExpression,
    });

    factory AuditannotationAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$AuditannotationAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$AuditannotationAdmissionregistrationV1Beta1ToJson(this);
}
