...
part 'awselasticblockstorevolumesource_v1.g.dart';
...
@JsonSerializable()
class AwselasticblockstorevolumesourceV1 {
    ...
    AwselasticblockstorevolumesourceV1({
        this.fsType,
        this.partition,
        this.readOnly,
    ...
    factory AwselasticblockstorevolumesourceV1.fromJson(Map<String, dynamic> json) => _$AwselasticblockstorevolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$AwselasticblockstorevolumesourceV1ToJson(this);
}
