...
part 'awselasticblockstorevolumesource.g.dart';
...
class Awselasticblockstorevolumesource {
    ...
    factory Awselasticblockstorevolumesource.fromJson(Map<String, dynamic> json) => _$AwselasticblockstorevolumesourceFromJson(json);
