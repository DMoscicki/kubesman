...
class CephfspersistentvolumesourceV1 {
    ...
    CephfspersistentvolumesourceV1({
    ...
    factory CephfspersistentvolumesourceV1.fromJson(Map<String, dynamic> json) => _$CephfspersistentvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$CephfspersistentvolumesourceV1ToJson(this);
}
