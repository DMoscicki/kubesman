...
part 'certificatesigningrequest.g.dart';
...
class Certificatesigningrequest {
    ...
    factory Certificatesigningrequest.fromJson(Map<String, dynamic> json) => _$CertificatesigningrequestFromJson(json);

    Map<String, dynamic> toJson() => _$CertificatesigningrequestToJson(this);
}
