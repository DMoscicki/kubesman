...
part 'certificatesigningrequestcondition.g.dart';
...
class Certificatesigningrequestcondition {
    ...
    factory Certificatesigningrequestcondition.fromJson(Map<String, dynamic> json) => _$CertificatesigningrequestconditionFromJson(json);

    Map<String, dynamic> toJson() => _$CertificatesigningrequestconditionToJson(this);
}
