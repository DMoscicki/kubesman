...
class CertificatesigningrequestlistCertificatesV1 {
    ...
    factory CertificatesigningrequestlistCertificatesV1.fromJson(Map<String, dynamic> json) => _$CertificatesigningrequestlistCertificatesV1FromJson(json);

    Map<String, dynamic> toJson() => _$CertificatesigningrequestlistCertificatesV1ToJson(this);
}
...
final certificatesigningrequestlistCertificatesV1KindValues = EnumValues({
    "CertificateSigningRequestList": CertificatesigningrequestlistCertificatesV1Kind.CERTIFICATE_SIGNING_REQUEST_LIST
});
