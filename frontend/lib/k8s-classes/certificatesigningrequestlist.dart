...
part 'certificatesigningrequestlist.g.dart';
...
class Certificatesigningrequestlist {
    ...
    @JsonKey(name: "kind")
    CertificatesigningrequestlistKind? kind;
    ...
    factory Certificatesigningrequestlist.fromJson(Map<String, dynamic> json) => _$CertificatesigningrequestlistFromJson(json);

    Map<String, dynamic> toJson() => _$CertificatesigningrequestlistToJson(this);
}
...
class IoK8SApiCertificatesV1CertificateSigningRequest {
    ...
    factory IoK8SApiCertificatesV1CertificateSigningRequest.fromJson(Map<String, dynamic> json) => _$IoK8SApiCertificatesV1CertificateSigningRequestFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCertificatesV1CertificateSigningRequestToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum CertificatesigningrequestlistKind {
    @JsonValue("CertificateSigningRequestList")
    CERTIFICATE_SIGNING_REQUEST_LIST
}

final certificatesigningrequestlistKindValues = EnumValues({
    "CertificateSigningRequestList": CertificatesigningrequestlistKind.CERTIFICATE_SIGNING_REQUEST_LIST
});
