...
part 'certificatesigningrequestspec_certificates_v1.g.dart';


///CertificateSigningRequestSpec contains the certificate request.
@JsonSerializable()
class CertificatesigningrequestspecCertificatesV1 {
    ...
    CertificatesigningrequestspecCertificatesV1({
    ...
    factory CertificatesigningrequestspecCertificatesV1.fromJson(Map<String, dynamic> json) => _$CertificatesigningrequestspecCertificatesV1FromJson(json);

    Map<String, dynamic> toJson() => _$CertificatesigningrequestspecCertificatesV1ToJson(this);
}
