...
part 'certificatesigningrequestspec.g.dart';
...
class Certificatesigningrequestspec {
    ...
    factory Certificatesigningrequestspec.fromJson(Map<String, dynamic> json) => _$CertificatesigningrequestspecFromJson(json);

    Map<String, dynamic> toJson() => _$CertificatesigningrequestspecToJson(this);
}
