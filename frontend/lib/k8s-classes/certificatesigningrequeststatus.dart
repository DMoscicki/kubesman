...
part 'certificatesigningrequeststatus.g.dart';
...
class Certificatesigningrequeststatus {
    ...
    factory Certificatesigningrequeststatus.fromJson(Map<String, dynamic> json) => _$CertificatesigningrequeststatusFromJson(json);

    Map<String, dynamic> toJson() => _$CertificatesigningrequeststatusToJson(this);
}
