...
part 'cinderpersistentvolumesource_v1.g.dart';
...
@JsonSerializable()
class CinderpersistentvolumesourceV1 {
    ...
    CinderpersistentvolumesourceV1({
        this.fsType,
        this.readOnly,
        this.secretRef,
    ...
    factory CinderpersistentvolumesourceV1.fromJson(Map<String, dynamic> json) => _$CinderpersistentvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$CinderpersistentvolumesourceV1ToJson(this);
}
