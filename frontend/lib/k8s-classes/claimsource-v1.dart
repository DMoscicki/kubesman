...
class ClaimsourceV1 {
    ...
    factory ClaimsourceV1.fromJson(Map<String, dynamic> json) => _$ClaimsourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$ClaimsourceV1ToJson(this);
}
