...
part 'clusterrole_rbac_v1.g.dart';
...
class ClusterroleRbacV1 {
    ...
    factory ClusterroleRbacV1.fromJson(Map<String, dynamic> json) => _$ClusterroleRbacV1FromJson(json);

    Map<String, dynamic> toJson() => _$ClusterroleRbacV1ToJson(this);
}
