...
class Clusterrole {
    ...
    factory Clusterrole.fromJson(Map<String, dynamic> json) => _$ClusterroleFromJson(json);

    Map<String, dynamic> toJson() => _$ClusterroleToJson(this);
}
