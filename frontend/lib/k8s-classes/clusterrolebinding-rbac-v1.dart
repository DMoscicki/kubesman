...
class ClusterrolebindingRbacV1 {
    ...
    factory ClusterrolebindingRbacV1.fromJson(Map<String, dynamic> json) => _$ClusterrolebindingRbacV1FromJson(json);

    Map<String, dynamic> toJson() => _$ClusterrolebindingRbacV1ToJson(this);
}
...
final kindValues = EnumValues({
    "ClusterRoleBinding": Kind.CLUSTER_ROLE_BINDING
});
