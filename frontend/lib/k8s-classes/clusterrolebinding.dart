...
part 'clusterrolebinding.g.dart';
...
class Clusterrolebinding {
    ...
    factory Clusterrolebinding.fromJson(Map<String, dynamic> json) => _$ClusterrolebindingFromJson(json);

    Map<String, dynamic> toJson() => _$ClusterrolebindingToJson(this);
}
