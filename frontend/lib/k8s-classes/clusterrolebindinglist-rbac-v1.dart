...
class ClusterrolebindinglistRbacV1 {
    ...
    factory ClusterrolebindinglistRbacV1.fromJson(Map<String, dynamic> json) => _$ClusterrolebindinglistRbacV1FromJson(json);
...
final clusterrolebindinglistRbacV1KindValues = EnumValues({
    "ClusterRoleBindingList": ClusterrolebindinglistRbacV1Kind.CLUSTER_ROLE_BINDING_LIST
});
