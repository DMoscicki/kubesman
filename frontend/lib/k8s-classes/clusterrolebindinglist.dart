...
part 'clusterrolebindinglist.g.dart';
...
class Clusterrolebindinglist {
    ...
    @JsonKey(name: "kind")
    ClusterrolebindinglistKind? kind;
    ...
    factory Clusterrolebindinglist.fromJson(Map<String, dynamic> json) => _$ClusterrolebindinglistFromJson(json);

    Map<String, dynamic> toJson() => _$ClusterrolebindinglistToJson(this);
}
...
class IoK8SApiRbacV1ClusterRoleBinding {
    ...
    ///be resolved, the Authorizer must return an error. This field is immutable.
    ...
    factory IoK8SApiRbacV1ClusterRoleBinding.fromJson(Map<String, dynamic> json) => _$IoK8SApiRbacV1ClusterRoleBindingFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiRbacV1ClusterRoleBindingToJson(this);
}
...
class IoK8SApiRbacV1RoleRef {
    ...
    factory IoK8SApiRbacV1RoleRef.fromJson(Map<String, dynamic> json) => _$IoK8SApiRbacV1RoleRefFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiRbacV1RoleRefToJson(this);
}
...
class IoK8SApiRbacV1Subject {
    ...
    factory IoK8SApiRbacV1Subject.fromJson(Map<String, dynamic> json) => _$IoK8SApiRbacV1SubjectFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiRbacV1SubjectToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ClusterrolebindinglistKind {
    @JsonValue("ClusterRoleBindingList")
    CLUSTER_ROLE_BINDING_LIST
}

final clusterrolebindinglistKindValues = EnumValues({
    "ClusterRoleBindingList": ClusterrolebindinglistKind.CLUSTER_ROLE_BINDING_LIST
});
