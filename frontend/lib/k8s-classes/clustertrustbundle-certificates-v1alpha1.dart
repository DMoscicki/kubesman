...
part 'clustertrustbundle_certificates_v1_alpha1.g.dart';
...
@JsonSerializable()
class ClustertrustbundleCertificatesV1Alpha1 {
    ...
    ClustertrustbundleCertificatesV1Alpha1({
        this.apiVersion,
        this.kind,
        this.metadata,
        required this.spec,
    ...
    factory ClustertrustbundleCertificatesV1Alpha1.fromJson(Map<String, dynamic> json) => _$ClustertrustbundleCertificatesV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ClustertrustbundleCertificatesV1Alpha1ToJson(this);
}
...
final kindValues = EnumValues({
    "ClusterTrustBundle": Kind.CLUSTER_TRUST_BUNDLE
});
