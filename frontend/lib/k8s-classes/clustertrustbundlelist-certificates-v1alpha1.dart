...
part 'clustertrustbundlelist_certificates_v1_alpha1.g.dart';


///ClusterTrustBundleList is a collection of ClusterTrustBundle objects
@JsonSerializable()
class ClustertrustbundlelistCertificatesV1Alpha1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiCertificatesV1Alpha1ClusterTrustBundle>? items;
    ...
    @JsonKey(name: "kind")
    ClustertrustbundlelistCertificatesV1Alpha1Kind? kind;
    
    ///metadata contains the list metadata.
    @JsonKey(name: "metadata")
    Metadata? metadata;

    ClustertrustbundlelistCertificatesV1Alpha1({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory ClustertrustbundlelistCertificatesV1Alpha1.fromJson(Map<String, dynamic> json) => _$ClustertrustbundlelistCertificatesV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ClustertrustbundlelistCertificatesV1Alpha1ToJson(this);
}
...
///certificates).
///
///ClusterTrustBundle objects are considered to be readable by any authenticated user in the
///cluster, because they can be mounted by pods using the `clusterTrustBundle` projection.
///All service accounts have read access to ClusterTrustBundles by default.  Users who only
///have namespace-level access to a cluster can read ClusterTrustBundles by impersonating a
///serviceaccount that they have access to.
///
///It can be optionally associated with a particular assigner, in which case it contains one
///valid set of trust anchors for that signer. Signers may have multiple associated
...
@JsonSerializable()
class IoK8SApiCertificatesV1Alpha1ClusterTrustBundle {
    ...
    @JsonKey(name: "spec")
    IoK8SApiCertificatesV1Alpha1ClusterTrustBundleSpec spec;
    ...
    factory IoK8SApiCertificatesV1Alpha1ClusterTrustBundle.fromJson(Map<String, dynamic> json) => _$IoK8SApiCertificatesV1Alpha1ClusterTrustBundleFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCertificatesV1Alpha1ClusterTrustBundleToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
    @JsonValue("ClusterTrustBundle")
    CLUSTER_TRUST_BUNDLE
}

final itemKindValues = EnumValues({
    "ClusterTrustBundle": ItemKind.CLUSTER_TRUST_BUNDLE
});
...
@JsonSerializable()
class IoK8SApiCertificatesV1Alpha1ClusterTrustBundleSpec {
    ...
    factory IoK8SApiCertificatesV1Alpha1ClusterTrustBundleSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiCertificatesV1Alpha1ClusterTrustBundleSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCertificatesV1Alpha1ClusterTrustBundleSpecToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ClustertrustbundlelistCertificatesV1Alpha1Kind {
    @JsonValue("ClusterTrustBundleList")
    CLUSTER_TRUST_BUNDLE_LIST
}

final clustertrustbundlelistCertificatesV1Alpha1KindValues = EnumValues({
    "ClusterTrustBundleList": ClustertrustbundlelistCertificatesV1Alpha1Kind.CLUSTER_TRUST_BUNDLE_LIST
});
