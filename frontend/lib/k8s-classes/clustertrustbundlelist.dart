...
part 'clustertrustbundlelist.g.dart';
...
class Clustertrustbundlelist {
    ...
    @JsonKey(name: "kind")
    ClustertrustbundlelistKind? kind;
    ...
    factory Clustertrustbundlelist.fromJson(Map<String, dynamic> json) => _$ClustertrustbundlelistFromJson(json);

    Map<String, dynamic> toJson() => _$ClustertrustbundlelistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ClustertrustbundlelistKind {
    @JsonValue("ClusterTrustBundleList")
    CLUSTER_TRUST_BUNDLE_LIST
}

final clustertrustbundlelistKindValues = EnumValues({
    "ClusterTrustBundleList": ClustertrustbundlelistKind.CLUSTER_TRUST_BUNDLE_LIST
});
