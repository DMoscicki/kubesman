...
part 'clustertrustbundleprojection_v1.g.dart';
...
@JsonSerializable()
class ClustertrustbundleprojectionV1 {
    ...
    ClustertrustbundleprojectionV1({
        this.labelSelector,
        this.name,
        this.optional,
        required this.path,
    ...
    factory ClustertrustbundleprojectionV1.fromJson(Map<String, dynamic> json) => _$ClustertrustbundleprojectionV1FromJson(json);

    Map<String, dynamic> toJson() => _$ClustertrustbundleprojectionV1ToJson(this);
}
