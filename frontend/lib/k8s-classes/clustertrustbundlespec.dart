...
part 'clustertrustbundlespec.g.dart';
...
class Clustertrustbundlespec {
    ...
    factory Clustertrustbundlespec.fromJson(Map<String, dynamic> json) => _$ClustertrustbundlespecFromJson(json);

    Map<String, dynamic> toJson() => _$ClustertrustbundlespecToJson(this);
}
