...
class ComponentstatusV1 {
    ...
    factory ComponentstatusV1.fromJson(Map<String, dynamic> json) => _$ComponentstatusV1FromJson(json);

    Map<String, dynamic> toJson() => _$ComponentstatusV1ToJson(this);
}
...
final kindValues = EnumValues({
    "ComponentStatus": Kind.COMPONENT_STATUS
});
