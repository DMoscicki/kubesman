...
class Componentstatus {
    ...
    factory Componentstatus.fromJson(Map<String, dynamic> json) => _$ComponentstatusFromJson(json);

    Map<String, dynamic> toJson() => _$ComponentstatusToJson(this);
}
