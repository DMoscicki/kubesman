...
part 'componentstatuslist.g.dart';
...
class Componentstatuslist {
    ...
    factory Componentstatuslist.fromJson(Map<String, dynamic> json) => _$ComponentstatuslistFromJson(json);

    Map<String, dynamic> toJson() => _$ComponentstatuslistToJson(this);
}


///ComponentStatus (and ComponentStatusList) holds the cluster validation info. Deprecated:
...
class IoK8SApiCoreV1ComponentStatus {
    ...
    factory IoK8SApiCoreV1ComponentStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ComponentStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ComponentStatusToJson(this);
}
...
class IoK8SApiCoreV1ComponentCondition {
    ...
    factory IoK8SApiCoreV1ComponentCondition.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ComponentConditionFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ComponentConditionToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ComponentstatuslistKind {
    @JsonValue("ComponentStatusList")
    COMPONENT_STATUS_LIST
}

final componentstatuslistKindValues = EnumValues({
    "ComponentStatusList": ComponentstatuslistKind.COMPONENT_STATUS_LIST
});
