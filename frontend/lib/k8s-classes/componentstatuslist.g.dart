...
part of 'componentstatuslist.dart';
...
Componentstatuslist _$ComponentstatuslistFromJson(Map<String, dynamic> json) =>
    Componentstatuslist(
      ...
      items: (json['items'] as List<dynamic>?)
          ?.map((e) =>
              IoK8SApiCoreV1ComponentStatus.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$ComponentstatuslistKindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ComponentstatuslistToJson(
        Componentstatuslist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$ComponentstatuslistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ComponentstatuslistKindEnumMap = {
  ComponentstatuslistKind.COMPONENT_STATUS_LIST: 'ComponentStatusList',
};

IoK8SApiCoreV1ComponentStatus _$IoK8SApiCoreV1ComponentStatusFromJson(
...
Map<String, dynamic> _$IoK8SApiCoreV1ComponentStatusToJson(
        IoK8SApiCoreV1ComponentStatus instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.COMPONENT_STATUS: 'ComponentStatus',
};
