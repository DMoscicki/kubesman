...
class ConfigmapV1 {
    ...
    factory ConfigmapV1.fromJson(Map<String, dynamic> json) => _$ConfigmapV1FromJson(json);

    Map<String, dynamic> toJson() => _$ConfigmapV1ToJson(this);
}
