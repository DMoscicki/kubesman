...
class Configmaplist {
    ...
    factory Configmaplist.fromJson(Map<String, dynamic> json) => _$ConfigmaplistFromJson(json);

    Map<String, dynamic> toJson() => _$ConfigmaplistToJson(this);
}
...
class IoK8SApiCoreV1ConfigMap {
    ...
    factory IoK8SApiCoreV1ConfigMap.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ConfigMapFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ConfigMapToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ConfigmaplistKind {
    @JsonValue("ConfigMapList")
    CONFIG_MAP_LIST
}

final configmaplistKindValues = EnumValues({
    "ConfigMapList": ConfigmaplistKind.CONFIG_MAP_LIST
});
