...
part 'containerresourcemetricsource_autoscaling_v2.g.dart';
...
@JsonSerializable()
class ContainerresourcemetricsourceAutoscalingV2 {
    ...
    ContainerresourcemetricsourceAutoscalingV2({
        required this.container,
        required this.name,
        required this.target,
    });

    factory ContainerresourcemetricsourceAutoscalingV2.fromJson(Map<String, dynamic> json) => _$ContainerresourcemetricsourceAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$ContainerresourcemetricsourceAutoscalingV2ToJson(this);
}
