...
part 'controllerrevision_apps_v1.g.dart';
...
///controllers.
@JsonSerializable()
class ControllerrevisionAppsV1 {
    ...
    factory ControllerrevisionAppsV1.fromJson(Map<String, dynamic> json) => _$ControllerrevisionAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$ControllerrevisionAppsV1ToJson(this);
}
...
final kindValues = EnumValues({
    "ControllerRevision": Kind.CONTROLLER_REVISION
});
