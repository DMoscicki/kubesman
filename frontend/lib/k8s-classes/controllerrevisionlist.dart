...
part 'controllerrevisionlist.g.dart';
...
class Controllerrevisionlist {
    ...
    @JsonKey(name: "kind")
    ControllerrevisionlistKind? kind;
    ...
    factory Controllerrevisionlist.fromJson(Map<String, dynamic> json) => _$ControllerrevisionlistFromJson(json);

    Map<String, dynamic> toJson() => _$ControllerrevisionlistToJson(this);
}
...
///the DaemonSet and StatefulSet controllers for update and rollback, this object is beta.
///However, it may be subject to name and representation changes in future releases, and
///clients should not depend on its stability. It is primarily for internal use by
///controllers.
@JsonSerializable()
class IoK8SApiAppsV1ControllerRevision {
    ...
    factory IoK8SApiAppsV1ControllerRevision.fromJson(Map<String, dynamic> json) => _$IoK8SApiAppsV1ControllerRevisionFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAppsV1ControllerRevisionToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ControllerrevisionlistKind {
    @JsonValue("ControllerRevisionList")
    CONTROLLER_REVISION_LIST
}

final controllerrevisionlistKindValues = EnumValues({
    "ControllerRevisionList": ControllerrevisionlistKind.CONTROLLER_REVISION_LIST
});
