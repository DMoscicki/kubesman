...
part 'cronjob_batch_v1.g.dart';


///CronJob represents the configuration of a single cron job.
@JsonSerializable()
class CronjobBatchV1 {
    ...
    factory CronjobBatchV1.fromJson(Map<String, dynamic> json) => _$CronjobBatchV1FromJson(json);

    Map<String, dynamic> toJson() => _$CronjobBatchV1ToJson(this);
}
