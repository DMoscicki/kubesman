...
part 'cronjobspec_batch_v1.g.dart';


///CronJobSpec describes how the job execution will look like and when it will actually run.
@JsonSerializable()
class CronjobspecBatchV1 {
    ...
    factory CronjobspecBatchV1.fromJson(Map<String, dynamic> json) => _$CronjobspecBatchV1FromJson(json);

    Map<String, dynamic> toJson() => _$CronjobspecBatchV1ToJson(this);
}
