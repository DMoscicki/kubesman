...
class Cronjobspec {
    ...
    factory Cronjobspec.fromJson(Map<String, dynamic> json) => _$CronjobspecFromJson(json);

    Map<String, dynamic> toJson() => _$CronjobspecToJson(this);
}
