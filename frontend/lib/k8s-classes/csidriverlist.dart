...
class Csidriverlist {
    ...
    factory Csidriverlist.fromJson(Map<String, dynamic> json) => _$CsidriverlistFromJson(json);

    Map<String, dynamic> toJson() => _$CsidriverlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum CsidriverlistKind {
    @JsonValue("CSIDriverList")
    CSI_DRIVER_LIST
}

final csidriverlistKindValues = EnumValues({
    "CSIDriverList": CsidriverlistKind.CSI_DRIVER_LIST
});
