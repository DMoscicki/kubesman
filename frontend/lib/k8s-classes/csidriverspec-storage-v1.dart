...
part 'csidriverspec_storage_v1.g.dart';


///CSIDriverSpec is the specification of a CSIDriver.
@JsonSerializable()
class CsidriverspecStorageV1 {
    ...
    factory CsidriverspecStorageV1.fromJson(Map<String, dynamic> json) => _$CsidriverspecStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$CsidriverspecStorageV1ToJson(this);
}
