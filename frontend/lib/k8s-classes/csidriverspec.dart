...
class Csidriverspec {
    ...
    factory Csidriverspec.fromJson(Map<String, dynamic> json) => _$CsidriverspecFromJson(json);

    Map<String, dynamic> toJson() => _$CsidriverspecToJson(this);
}
