...
part 'csinode_storage_v1.g.dart';
...
class CsinodeStorageV1 {
    ...
    factory CsinodeStorageV1.fromJson(Map<String, dynamic> json) => _$CsinodeStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$CsinodeStorageV1ToJson(this);
}
