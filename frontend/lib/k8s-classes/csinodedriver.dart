...
class Csinodedriver {
    ...
    factory Csinodedriver.fromJson(Map<String, dynamic> json) => _$CsinodedriverFromJson(json);

    Map<String, dynamic> toJson() => _$CsinodedriverToJson(this);
}
