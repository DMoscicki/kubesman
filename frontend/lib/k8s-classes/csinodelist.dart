...
class Csinodelist {
    ...
    factory Csinodelist.fromJson(Map<String, dynamic> json) => _$CsinodelistFromJson(json);

    Map<String, dynamic> toJson() => _$CsinodelistToJson(this);
}


///CSINode holds information about all CSI drivers installed on a node. CSI drivers do not
///need to create the CSINode object directly. As long as they use the node-driver-registrar
///sidecar container, the kubelet will automatically populate the CSINode object for the CSI
///driver as part of kubelet plugin registration. CSINode has the same name as a node. If
///the object is missing, it means either there are no CSI Drivers available on the node, or
///the Kubelet version is low enough that it doesn't create this object. CSINode has an
...
class IoK8SApiStorageV1CsiNode {
    ...
    factory IoK8SApiStorageV1CsiNode.fromJson(Map<String, dynamic> json) => _$IoK8SApiStorageV1CsiNodeFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStorageV1CsiNodeToJson(this);
}
...
class IoK8SApiStorageV1CsiNodeSpec {
    ...
    factory IoK8SApiStorageV1CsiNodeSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiStorageV1CsiNodeSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStorageV1CsiNodeSpecToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum CsinodelistKind {
    @JsonValue("CSINodeList")
    CSI_NODE_LIST
}

final csinodelistKindValues = EnumValues({
    "CSINodeList": CsinodelistKind.CSI_NODE_LIST
});
