...
class Csinodespec {
    ...
    factory Csinodespec.fromJson(Map<String, dynamic> json) => _$CsinodespecFromJson(json);

    Map<String, dynamic> toJson() => _$CsinodespecToJson(this);
}
