...
part 'csipersistentvolumesource.g.dart';
...
class Csipersistentvolumesource {
    ...
    factory Csipersistentvolumesource.fromJson(Map<String, dynamic> json) => _$CsipersistentvolumesourceFromJson(json);

    Map<String, dynamic> toJson() => _$CsipersistentvolumesourceToJson(this);
}
