...
part 'csistoragecapacity_storage_v1.g.dart';
...
@JsonSerializable()
class CsistoragecapacityStorageV1 {
    ...
    factory CsistoragecapacityStorageV1.fromJson(Map<String, dynamic> json) => _$CsistoragecapacityStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$CsistoragecapacityStorageV1ToJson(this);
}
...
final kindValues = EnumValues({
    "CSIStorageCapacity": Kind.CSI_STORAGE_CAPACITY
});
