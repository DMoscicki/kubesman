...
part 'csistoragecapacity.g.dart';
...
class Csistoragecapacity {
    ...
    factory Csistoragecapacity.fromJson(Map<String, dynamic> json) => _$CsistoragecapacityFromJson(json);

    Map<String, dynamic> toJson() => _$CsistoragecapacityToJson(this);
}
