...
class CsistoragecapacitylistStorageV1 {
    ...
    factory CsistoragecapacitylistStorageV1.fromJson(Map<String, dynamic> json) => _$CsistoragecapacitylistStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$CsistoragecapacitylistStorageV1ToJson(this);
}
...
final csistoragecapacitylistStorageV1KindValues = EnumValues({
    "CSIStorageCapacityList": CsistoragecapacitylistStorageV1Kind.CSI_STORAGE_CAPACITY_LIST
});
