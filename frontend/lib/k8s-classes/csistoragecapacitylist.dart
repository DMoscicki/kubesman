...
part 'csistoragecapacitylist.g.dart';
...
class Csistoragecapacitylist {
    ...
    @JsonKey(name: "kind")
    CsistoragecapacitylistKind? kind;
    ...
    factory Csistoragecapacitylist.fromJson(Map<String, dynamic> json) => _$CsistoragecapacitylistFromJson(json);

    Map<String, dynamic> toJson() => _$CsistoragecapacitylistToJson(this);
}
...
///
///For example this can express things like: - StorageClass "standard" has "1234 GiB"
///available in "topology.kubernetes.io/zone=us-east1" - StorageClass "localssd" has "10
///GiB" available in "kubernetes.io/hostname=knode-abc123"
///
...
///object exists, but the capacity is unset - such an object exists, but the capacity is
///zero
///
...
///nodes. If MaximumVolumeSize is unset, it falls back to a comparison against the less
///precise Capacity. If that is also unset, the scheduler assumes that capacity is
...
class IoK8SApiStorageV1CsiStorageCapacity {
    ...
    ///maximumVolumeSize is the value reported by the CSI driver in its GetCapacityResponse for
    ...
    ///parameters as those in GetCapacityRequest. The corresponding value in the Kubernetes API
    ...
    ///subdomain (dots allowed, 253 characters). To ensure that there are no conflicts with
    ///other CSI drivers on the cluster, the recommendation is to use csisc-<uuid>, a generated
    ...
    ///reported. If not set, the storage is not accessible from any node in the cluster. If
    ///empty, the storage is accessible from all nodes. This field is immutable.
    ...
    factory IoK8SApiStorageV1CsiStorageCapacity.fromJson(Map<String, dynamic> json) => _$IoK8SApiStorageV1CsiStorageCapacityFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStorageV1CsiStorageCapacityToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum CsistoragecapacitylistKind {
    @JsonValue("CSIStorageCapacityList")
    CSI_STORAGE_CAPACITY_LIST
}

final csistoragecapacitylistKindValues = EnumValues({
    "CSIStorageCapacityList": CsistoragecapacitylistKind.CSI_STORAGE_CAPACITY_LIST
});
