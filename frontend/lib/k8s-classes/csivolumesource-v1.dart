...
part 'csivolumesource_v1.g.dart';


///Represents a source location of a volume to mount, managed by an external CSI driver
@JsonSerializable()
class CsivolumesourceV1 {
    ...
    factory CsivolumesourceV1.fromJson(Map<String, dynamic> json) => _$CsivolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$CsivolumesourceV1ToJson(this);
}
