...
part 'customresourcedefinitionnames_apiextensions_v1.g.dart';


///CustomResourceDefinitionNames indicates the names to serve this CustomResourceDefinition
@JsonSerializable()
class CustomresourcedefinitionnamesApiextensionsV1 {
    ...
    CustomresourcedefinitionnamesApiextensionsV1({
        this.categories,
        required this.kind,
        this.listKind,
    ...
    factory CustomresourcedefinitionnamesApiextensionsV1.fromJson(Map<String, dynamic> json) => _$CustomresourcedefinitionnamesApiextensionsV1FromJson(json);

    Map<String, dynamic> toJson() => _$CustomresourcedefinitionnamesApiextensionsV1ToJson(this);
}
