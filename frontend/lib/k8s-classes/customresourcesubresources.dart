...
part 'customresourcesubresources.g.dart';
...
class Customresourcesubresources {
    ...
    factory Customresourcesubresources.fromJson(Map<String, dynamic> json) => _$CustomresourcesubresourcesFromJson(json);

    Map<String, dynamic> toJson() => _$CustomresourcesubresourcesToJson(this);
}
