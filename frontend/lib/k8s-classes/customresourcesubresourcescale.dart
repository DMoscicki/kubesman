...
part 'customresourcesubresourcescale.g.dart';
...
class Customresourcesubresourcescale {
    ...
    factory Customresourcesubresourcescale.fromJson(Map<String, dynamic> json) => _$CustomresourcesubresourcescaleFromJson(json);

    Map<String, dynamic> toJson() => _$CustomresourcesubresourcescaleToJson(this);
}
