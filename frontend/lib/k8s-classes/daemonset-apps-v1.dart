...
part 'daemonset_apps_v1.g.dart';


///DaemonSet represents the configuration of a daemon set.
@JsonSerializable()
class DaemonsetAppsV1 {
    ...
    factory DaemonsetAppsV1.fromJson(Map<String, dynamic> json) => _$DaemonsetAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$DaemonsetAppsV1ToJson(this);
}
