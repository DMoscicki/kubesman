...
part 'daemonsetspec_apps_v1.g.dart';


///DaemonSetSpec is the specification of a daemon set.
@JsonSerializable()
class DaemonsetspecAppsV1 {
    ...
    factory DaemonsetspecAppsV1.fromJson(Map<String, dynamic> json) => _$DaemonsetspecAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$DaemonsetspecAppsV1ToJson(this);
}
