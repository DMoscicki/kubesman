...
class Daemonsetspec {
    ...
    factory Daemonsetspec.fromJson(Map<String, dynamic> json) => _$DaemonsetspecFromJson(json);

    Map<String, dynamic> toJson() => _$DaemonsetspecToJson(this);
}
