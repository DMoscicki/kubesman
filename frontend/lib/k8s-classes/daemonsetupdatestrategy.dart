...
part 'daemonsetupdatestrategy.g.dart';
...
class Daemonsetupdatestrategy {
    ...
    factory Daemonsetupdatestrategy.fromJson(Map<String, dynamic> json) => _$DaemonsetupdatestrategyFromJson(json);

    Map<String, dynamic> toJson() => _$DaemonsetupdatestrategyToJson(this);
}
