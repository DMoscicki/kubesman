...
part 'deployment_apps_v1.g.dart';


///Deployment enables declarative updates for Pods and ReplicaSets.
@JsonSerializable()
class DeploymentAppsV1 {
    ...
    factory DeploymentAppsV1.fromJson(Map<String, dynamic> json) => _$DeploymentAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$DeploymentAppsV1ToJson(this);
}
