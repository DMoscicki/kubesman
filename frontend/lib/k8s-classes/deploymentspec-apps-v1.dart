...
part 'deploymentspec_apps_v1.g.dart';


///DeploymentSpec is the specification of the desired behavior of the Deployment.
@JsonSerializable()
class DeploymentspecAppsV1 {
    ...
    factory DeploymentspecAppsV1.fromJson(Map<String, dynamic> json) => _$DeploymentspecAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$DeploymentspecAppsV1ToJson(this);
}
