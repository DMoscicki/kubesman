...
part 'deploymentstrategy_apps_v1.g.dart';


///DeploymentStrategy describes how to replace existing pods with new ones.
@JsonSerializable()
class DeploymentstrategyAppsV1 {
    ...
    DeploymentstrategyAppsV1({
        this.rollingUpdate,
        this.type,
    });

    factory DeploymentstrategyAppsV1.fromJson(Map<String, dynamic> json) => _$DeploymentstrategyAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$DeploymentstrategyAppsV1ToJson(this);
}
