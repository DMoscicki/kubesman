...
part 'downwardapivolumefile_v1.g.dart';


///DownwardAPIVolumeFile represents information to create the file containing the pod field
@JsonSerializable()
class DownwardapivolumefileV1 {
    ...
    factory DownwardapivolumefileV1.fromJson(Map<String, dynamic> json) => _$DownwardapivolumefileV1FromJson(json);

    Map<String, dynamic> toJson() => _$DownwardapivolumefileV1ToJson(this);
}
