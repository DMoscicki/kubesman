...
class Driverrequests {
    ...
    factory Driverrequests.fromJson(Map<String, dynamic> json) => _$DriverrequestsFromJson(json);

    Map<String, dynamic> toJson() => _$DriverrequestsToJson(this);
}
