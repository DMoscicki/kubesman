...
part 'endpointaddress_v1.g.dart';


///EndpointAddress is a tuple that describes single IP address.
@JsonSerializable()
class EndpointaddressV1 {
    ...
    factory EndpointaddressV1.fromJson(Map<String, dynamic> json) => _$EndpointaddressV1FromJson(json);

    Map<String, dynamic> toJson() => _$EndpointaddressV1ToJson(this);
}
