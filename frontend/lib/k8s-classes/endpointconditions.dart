...
part 'endpointconditions.g.dart';
...
class Endpointconditions {
    ...
    factory Endpointconditions.fromJson(Map<String, dynamic> json) => _$EndpointconditionsFromJson(json);

    Map<String, dynamic> toJson() => _$EndpointconditionsToJson(this);
}
