...
part 'endpointport_discovery_v1.g.dart';


///EndpointPort represents a Port used by an EndpointSlice
@JsonSerializable()
class EndpointportDiscoveryV1 {
    ...
    factory EndpointportDiscoveryV1.fromJson(Map<String, dynamic> json) => _$EndpointportDiscoveryV1FromJson(json);

    Map<String, dynamic> toJson() => _$EndpointportDiscoveryV1ToJson(this);
}
