...
class EndpointsV1 {
    ...
    factory EndpointsV1.fromJson(Map<String, dynamic> json) => _$EndpointsV1FromJson(json);

    Map<String, dynamic> toJson() => _$EndpointsV1ToJson(this);
}
