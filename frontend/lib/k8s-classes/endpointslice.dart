...
class Endpointslice {
    ...
    factory Endpointslice.fromJson(Map<String, dynamic> json) => _$EndpointsliceFromJson(json);

    Map<String, dynamic> toJson() => _$EndpointsliceToJson(this);
}
