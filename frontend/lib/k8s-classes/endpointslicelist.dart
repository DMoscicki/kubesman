...
class Endpointslicelist {
    ...
    factory Endpointslicelist.fromJson(Map<String, dynamic> json) => _$EndpointslicelistFromJson(json);

    Map<String, dynamic> toJson() => _$EndpointslicelistToJson(this);
}
...
class IoK8SApiDiscoveryV1EndpointSlice {
    ...
    factory IoK8SApiDiscoveryV1EndpointSlice.fromJson(Map<String, dynamic> json) => _$IoK8SApiDiscoveryV1EndpointSliceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiDiscoveryV1EndpointSliceToJson(this);
}
...
final itemKindValues = EnumValues({
    "EndpointSlice": ItemKind.ENDPOINT_SLICE
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum EndpointslicelistKind {
    @JsonValue("EndpointSliceList")
    ENDPOINT_SLICE_LIST
}

final endpointslicelistKindValues = EnumValues({
    "EndpointSliceList": EndpointslicelistKind.ENDPOINT_SLICE_LIST
});
