...
class Endpointslist {
    ...
    factory Endpointslist.fromJson(Map<String, dynamic> json) => _$EndpointslistFromJson(json);

    Map<String, dynamic> toJson() => _$EndpointslistToJson(this);
}
...
class IoK8SApiCoreV1Endpoints {
    ...
    factory IoK8SApiCoreV1Endpoints.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1EndpointsFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1EndpointsToJson(this);
}
...
class IoK8SApiCoreV1EndpointSubset {
    ...
    factory IoK8SApiCoreV1EndpointSubset.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1EndpointSubsetFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1EndpointSubsetToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum EndpointslistKind {
    @JsonValue("EndpointsList")
    ENDPOINTS_LIST
}

final endpointslistKindValues = EnumValues({
    "EndpointsList": EndpointslistKind.ENDPOINTS_LIST
});
