...
class EndpointsubsetV1 {
    ...
    factory EndpointsubsetV1.fromJson(Map<String, dynamic> json) => _$EndpointsubsetV1FromJson(json);

    Map<String, dynamic> toJson() => _$EndpointsubsetV1ToJson(this);
}
