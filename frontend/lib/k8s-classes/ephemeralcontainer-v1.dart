...
part 'ephemeralcontainer_v1.g.dart';
...
class EphemeralcontainerV1 {
    ...
    factory EphemeralcontainerV1.fromJson(Map<String, dynamic> json) => _$EphemeralcontainerV1FromJson(json);

    Map<String, dynamic> toJson() => _$EphemeralcontainerV1ToJson(this);
}
