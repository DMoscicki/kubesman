...
part 'ephemeralvolumesource_v1.g.dart';


///Represents an ephemeral volume that is handled by a normal storage driver.
@JsonSerializable()
class EphemeralvolumesourceV1 {
    ...
    factory EphemeralvolumesourceV1.fromJson(Map<String, dynamic> json) => _$EphemeralvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$EphemeralvolumesourceV1ToJson(this);
}
