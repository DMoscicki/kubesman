...
class EventEventsV1 {
    ...
    factory EventEventsV1.fromJson(Map<String, dynamic> json) => _$EventEventsV1FromJson(json);

    Map<String, dynamic> toJson() => _$EventEventsV1ToJson(this);
}
