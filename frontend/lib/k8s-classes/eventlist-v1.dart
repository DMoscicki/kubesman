...
class EventlistV1 {
    ...
    factory EventlistV1.fromJson(Map<String, dynamic> json) => _$EventlistV1FromJson(json);
...
///the timing of an event with a given Reason reflecting a consistent underlying trigger, or
///the continued existence of events with that Reason.  Events should be treated as
...
class IoK8SApiCoreV1Event {
    ...
    @JsonKey(name: "source")
    IoK8SApiCoreV1EventSource? source;
    ...
    factory IoK8SApiCoreV1Event.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1EventFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1EventToJson(this);
}
...
class IoK8SApiCoreV1EventSeries {
    ...
    factory IoK8SApiCoreV1EventSeries.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1EventSeriesFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1EventSeriesToJson(this);
}
