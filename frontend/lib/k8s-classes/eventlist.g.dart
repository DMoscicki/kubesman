...
Eventlist _$EventlistFromJson(Map<String, dynamic> json) => Eventlist(
      ...
      items: (json['items'] as List<dynamic>?)
          ?.map(
              (e) => IoK8SApiEventsV1Event.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$EventlistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$EventlistToJson(Eventlist instance) => <String, dynamic>{
      ...
      'kind': _$EventlistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$EventlistKindEnumMap = {
  EventlistKind.EVENT_LIST: 'EventList',
};

IoK8SApiEventsV1Event _$IoK8SApiEventsV1EventFromJson(
...
Map<String, dynamic> _$IoK8SApiEventsV1EventToJson(
        IoK8SApiEventsV1Event instance) =>
    <String, dynamic>{
