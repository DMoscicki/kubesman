...
part 'eviction_policy_v1.g.dart';
...
class EvictionPolicyV1 {
    ...
    factory EvictionPolicyV1.fromJson(Map<String, dynamic> json) => _$EvictionPolicyV1FromJson(json);

    Map<String, dynamic> toJson() => _$EvictionPolicyV1ToJson(this);
}
...
class IoK8SApimachineryPkgApisMetaV1DeleteOptions {
    ...
    factory IoK8SApimachineryPkgApisMetaV1DeleteOptions.fromJson(Map<String, dynamic> json) => _$IoK8SApimachineryPkgApisMetaV1DeleteOptionsFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApimachineryPkgApisMetaV1DeleteOptionsToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum DeleteOptionsKind {
    @JsonValue("DeleteOptions")
    DELETE_OPTIONS
}

final deleteOptionsKindValues = EnumValues({
    "DeleteOptions": DeleteOptionsKind.DELETE_OPTIONS
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum EvictionPolicyV1Kind {
    @JsonValue("Eviction")
    EVICTION
}

final evictionPolicyV1KindValues = EnumValues({
    "Eviction": EvictionPolicyV1Kind.EVICTION
});
