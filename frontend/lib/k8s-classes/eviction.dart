...
class Eviction {
    ...
    factory Eviction.fromJson(Map<String, dynamic> json) => _$EvictionFromJson(json);

    Map<String, dynamic> toJson() => _$EvictionToJson(this);
}
...
final evictionKindValues = EnumValues({
