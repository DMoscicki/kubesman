...
part 'exemptprioritylevelconfiguration_flowcontrol_v1.g.dart';
...
@JsonSerializable()
class ExemptprioritylevelconfigurationFlowcontrolV1 {
    ...
    ExemptprioritylevelconfigurationFlowcontrolV1({
        this.lendablePercent,
        this.nominalConcurrencyShares,
    });

    factory ExemptprioritylevelconfigurationFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$ExemptprioritylevelconfigurationFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$ExemptprioritylevelconfigurationFlowcontrolV1ToJson(this);
}
