...
part 'exemptprioritylevelconfiguration_flowcontrol_v1_beta3.g.dart';
...
@JsonSerializable()
class ExemptprioritylevelconfigurationFlowcontrolV1Beta3 {
    ...
    ExemptprioritylevelconfigurationFlowcontrolV1Beta3({
        this.lendablePercent,
        this.nominalConcurrencyShares,
    });

    factory ExemptprioritylevelconfigurationFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$ExemptprioritylevelconfigurationFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$ExemptprioritylevelconfigurationFlowcontrolV1Beta3ToJson(this);
}
