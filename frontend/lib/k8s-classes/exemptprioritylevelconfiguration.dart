...
part 'exemptprioritylevelconfiguration.g.dart';
...
class Exemptprioritylevelconfiguration {
    ...
    factory Exemptprioritylevelconfiguration.fromJson(Map<String, dynamic> json) => _$ExemptprioritylevelconfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$ExemptprioritylevelconfigurationToJson(this);
}
