...
part 'expressionwarning_admissionregistration_v1.g.dart';


///ExpressionWarning is a warning information that targets a specific expression.
@JsonSerializable()
class ExpressionwarningAdmissionregistrationV1 {
    ...
    ExpressionwarningAdmissionregistrationV1({
        required this.fieldRef,
        required this.warning,
    });

    factory ExpressionwarningAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ExpressionwarningAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ExpressionwarningAdmissionregistrationV1ToJson(this);
}
