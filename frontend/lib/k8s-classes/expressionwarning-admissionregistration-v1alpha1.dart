...
part 'expressionwarning_admissionregistration_v1_alpha1.g.dart';


///ExpressionWarning is a warning information that targets a specific expression.
@JsonSerializable()
class ExpressionwarningAdmissionregistrationV1Alpha1 {
    ...
    ExpressionwarningAdmissionregistrationV1Alpha1({
        required this.fieldRef,
        required this.warning,
    });

    factory ExpressionwarningAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ExpressionwarningAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ExpressionwarningAdmissionregistrationV1Alpha1ToJson(this);
}
