...
part 'externalmetricsource_autoscaling_v2.g.dart';
...
@JsonSerializable()
class ExternalmetricsourceAutoscalingV2 {
    ...
    ExternalmetricsourceAutoscalingV2({
        required this.metric,
        required this.target,
    });

    factory ExternalmetricsourceAutoscalingV2.fromJson(Map<String, dynamic> json) => _$ExternalmetricsourceAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$ExternalmetricsourceAutoscalingV2ToJson(this);
}
