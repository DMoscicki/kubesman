...
part 'externalmetricsource.g.dart';
...
class Externalmetricsource {
    ...
    factory Externalmetricsource.fromJson(Map<String, dynamic> json) => _$ExternalmetricsourceFromJson(json);

    Map<String, dynamic> toJson() => _$ExternalmetricsourceToJson(this);
}
