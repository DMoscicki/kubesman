...
part 'externalmetricstatus.g.dart';
...
class Externalmetricstatus {
    ...
    factory Externalmetricstatus.fromJson(Map<String, dynamic> json) => _$ExternalmetricstatusFromJson(json);

    Map<String, dynamic> toJson() => _$ExternalmetricstatusToJson(this);
}
