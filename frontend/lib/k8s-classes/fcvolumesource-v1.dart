...
class FcvolumesourceV1 {
    ...
    factory FcvolumesourceV1.fromJson(Map<String, dynamic> json) => _$FcvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$FcvolumesourceV1ToJson(this);
}
