...
part 'flexpersistentvolumesource_v1.g.dart';


///FlexPersistentVolumeSource represents a generic persistent volume resource that is
///provisioned/attached using an exec based plugin.
@JsonSerializable()
class FlexpersistentvolumesourceV1 {
    ...
    factory FlexpersistentvolumesourceV1.fromJson(Map<String, dynamic> json) => _$FlexpersistentvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$FlexpersistentvolumesourceV1ToJson(this);
}
