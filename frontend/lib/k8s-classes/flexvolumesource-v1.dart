...
class FlexvolumesourceV1 {
    ...
    factory FlexvolumesourceV1.fromJson(Map<String, dynamic> json) => _$FlexvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$FlexvolumesourceV1ToJson(this);
}
