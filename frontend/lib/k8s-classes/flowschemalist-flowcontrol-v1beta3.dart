...
part 'flowschemalist_flowcontrol_v1_beta3.g.dart';


///FlowSchemaList is a list of FlowSchema objects.
@JsonSerializable()
class FlowschemalistFlowcontrolV1Beta3 {
    ...
    @JsonKey(name: "kind")
    FlowschemalistFlowcontrolV1Beta3Kind? kind;
    ...
    FlowschemalistFlowcontrolV1Beta3({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory FlowschemalistFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$FlowschemalistFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$FlowschemalistFlowcontrolV1Beta3ToJson(this);
}
...
class IoK8SApiFlowcontrolV1Beta3FlowSchema {
    ...
    factory IoK8SApiFlowcontrolV1Beta3FlowSchema.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1Beta3FlowSchemaFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1Beta3FlowSchemaToJson(this);
}
...
class IoK8SApiFlowcontrolV1Beta3FlowSchemaSpec {
    ...
    factory IoK8SApiFlowcontrolV1Beta3FlowSchemaSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1Beta3FlowSchemaSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1Beta3FlowSchemaSpecToJson(this);
}
...
class IoK8SApiFlowcontrolV1Beta3FlowSchemaStatus {
    ...
    factory IoK8SApiFlowcontrolV1Beta3FlowSchemaStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1Beta3FlowSchemaStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1Beta3FlowSchemaStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum FlowschemalistFlowcontrolV1Beta3Kind {
    @JsonValue("FlowSchemaList")
    FLOW_SCHEMA_LIST
}

final flowschemalistFlowcontrolV1Beta3KindValues = EnumValues({
    "FlowSchemaList": FlowschemalistFlowcontrolV1Beta3Kind.FLOW_SCHEMA_LIST
});
