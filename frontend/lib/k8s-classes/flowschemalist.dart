...
class Flowschemalist {
    ...
    factory Flowschemalist.fromJson(Map<String, dynamic> json) => _$FlowschemalistFromJson(json);

    Map<String, dynamic> toJson() => _$FlowschemalistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum FlowschemalistKind {
    @JsonValue("FlowSchemaList")
    FLOW_SCHEMA_LIST
}

final flowschemalistKindValues = EnumValues({
    "FlowSchemaList": FlowschemalistKind.FLOW_SCHEMA_LIST
});
