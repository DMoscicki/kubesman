...
class Flowschemaspec {
    ...
    factory Flowschemaspec.fromJson(Map<String, dynamic> json) => _$FlowschemaspecFromJson(json);

    Map<String, dynamic> toJson() => _$FlowschemaspecToJson(this);
}
