...
part 'gcepersistentdiskvolumesource.g.dart';
...
class Gcepersistentdiskvolumesource {
    ...
    factory Gcepersistentdiskvolumesource.fromJson(Map<String, dynamic> json) => _$GcepersistentdiskvolumesourceFromJson(json);
