...
part 'horizontalpodautoscaler_autoscaling_v1.g.dart';


///configuration of a horizontal pod autoscaler.
@JsonSerializable()
class HorizontalpodautoscalerAutoscalingV1 {
    ...
    factory HorizontalpodautoscalerAutoscalingV1.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerAutoscalingV1FromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerAutoscalingV1ToJson(this);
}
...
final kindValues = EnumValues({
    "HorizontalPodAutoscaler": Kind.HORIZONTAL_POD_AUTOSCALER
});
