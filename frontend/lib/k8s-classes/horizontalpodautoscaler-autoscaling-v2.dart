...
part 'horizontalpodautoscaler_autoscaling_v2.g.dart';
...
class HorizontalpodautoscalerAutoscalingV2 {
    ...
    factory HorizontalpodautoscalerAutoscalingV2.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerAutoscalingV2ToJson(this);
}
