...
part 'horizontalpodautoscaler.g.dart';
...
class Horizontalpodautoscaler {
    ...
    factory Horizontalpodautoscaler.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerFromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerToJson(this);
}
