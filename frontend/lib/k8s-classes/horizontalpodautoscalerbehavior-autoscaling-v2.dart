...
part 'horizontalpodautoscalerbehavior_autoscaling_v2.g.dart';
...
@JsonSerializable()
class HorizontalpodautoscalerbehaviorAutoscalingV2 {
    ...
    HorizontalpodautoscalerbehaviorAutoscalingV2({
        this.scaleDown,
        this.scaleUp,
    });

    factory HorizontalpodautoscalerbehaviorAutoscalingV2.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerbehaviorAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerbehaviorAutoscalingV2ToJson(this);
}
