...
part 'horizontalpodautoscalerbehavior.g.dart';
...
class Horizontalpodautoscalerbehavior {
    ...
    factory Horizontalpodautoscalerbehavior.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerbehaviorFromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerbehaviorToJson(this);
}
