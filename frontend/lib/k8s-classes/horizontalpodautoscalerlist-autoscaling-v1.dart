...
class HorizontalpodautoscalerlistAutoscalingV1 {
    ...
    factory HorizontalpodautoscalerlistAutoscalingV1.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerlistAutoscalingV1FromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerlistAutoscalingV1ToJson(this);
}
...
class IoK8SApiAutoscalingV1HorizontalPodAutoscaler {
    ...
    factory IoK8SApiAutoscalingV1HorizontalPodAutoscaler.fromJson(Map<String, dynamic> json) => _$IoK8SApiAutoscalingV1HorizontalPodAutoscalerFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAutoscalingV1HorizontalPodAutoscalerToJson(this);
}
...
class IoK8SApiAutoscalingV1HorizontalPodAutoscalerSpec {
    ...
    factory IoK8SApiAutoscalingV1HorizontalPodAutoscalerSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAutoscalingV1HorizontalPodAutoscalerSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAutoscalingV1HorizontalPodAutoscalerSpecToJson(this);
}
...
class IoK8SApiAutoscalingV1HorizontalPodAutoscalerStatus {
    ...
    factory IoK8SApiAutoscalingV1HorizontalPodAutoscalerStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAutoscalingV1HorizontalPodAutoscalerStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAutoscalingV1HorizontalPodAutoscalerStatusToJson(this);
}
...
final horizontalpodautoscalerlistAutoscalingV1KindValues = EnumValues({
    "HorizontalPodAutoscalerList": HorizontalpodautoscalerlistAutoscalingV1Kind.HORIZONTAL_POD_AUTOSCALER_LIST
});
