...
class HorizontalpodautoscalerlistAutoscalingV2 {
    ...
    factory HorizontalpodautoscalerlistAutoscalingV2.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerlistAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerlistAutoscalingV2ToJson(this);
}
...
final horizontalpodautoscalerlistAutoscalingV2KindValues = EnumValues({
    "HorizontalPodAutoscalerList": HorizontalpodautoscalerlistAutoscalingV2Kind.HORIZONTAL_POD_AUTOSCALER_LIST
});
