...
part 'horizontalpodautoscalerspec_autoscaling_v2.g.dart';
...
class HorizontalpodautoscalerspecAutoscalingV2 {
    ...
    factory HorizontalpodautoscalerspecAutoscalingV2.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerspecAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerspecAutoscalingV2ToJson(this);
}
