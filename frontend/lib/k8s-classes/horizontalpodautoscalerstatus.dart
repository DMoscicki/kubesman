...
part 'horizontalpodautoscalerstatus.g.dart';
...
class Horizontalpodautoscalerstatus {
    ...
    factory Horizontalpodautoscalerstatus.fromJson(Map<String, dynamic> json) => _$HorizontalpodautoscalerstatusFromJson(json);

    Map<String, dynamic> toJson() => _$HorizontalpodautoscalerstatusToJson(this);
}
