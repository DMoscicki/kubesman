...
part 'hpascalingrules_autoscaling_v2.g.dart';
...
@JsonSerializable()
class HpascalingrulesAutoscalingV2 {
    ...
    HpascalingrulesAutoscalingV2({
        this.policies,
        this.selectPolicy,
        this.stabilizationWindowSeconds,
    });

    factory HpascalingrulesAutoscalingV2.fromJson(Map<String, dynamic> json) => _$HpascalingrulesAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$HpascalingrulesAutoscalingV2ToJson(this);
}
