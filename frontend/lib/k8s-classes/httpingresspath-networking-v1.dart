...
class HttpingresspathNetworkingV1 {
    ...
    HttpingresspathNetworkingV1({
        required this.backend,
        this.path,
        required this.pathType,
    });

    factory HttpingresspathNetworkingV1.fromJson(Map<String, dynamic> json) => _$HttpingresspathNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$HttpingresspathNetworkingV1ToJson(this);
}
