...
part 'httpingressrulevalue_networking_v1.g.dart';
...
///before the first '?' or '#'.
@JsonSerializable()
class HttpingressrulevalueNetworkingV1 {
    
    ///paths is a collection of paths that map requests to backends.
    @JsonKey(name: "paths")
    List<IoK8SApiNetworkingV1HttpIngressPath>? paths;

    HttpingressrulevalueNetworkingV1({
        required this.paths,
    });

    factory HttpingressrulevalueNetworkingV1.fromJson(Map<String, dynamic> json) => _$HttpingressrulevalueNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$HttpingressrulevalueNetworkingV1ToJson(this);
}
