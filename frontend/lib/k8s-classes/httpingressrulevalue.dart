...
part 'httpingressrulevalue.g.dart';
...
class Httpingressrulevalue {
    ...
    factory Httpingressrulevalue.fromJson(Map<String, dynamic> json) => _$HttpingressrulevalueFromJson(json);

    Map<String, dynamic> toJson() => _$HttpingressrulevalueToJson(this);
}
