...
part 'ingress_networking_v1.g.dart';
...
class IngressNetworkingV1 {
    ...
    factory IngressNetworkingV1.fromJson(Map<String, dynamic> json) => _$IngressNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$IngressNetworkingV1ToJson(this);
}
