...
class Ingressbackend {
    ...
    factory Ingressbackend.fromJson(Map<String, dynamic> json) => _$IngressbackendFromJson(json);

    Map<String, dynamic> toJson() => _$IngressbackendToJson(this);
}
