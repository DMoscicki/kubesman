...
part 'ingressclass_networking_v1.g.dart';
...
///this default class.
@JsonSerializable()
class IngressclassNetworkingV1 {
    ...
    factory IngressclassNetworkingV1.fromJson(Map<String, dynamic> json) => _$IngressclassNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$IngressclassNetworkingV1ToJson(this);
}
...
final kindValues = EnumValues({
    "IngressClass": Kind.INGRESS_CLASS
});
