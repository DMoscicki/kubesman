...
class Ingressclass {
    ...
    factory Ingressclass.fromJson(Map<String, dynamic> json) => _$IngressclassFromJson(json);

    Map<String, dynamic> toJson() => _$IngressclassToJson(this);
}
