...
class Ingressclasslist {
    ...
    factory Ingressclasslist.fromJson(Map<String, dynamic> json) => _$IngressclasslistFromJson(json);

    Map<String, dynamic> toJson() => _$IngressclasslistToJson(this);
}
...
class IoK8SApiNetworkingV1IngressClass {
    ...
    factory IoK8SApiNetworkingV1IngressClass.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1IngressClassFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1IngressClassToJson(this);
}
...
final itemKindValues = EnumValues({
    "IngressClass": ItemKind.INGRESS_CLASS
});
...
class IoK8SApiNetworkingV1IngressClassSpec {
    ...
    factory IoK8SApiNetworkingV1IngressClassSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1IngressClassSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1IngressClassSpecToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum IngressclasslistKind {
    @JsonValue("IngressClassList")
    INGRESS_CLASS_LIST
}

final ingressclasslistKindValues = EnumValues({
    "IngressClassList": IngressclasslistKind.INGRESS_CLASS_LIST
});
