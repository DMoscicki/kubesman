...
part of 'ingressclasslist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Ingressclasslist _$IngressclasslistFromJson(Map<String, dynamic> json) =>
    Ingressclasslist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiNetworkingV1IngressClass.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$IngressclasslistKindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$IngressclasslistToJson(Ingressclasslist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$IngressclasslistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$IngressclasslistKindEnumMap = {
  IngressclasslistKind.INGRESS_CLASS_LIST: 'IngressClassList',
};

IoK8SApiNetworkingV1IngressClass _$IoK8SApiNetworkingV1IngressClassFromJson(
...
Map<String, dynamic> _$IoK8SApiNetworkingV1IngressClassToJson(
        IoK8SApiNetworkingV1IngressClass instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.INGRESS_CLASS: 'IngressClass',
};
