...
part 'ingressclassspec_networking_v1.g.dart';


///IngressClassSpec provides information about the class of an Ingress.
@JsonSerializable()
class IngressclassspecNetworkingV1 {
    ...
    IngressclassspecNetworkingV1({
        this.controller,
        this.parameters,
    });

    factory IngressclassspecNetworkingV1.fromJson(Map<String, dynamic> json) => _$IngressclassspecNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$IngressclassspecNetworkingV1ToJson(this);
}
