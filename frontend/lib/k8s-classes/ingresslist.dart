...
class Ingresslist {
    ...
    factory Ingresslist.fromJson(Map<String, dynamic> json) => _$IngresslistFromJson(json);

    Map<String, dynamic> toJson() => _$IngresslistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum IngresslistKind {
    @JsonValue("IngressList")
    INGRESS_LIST
}

final ingresslistKindValues = EnumValues({
    "IngressList": IngresslistKind.INGRESS_LIST
});
