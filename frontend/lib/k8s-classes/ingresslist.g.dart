...
part of 'ingresslist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Ingresslist _$IngresslistFromJson(Map<String, dynamic> json) => Ingresslist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) =>
              IoK8SApiNetworkingV1Ingress.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$IngresslistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$IngresslistToJson(Ingresslist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$IngresslistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$IngresslistKindEnumMap = {
  IngresslistKind.INGRESS_LIST: 'IngressList',
};

IoK8SApiNetworkingV1Ingress _$IoK8SApiNetworkingV1IngressFromJson(
...
Map<String, dynamic> _$IoK8SApiNetworkingV1IngressToJson(
        IoK8SApiNetworkingV1Ingress instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
