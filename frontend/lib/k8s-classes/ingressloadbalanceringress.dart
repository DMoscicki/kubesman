...
part 'ingressloadbalanceringress.g.dart';
...
class Ingressloadbalanceringress {
    ...
    factory Ingressloadbalanceringress.fromJson(Map<String, dynamic> json) => _$IngressloadbalanceringressFromJson(json);

    Map<String, dynamic> toJson() => _$IngressloadbalanceringressToJson(this);
}
