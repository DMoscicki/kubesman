...
part 'ingressloadbalancerstatus.g.dart';
...
class Ingressloadbalancerstatus {
    ...
    factory Ingressloadbalancerstatus.fromJson(Map<String, dynamic> json) => _$IngressloadbalancerstatusFromJson(json);

    Map<String, dynamic> toJson() => _$IngressloadbalancerstatusToJson(this);
}
