...
part 'ingressrule_networking_v1.g.dart';
...
class IngressruleNetworkingV1 {
    ...
    IngressruleNetworkingV1({
        this.host,
        this.http,
    });

    factory IngressruleNetworkingV1.fromJson(Map<String, dynamic> json) => _$IngressruleNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$IngressruleNetworkingV1ToJson(this);
}
