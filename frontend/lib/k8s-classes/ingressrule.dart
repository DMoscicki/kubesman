...
class Ingressrule {
    ...
    factory Ingressrule.fromJson(Map<String, dynamic> json) => _$IngressruleFromJson(json);

    Map<String, dynamic> toJson() => _$IngressruleToJson(this);
}
