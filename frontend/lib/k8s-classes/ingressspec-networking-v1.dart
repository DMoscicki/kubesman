...
part 'ingressspec_networking_v1.g.dart';


///IngressSpec describes the Ingress the user wishes to exist.
@JsonSerializable()
class IngressspecNetworkingV1 {
    ...
    factory IngressspecNetworkingV1.fromJson(Map<String, dynamic> json) => _$IngressspecNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$IngressspecNetworkingV1ToJson(this);
}
