...
class Ingressstatus {
    ...
    factory Ingressstatus.fromJson(Map<String, dynamic> json) => _$IngressstatusFromJson(json);

    Map<String, dynamic> toJson() => _$IngressstatusToJson(this);
}
