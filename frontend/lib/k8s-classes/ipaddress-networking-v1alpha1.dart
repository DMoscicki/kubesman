...
part 'ipaddress_networking_v1_alpha1.g.dart';
...
@JsonSerializable()
class IpaddressNetworkingV1Alpha1 {
    ...
    factory IpaddressNetworkingV1Alpha1.fromJson(Map<String, dynamic> json) => _$IpaddressNetworkingV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$IpaddressNetworkingV1Alpha1ToJson(this);
}
