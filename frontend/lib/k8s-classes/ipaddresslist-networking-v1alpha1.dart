...
part 'ipaddresslist_networking_v1_alpha1.g.dart';


///IPAddressList contains a list of IPAddress.
@JsonSerializable()
class IpaddresslistNetworkingV1Alpha1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiNetworkingV1Alpha1IpAddress>? items;
    ...
    @JsonKey(name: "kind")
    IpaddresslistNetworkingV1Alpha1Kind? kind;
    ...
    IpaddresslistNetworkingV1Alpha1({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory IpaddresslistNetworkingV1Alpha1.fromJson(Map<String, dynamic> json) => _$IpaddresslistNetworkingV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$IpaddresslistNetworkingV1Alpha1ToJson(this);
}
...
///by APIs that operate on IP addresses. The object is used by the Service core API for
///allocation of IP addresses. An IP address can be represented in different formats, to
///guarantee the uniqueness of the IP, the name of the object is the IP address in canonical
///format, four decimal digits separated by dots suppressing leading zeros for IPv4 and the
///representation defined by RFC 5952 for IPv6. Valid: 192.168.1.5 or 2001:db8::1 or
///2001:db8:aaaa:bbbb:cccc:dddd:eeee:1 Invalid: 10.01.2.3 or 2001:db8:0:0:0::1
@JsonSerializable()
class IoK8SApiNetworkingV1Alpha1IpAddress {
    ...
    @JsonKey(name: "spec")
    IoK8SApiNetworkingV1Alpha1IpAddressSpec? spec;
    ...
    factory IoK8SApiNetworkingV1Alpha1IpAddress.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1Alpha1IpAddressFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1Alpha1IpAddressToJson(this);
}
...
@JsonSerializable()
class IoK8SApiNetworkingV1Alpha1IpAddressSpec {
    ...
    factory IoK8SApiNetworkingV1Alpha1IpAddressSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1Alpha1IpAddressSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1Alpha1IpAddressSpecToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum IpaddresslistNetworkingV1Alpha1Kind {
    @JsonValue("IPAddressList")
    IP_ADDRESS_LIST
}

final ipaddresslistNetworkingV1Alpha1KindValues = EnumValues({
    "IPAddressList": IpaddresslistNetworkingV1Alpha1Kind.IP_ADDRESS_LIST
});
