...
class Ipaddresslist {
    ...
    factory Ipaddresslist.fromJson(Map<String, dynamic> json) => _$IpaddresslistFromJson(json);

    Map<String, dynamic> toJson() => _$IpaddresslistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum IpaddresslistKind {
    @JsonValue("IPAddressList")
    IP_ADDRESS_LIST
}

final ipaddresslistKindValues = EnumValues({
    "IPAddressList": IpaddresslistKind.IP_ADDRESS_LIST
});
