...
part of 'ipaddresslist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Ipaddresslist _$IpaddresslistFromJson(Map<String, dynamic> json) =>
    Ipaddresslist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiNetworkingV1Alpha1IpAddress.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$IpaddresslistKindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$IpaddresslistToJson(Ipaddresslist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$IpaddresslistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$IpaddresslistKindEnumMap = {
  IpaddresslistKind.IP_ADDRESS_LIST: 'IPAddressList',
};

IoK8SApiNetworkingV1Alpha1IpAddress
    _$IoK8SApiNetworkingV1Alpha1IpAddressFromJson(Map<String, dynamic> json) =>
        IoK8SApiNetworkingV1Alpha1IpAddress(
          apiVersion: json['apiVersion'] as String?,
...
Map<String, dynamic> _$IoK8SApiNetworkingV1Alpha1IpAddressToJson(
        IoK8SApiNetworkingV1Alpha1IpAddress instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
