...
part 'iscsipersistentvolumesource_v1.g.dart';
...
@JsonSerializable()
class IscsipersistentvolumesourceV1 {
    ...
    factory IscsipersistentvolumesourceV1.fromJson(Map<String, dynamic> json) => _$IscsipersistentvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$IscsipersistentvolumesourceV1ToJson(this);
}
