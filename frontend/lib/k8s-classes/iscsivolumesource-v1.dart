...
class IscsivolumesourceV1 {
    ...
    factory IscsivolumesourceV1.fromJson(Map<String, dynamic> json) => _$IscsivolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$IscsivolumesourceV1ToJson(this);
}
