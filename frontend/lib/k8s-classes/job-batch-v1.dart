...
class JobBatchV1 {
    ...
    factory JobBatchV1.fromJson(Map<String, dynamic> json) => _$JobBatchV1FromJson(json);

    Map<String, dynamic> toJson() => _$JobBatchV1ToJson(this);
}
