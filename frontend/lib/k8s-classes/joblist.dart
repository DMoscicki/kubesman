...
class Joblist {
    ...
    factory Joblist.fromJson(Map<String, dynamic> json) => _$JoblistFromJson(json);
...
class IoK8SApiBatchV1Job {
    ...
    factory IoK8SApiBatchV1Job.fromJson(Map<String, dynamic> json) => _$IoK8SApiBatchV1JobFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiBatchV1JobToJson(this);
}
...
class IoK8SApiBatchV1JobStatus {
    ...
    factory IoK8SApiBatchV1JobStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiBatchV1JobStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiBatchV1JobStatusToJson(this);
}
...
final joblistKindValues = EnumValues({
    "JobList": JoblistKind.JOB_LIST
});
