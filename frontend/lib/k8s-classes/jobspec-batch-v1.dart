...
part 'jobspec_batch_v1.g.dart';


///JobSpec describes how the job execution will look like.
@JsonSerializable()
class JobspecBatchV1 {
    ...
    factory JobspecBatchV1.fromJson(Map<String, dynamic> json) => _$JobspecBatchV1FromJson(json);

    Map<String, dynamic> toJson() => _$JobspecBatchV1ToJson(this);
}
