...
class KeytopathV1 {
    ...
    factory KeytopathV1.fromJson(Map<String, dynamic> json) => _$KeytopathV1FromJson(json);

    Map<String, dynamic> toJson() => _$KeytopathV1ToJson(this);
}
