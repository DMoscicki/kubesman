...
part 'lease_coordination_v1.g.dart';


///Lease defines a lease concept.
@JsonSerializable()
class LeaseCoordinationV1 {
    ...
    factory LeaseCoordinationV1.fromJson(Map<String, dynamic> json) => _$LeaseCoordinationV1FromJson(json);

    Map<String, dynamic> toJson() => _$LeaseCoordinationV1ToJson(this);
}
