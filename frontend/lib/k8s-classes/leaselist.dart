...
class Leaselist {
    ...
    factory Leaselist.fromJson(Map<String, dynamic> json) => _$LeaselistFromJson(json);

    Map<String, dynamic> toJson() => _$LeaselistToJson(this);
}
...
class IoK8SApiCoordinationV1Lease {
    ...
    factory IoK8SApiCoordinationV1Lease.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoordinationV1LeaseFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoordinationV1LeaseToJson(this);
}
...
class IoK8SApiCoordinationV1LeaseSpec {
    ...
    factory IoK8SApiCoordinationV1LeaseSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoordinationV1LeaseSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoordinationV1LeaseSpecToJson(this);
}
...
final leaselistKindValues = EnumValues({
    "LeaseList": LeaselistKind.LEASE_LIST
});
