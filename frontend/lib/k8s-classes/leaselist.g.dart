...
part of 'leaselist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Leaselist _$LeaselistFromJson(Map<String, dynamic> json) => Leaselist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) =>
              IoK8SApiCoordinationV1Lease.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$LeaselistKindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$LeaselistToJson(Leaselist instance) => <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$LeaselistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$LeaselistKindEnumMap = {
  LeaselistKind.LEASE_LIST: 'LeaseList',
};

IoK8SApiCoordinationV1Lease _$IoK8SApiCoordinationV1LeaseFromJson(
...
Map<String, dynamic> _$IoK8SApiCoordinationV1LeaseToJson(
        IoK8SApiCoordinationV1Lease instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
