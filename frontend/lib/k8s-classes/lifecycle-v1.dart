...
class LifecycleV1 {
    ...
    factory LifecycleV1.fromJson(Map<String, dynamic> json) => _$LifecycleV1FromJson(json);

    Map<String, dynamic> toJson() => _$LifecycleV1ToJson(this);
}
