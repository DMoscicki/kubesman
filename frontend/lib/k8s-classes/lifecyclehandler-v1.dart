...
part 'lifecyclehandler_v1.g.dart';
...
class LifecyclehandlerV1 {
    ...
    factory LifecyclehandlerV1.fromJson(Map<String, dynamic> json) => _$LifecyclehandlerV1FromJson(json);

    Map<String, dynamic> toJson() => _$LifecyclehandlerV1ToJson(this);
}
