...
part 'limitedprioritylevelconfiguration_flowcontrol_v1.g.dart';
...
@JsonSerializable()
class LimitedprioritylevelconfigurationFlowcontrolV1 {
    ...
    LimitedprioritylevelconfigurationFlowcontrolV1({
    ...
    factory LimitedprioritylevelconfigurationFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$LimitedprioritylevelconfigurationFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$LimitedprioritylevelconfigurationFlowcontrolV1ToJson(this);
}
