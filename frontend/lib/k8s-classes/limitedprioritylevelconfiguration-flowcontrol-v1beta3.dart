...
part 'limitedprioritylevelconfiguration_flowcontrol_v1_beta3.g.dart';
...
@JsonSerializable()
class LimitedprioritylevelconfigurationFlowcontrolV1Beta3 {
    ...
    LimitedprioritylevelconfigurationFlowcontrolV1Beta3({
    ...
    factory LimitedprioritylevelconfigurationFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$LimitedprioritylevelconfigurationFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$LimitedprioritylevelconfigurationFlowcontrolV1Beta3ToJson(this);
}
