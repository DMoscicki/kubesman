...
class LimitrangeV1 {
    ...
    factory LimitrangeV1.fromJson(Map<String, dynamic> json) => _$LimitrangeV1FromJson(json);

    Map<String, dynamic> toJson() => _$LimitrangeV1ToJson(this);
}
