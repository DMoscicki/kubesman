...
class Limitrangelist {
    ...
    factory Limitrangelist.fromJson(Map<String, dynamic> json) => _$LimitrangelistFromJson(json);

    Map<String, dynamic> toJson() => _$LimitrangelistToJson(this);
}
...
class IoK8SApiCoreV1LimitRange {
    ...
    factory IoK8SApiCoreV1LimitRange.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1LimitRangeFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1LimitRangeToJson(this);
}
...
final itemKindValues = EnumValues({
    "LimitRange": ItemKind.LIMIT_RANGE
});
...
class IoK8SApiCoreV1LimitRangeSpec {
    ...
    factory IoK8SApiCoreV1LimitRangeSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1LimitRangeSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1LimitRangeSpecToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum LimitrangelistKind {
    @JsonValue("LimitRangeList")
    LIMIT_RANGE_LIST
}

final limitrangelistKindValues = EnumValues({
    "LimitRangeList": LimitrangelistKind.LIMIT_RANGE_LIST
});
