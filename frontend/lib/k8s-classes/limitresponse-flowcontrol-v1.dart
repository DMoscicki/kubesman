...
part 'limitresponse_flowcontrol_v1.g.dart';


///LimitResponse defines how to handle requests that can not be executed right now.
@JsonSerializable()
class LimitresponseFlowcontrolV1 {
    ...
    LimitresponseFlowcontrolV1({
        this.queuing,
        required this.type,
    });

    factory LimitresponseFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$LimitresponseFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$LimitresponseFlowcontrolV1ToJson(this);
}
