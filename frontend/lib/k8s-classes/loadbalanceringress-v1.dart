...
part 'loadbalanceringress_v1.g.dart';
...
class LoadbalanceringressV1 {
    ...
    factory LoadbalanceringressV1.fromJson(Map<String, dynamic> json) => _$LoadbalanceringressV1FromJson(json);

    Map<String, dynamic> toJson() => _$LoadbalanceringressV1ToJson(this);
}
