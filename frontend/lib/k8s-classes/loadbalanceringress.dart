...
part 'loadbalanceringress.g.dart';
...
class Loadbalanceringress {
    ...
    factory Loadbalanceringress.fromJson(Map<String, dynamic> json) => _$LoadbalanceringressFromJson(json);

    Map<String, dynamic> toJson() => _$LoadbalanceringressToJson(this);
}
