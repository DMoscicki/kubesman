...
part 'loadbalancerstatus.g.dart';
...
class Loadbalancerstatus {
    ...
    factory Loadbalancerstatus.fromJson(Map<String, dynamic> json) => _$LoadbalancerstatusFromJson(json);

    Map<String, dynamic> toJson() => _$LoadbalancerstatusToJson(this);
}
