...
part 'localsubjectaccessreview_authorization_v1.g.dart';
...
@JsonSerializable()
class LocalsubjectaccessreviewAuthorizationV1 {
    ...
    LocalsubjectaccessreviewAuthorizationV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        required this.spec,
    ...
    factory LocalsubjectaccessreviewAuthorizationV1.fromJson(Map<String, dynamic> json) => _$LocalsubjectaccessreviewAuthorizationV1FromJson(json);

    Map<String, dynamic> toJson() => _$LocalsubjectaccessreviewAuthorizationV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum Kind {
    @JsonValue("LocalSubjectAccessReview")
    LOCAL_SUBJECT_ACCESS_REVIEW
}

final kindValues = EnumValues({
    "LocalSubjectAccessReview": Kind.LOCAL_SUBJECT_ACCESS_REVIEW
});
