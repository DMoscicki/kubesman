...
part 'localsubjectaccessreview.g.dart';
...
class Localsubjectaccessreview {
    ...
    factory Localsubjectaccessreview.fromJson(Map<String, dynamic> json) => _$LocalsubjectaccessreviewFromJson(json);

    Map<String, dynamic> toJson() => _$LocalsubjectaccessreviewToJson(this);
}
