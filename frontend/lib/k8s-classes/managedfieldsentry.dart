...
part 'managedfieldsentry.g.dart';
...
class Managedfieldsentry {
    ...
    factory Managedfieldsentry.fromJson(Map<String, dynamic> json) => _$ManagedfieldsentryFromJson(json);

    Map<String, dynamic> toJson() => _$ManagedfieldsentryToJson(this);
}
