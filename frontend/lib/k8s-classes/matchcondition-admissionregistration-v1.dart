...
part 'matchcondition_admissionregistration_v1.g.dart';


///MatchCondition represents a condition which must by fulfilled for a request to be sent to
///a webhook.
@JsonSerializable()
class MatchconditionAdmissionregistrationV1 {
    ...
    MatchconditionAdmissionregistrationV1({
        required this.expression,
        required this.name,
    });

    factory MatchconditionAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$MatchconditionAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$MatchconditionAdmissionregistrationV1ToJson(this);
}
