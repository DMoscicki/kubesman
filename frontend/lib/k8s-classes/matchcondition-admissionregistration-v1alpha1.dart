...
part 'matchcondition_admissionregistration_v1_alpha1.g.dart';

@JsonSerializable()
class MatchconditionAdmissionregistrationV1Alpha1 {
    ...
    MatchconditionAdmissionregistrationV1Alpha1({
        required this.expression,
        required this.name,
    });

    factory MatchconditionAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$MatchconditionAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$MatchconditionAdmissionregistrationV1Alpha1ToJson(this);
}
