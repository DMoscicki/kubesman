...
part 'matchcondition_admissionregistration_v1_beta1.g.dart';


///MatchCondition represents a condition which must be fulfilled for a request to be sent to
///a webhook.
@JsonSerializable()
class MatchconditionAdmissionregistrationV1Beta1 {
    ...
    MatchconditionAdmissionregistrationV1Beta1({
        required this.expression,
        required this.name,
    });

    factory MatchconditionAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$MatchconditionAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$MatchconditionAdmissionregistrationV1Beta1ToJson(this);
}
