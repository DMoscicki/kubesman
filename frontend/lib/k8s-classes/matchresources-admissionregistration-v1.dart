...
part 'matchresources_admissionregistration_v1.g.dart';
...
@JsonSerializable()
class MatchresourcesAdmissionregistrationV1 {
    ...
    MatchresourcesAdmissionregistrationV1({
    ...
    factory MatchresourcesAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$MatchresourcesAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$MatchresourcesAdmissionregistrationV1ToJson(this);
}
