...
part 'matchresources_admissionregistration_v1_beta1.g.dart';
...
@JsonSerializable()
class MatchresourcesAdmissionregistrationV1Beta1 {
    ...
    MatchresourcesAdmissionregistrationV1Beta1({
    ...
    factory MatchresourcesAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$MatchresourcesAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$MatchresourcesAdmissionregistrationV1Beta1ToJson(this);
}
