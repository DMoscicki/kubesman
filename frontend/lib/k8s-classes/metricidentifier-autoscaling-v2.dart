...
part 'metricidentifier_autoscaling_v2.g.dart';


///MetricIdentifier defines the name and optionally selector for a metric
@JsonSerializable()
class MetricidentifierAutoscalingV2 {
    ...
    MetricidentifierAutoscalingV2({
        required this.name,
        this.selector,
    });

    factory MetricidentifierAutoscalingV2.fromJson(Map<String, dynamic> json) => _$MetricidentifierAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$MetricidentifierAutoscalingV2ToJson(this);
}
