...
class Metricspec {
    ...
    IoK8SApiAutoscalingV2ExternalMetricSource? metricspecExternal;
    ...
    factory Metricspec.fromJson(Map<String, dynamic> json) => _$MetricspecFromJson(json);

    Map<String, dynamic> toJson() => _$MetricspecToJson(this);
}
