...
part 'metricstatus_autoscaling_v2.g.dart';


///MetricStatus describes the last-read state of a single metric.
@JsonSerializable()
class MetricstatusAutoscalingV2 {
    ...
    IoK8SApiAutoscalingV2ExternalMetricStatus? metricstatusAutoscalingV2External;
    ...
    MetricstatusAutoscalingV2({
        this.containerResource,
        this.metricstatusAutoscalingV2External,
        this.object,
        this.pods,
        this.resource,
        required this.type,
    ...
    factory MetricstatusAutoscalingV2.fromJson(Map<String, dynamic> json) => _$MetricstatusAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$MetricstatusAutoscalingV2ToJson(this);
}
