...
class Metricstatus {
    ...
    IoK8SApiAutoscalingV2ExternalMetricStatus? metricstatusExternal;
    ...
    factory Metricstatus.fromJson(Map<String, dynamic> json) => _$MetricstatusFromJson(json);

    Map<String, dynamic> toJson() => _$MetricstatusToJson(this);
}
