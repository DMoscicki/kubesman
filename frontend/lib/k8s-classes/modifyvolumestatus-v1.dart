...
part 'modifyvolumestatus_v1.g.dart';


///ModifyVolumeStatus represents the status object of ControllerModifyVolume operation
@JsonSerializable()
class ModifyvolumestatusV1 {
    ...
    ModifyvolumestatusV1({
        required this.status,
        this.targetVolumeAttributesClassName,
    });

    factory ModifyvolumestatusV1.fromJson(Map<String, dynamic> json) => _$ModifyvolumestatusV1FromJson(json);

    Map<String, dynamic> toJson() => _$ModifyvolumestatusV1ToJson(this);
}
