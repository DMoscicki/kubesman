...
part 'mutatingwebhook_admissionregistration_v1.g.dart';


///MutatingWebhook describes an admission webhook and the resources and operations it
///applies to.
@JsonSerializable()
class MutatingwebhookAdmissionregistrationV1 {
    ...
    MutatingwebhookAdmissionregistrationV1({
    ...
    factory MutatingwebhookAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$MutatingwebhookAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$MutatingwebhookAdmissionregistrationV1ToJson(this);
}
