...
class Mutatingwebhook {
    ...
    factory Mutatingwebhook.fromJson(Map<String, dynamic> json) => _$MutatingwebhookFromJson(json);

    Map<String, dynamic> toJson() => _$MutatingwebhookToJson(this);
}
