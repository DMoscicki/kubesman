...
part 'mutatingwebhookconfiguration_admissionregistration_v1.g.dart';
...
@JsonSerializable()
class MutatingwebhookconfigurationAdmissionregistrationV1 {
    ...
    MutatingwebhookconfigurationAdmissionregistrationV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.webhooks,
    ...
    factory MutatingwebhookconfigurationAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$MutatingwebhookconfigurationAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$MutatingwebhookconfigurationAdmissionregistrationV1ToJson(this);
}
