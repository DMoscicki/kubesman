...
part 'mutatingwebhookconfiguration.g.dart';
...
class Mutatingwebhookconfiguration {
    ...
    factory Mutatingwebhookconfiguration.fromJson(Map<String, dynamic> json) => _$MutatingwebhookconfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$MutatingwebhookconfigurationToJson(this);
}
