...
part of 'mutatingwebhookconfiguration.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Mutatingwebhookconfiguration _$MutatingwebhookconfigurationFromJson(
    ...
    Mutatingwebhookconfiguration(
      ...
      webhooks: (json['webhooks'] as List<dynamic>?)
          ?.map((e) => IoK8SApiAdmissionregistrationV1MutatingWebhook.fromJson(
              e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$MutatingwebhookconfigurationToJson(
        Mutatingwebhookconfiguration instance) =>
    <String, dynamic>{
...
const _$KindEnumMap = {
  Kind.MUTATING_WEBHOOK_CONFIGURATION: 'MutatingWebhookConfiguration',
};
