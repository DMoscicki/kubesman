...
class MutatingwebhookconfigurationlistAdmissionregistrationV1 {
    ...
    factory MutatingwebhookconfigurationlistAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$MutatingwebhookconfigurationlistAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$MutatingwebhookconfigurationlistAdmissionregistrationV1ToJson(this);
}
...
final mutatingwebhookconfigurationlistAdmissionregistrationV1KindValues = EnumValues({
    "MutatingWebhookConfigurationList": MutatingwebhookconfigurationlistAdmissionregistrationV1Kind.MUTATING_WEBHOOK_CONFIGURATION_LIST
});
