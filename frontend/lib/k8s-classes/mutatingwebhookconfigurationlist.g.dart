...
part of 'mutatingwebhookconfigurationlist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Mutatingwebhookconfigurationlist _$MutatingwebhookconfigurationlistFromJson(
    ...
    Mutatingwebhookconfigurationlist(
      ...
      kind: $enumDecodeNullable(
          _$MutatingwebhookconfigurationlistKindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$MutatingwebhookconfigurationlistToJson(
        Mutatingwebhookconfigurationlist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$MutatingwebhookconfigurationlistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$MutatingwebhookconfigurationlistKindEnumMap = {
  MutatingwebhookconfigurationlistKind.MUTATING_WEBHOOK_CONFIGURATION_LIST:
      'MutatingWebhookConfigurationList',
};

IoK8SApiAdmissionregistrationV1MutatingWebhookConfiguration
    _$IoK8SApiAdmissionregistrationV1MutatingWebhookConfigurationFromJson(
            Map<String, dynamic> json) =>
        IoK8SApiAdmissionregistrationV1MutatingWebhookConfiguration(
          apiVersion: json['apiVersion'] as String?,
          ...
          webhooks: (json['webhooks'] as List<dynamic>?)
              ?.map((e) =>
                  IoK8SApiAdmissionregistrationV1MutatingWebhook.fromJson(
                      e as Map<String, dynamic>))
              .toList(),
        );

Map<String, dynamic>
    _$IoK8SApiAdmissionregistrationV1MutatingWebhookConfigurationToJson(
            IoK8SApiAdmissionregistrationV1MutatingWebhookConfiguration
                instance) =>
        <String, dynamic>{
          'apiVersion': instance.apiVersion,
...
IoK8SApiAdmissionregistrationV1MutatingWebhook
    _$IoK8SApiAdmissionregistrationV1MutatingWebhookFromJson(
            Map<String, dynamic> json) =>
        IoK8SApiAdmissionregistrationV1MutatingWebhook(
          ...
          reinvocationPolicy: json['reinvocationPolicy'] as String?,
...
Map<String, dynamic> _$IoK8SApiAdmissionregistrationV1MutatingWebhookToJson(
        IoK8SApiAdmissionregistrationV1MutatingWebhook instance) =>
    <String, dynamic>{
      ...
      'reinvocationPolicy': instance.reinvocationPolicy,
