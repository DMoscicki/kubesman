...
part 'namedresourcesattribute_resource_v1_alpha2.g.dart';


///NamedResourcesAttribute is a combination of an attribute name and its value.
@JsonSerializable()
class NamedresourcesattributeResourceV1Alpha2 {
    
    ///BoolValue is a true/false value.
    @JsonKey(name: "bool")
    bool? namedresourcesattributeResourceV1Alpha2Bool;
    
    ///IntValue is a 64-bit integer.
    @JsonKey(name: "int")
    int? namedresourcesattributeResourceV1Alpha2Int;
    ...
    NamedresourcesattributeResourceV1Alpha2({
        this.namedresourcesattributeResourceV1Alpha2Bool,
        this.namedresourcesattributeResourceV1Alpha2Int,
        this.intSlice,
        required this.name,
        this.quantity,
        this.string,
    ...
    factory NamedresourcesattributeResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$NamedresourcesattributeResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$NamedresourcesattributeResourceV1Alpha2ToJson(this);
}
