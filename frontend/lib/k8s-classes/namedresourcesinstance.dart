...
part 'namedresourcesinstance.g.dart';
...
class Namedresourcesinstance {
    ...
    factory Namedresourcesinstance.fromJson(Map<String, dynamic> json) => _$NamedresourcesinstanceFromJson(json);

    Map<String, dynamic> toJson() => _$NamedresourcesinstanceToJson(this);
}
