...
part of 'namedresourcesinstance.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Namedresourcesinstance _$NamedresourcesinstanceFromJson(
        Map<String, dynamic> json) =>
    Namedresourcesinstance(
      attributes: (json['attributes'] as List<dynamic>?)
          ?.map((e) => IoK8SApiResourceV1Alpha2NamedResourcesAttribute.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      name: json['name'] as String?,
    );

Map<String, dynamic> _$NamedresourcesinstanceToJson(
        Namedresourcesinstance instance) =>
    <String, dynamic>{
