...
part 'namedresourcesresources_resource_v1_alpha2.g.dart';


///NamedResourcesResources is used in ResourceModel.
@JsonSerializable()
class NamedresourcesresourcesResourceV1Alpha2 {
    
    ///The list of all individual resources instances currently available.
    @JsonKey(name: "instances")
    List<IoK8SApiResourceV1Alpha2NamedResourcesInstance>? instances;

    NamedresourcesresourcesResourceV1Alpha2({
        required this.instances,
    });

    factory NamedresourcesresourcesResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$NamedresourcesresourcesResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$NamedresourcesresourcesResourceV1Alpha2ToJson(this);
}
