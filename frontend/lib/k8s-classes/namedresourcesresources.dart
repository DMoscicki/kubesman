...
part 'namedresourcesresources.g.dart';
...
class Namedresourcesresources {
    ...
    factory Namedresourcesresources.fromJson(Map<String, dynamic> json) => _$NamedresourcesresourcesFromJson(json);

    Map<String, dynamic> toJson() => _$NamedresourcesresourcesToJson(this);
}
