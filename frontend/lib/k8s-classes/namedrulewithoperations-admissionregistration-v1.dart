...
part 'namedrulewithoperations_admissionregistration_v1.g.dart';


///NamedRuleWithOperations is a tuple of Operations and Resources with ResourceNames.
@JsonSerializable()
class NamedrulewithoperationsAdmissionregistrationV1 {
    ...
    NamedrulewithoperationsAdmissionregistrationV1({
        this.apiGroups,
        this.apiVersions,
        this.operations,
        this.resourceNames,
    ...
    factory NamedrulewithoperationsAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$NamedrulewithoperationsAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$NamedrulewithoperationsAdmissionregistrationV1ToJson(this);
}
