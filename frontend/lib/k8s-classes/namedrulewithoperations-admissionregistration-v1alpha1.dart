...
part 'namedrulewithoperations_admissionregistration_v1_alpha1.g.dart';


///NamedRuleWithOperations is a tuple of Operations and Resources with ResourceNames.
@JsonSerializable()
class NamedrulewithoperationsAdmissionregistrationV1Alpha1 {
    ...
    NamedrulewithoperationsAdmissionregistrationV1Alpha1({
        this.apiGroups,
        this.apiVersions,
        this.operations,
        this.resourceNames,
    ...
    factory NamedrulewithoperationsAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$NamedrulewithoperationsAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$NamedrulewithoperationsAdmissionregistrationV1Alpha1ToJson(this);
}
