...
part 'namedrulewithoperations_admissionregistration_v1_beta1.g.dart';


///NamedRuleWithOperations is a tuple of Operations and Resources with ResourceNames.
@JsonSerializable()
class NamedrulewithoperationsAdmissionregistrationV1Beta1 {
    ...
    NamedrulewithoperationsAdmissionregistrationV1Beta1({
        this.apiGroups,
        this.apiVersions,
        this.operations,
        this.resourceNames,
    ...
    factory NamedrulewithoperationsAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$NamedrulewithoperationsAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$NamedrulewithoperationsAdmissionregistrationV1Beta1ToJson(this);
}
