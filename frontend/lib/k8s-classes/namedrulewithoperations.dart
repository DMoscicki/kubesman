...
part 'namedrulewithoperations.g.dart';
...
class Namedrulewithoperations {
    ...
    factory Namedrulewithoperations.fromJson(Map<String, dynamic> json) => _$NamedrulewithoperationsFromJson(json);

    Map<String, dynamic> toJson() => _$NamedrulewithoperationsToJson(this);
}
