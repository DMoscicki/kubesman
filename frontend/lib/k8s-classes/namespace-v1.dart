...
class NamespaceV1 {
    ...
    factory NamespaceV1.fromJson(Map<String, dynamic> json) => _$NamespaceV1FromJson(json);

    Map<String, dynamic> toJson() => _$NamespaceV1ToJson(this);
}
