...
class Namespacelist {
    ...
    factory Namespacelist.fromJson(Map<String, dynamic> json) => _$NamespacelistFromJson(json);

    Map<String, dynamic> toJson() => _$NamespacelistToJson(this);
}
...
class IoK8SApiCoreV1Namespace {
    ...
    factory IoK8SApiCoreV1Namespace.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1NamespaceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1NamespaceToJson(this);
}
...
class IoK8SApiCoreV1NamespaceSpec {
    ...
    factory IoK8SApiCoreV1NamespaceSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1NamespaceSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1NamespaceSpecToJson(this);
}
...
class IoK8SApiCoreV1NamespaceStatus {
    ...
    factory IoK8SApiCoreV1NamespaceStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1NamespaceStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1NamespaceStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum NamespacelistKind {
    @JsonValue("NamespaceList")
    NAMESPACE_LIST
}

final namespacelistKindValues = EnumValues({
    "NamespaceList": NamespacelistKind.NAMESPACE_LIST
});
