...
part 'networkpolicy_networking_v1.g.dart';


///NetworkPolicy describes what network traffic is allowed for a set of Pods
@JsonSerializable()
class NetworkpolicyNetworkingV1 {
    ...
    factory NetworkpolicyNetworkingV1.fromJson(Map<String, dynamic> json) => _$NetworkpolicyNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$NetworkpolicyNetworkingV1ToJson(this);
}
