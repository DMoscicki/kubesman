...
part 'networkpolicyegressrule_networking_v1.g.dart';
...
@JsonSerializable()
class NetworkpolicyegressruleNetworkingV1 {
    ...
    NetworkpolicyegressruleNetworkingV1({
        this.ports,
        this.to,
    });

    factory NetworkpolicyegressruleNetworkingV1.fromJson(Map<String, dynamic> json) => _$NetworkpolicyegressruleNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$NetworkpolicyegressruleNetworkingV1ToJson(this);
}
