...
part 'networkpolicyegressrule.g.dart';
...
class Networkpolicyegressrule {
    ...
    factory Networkpolicyegressrule.fromJson(Map<String, dynamic> json) => _$NetworkpolicyegressruleFromJson(json);

    Map<String, dynamic> toJson() => _$NetworkpolicyegressruleToJson(this);
}
