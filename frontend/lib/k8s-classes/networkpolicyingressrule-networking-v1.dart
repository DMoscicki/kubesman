...
part 'networkpolicyingressrule_networking_v1.g.dart';
...
///from.
@JsonSerializable()
class NetworkpolicyingressruleNetworkingV1 {
    ...
    NetworkpolicyingressruleNetworkingV1({
        this.from,
        this.ports,
    });

    factory NetworkpolicyingressruleNetworkingV1.fromJson(Map<String, dynamic> json) => _$NetworkpolicyingressruleNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$NetworkpolicyingressruleNetworkingV1ToJson(this);
}
