...
class Networkpolicylist {
    ...
    factory Networkpolicylist.fromJson(Map<String, dynamic> json) => _$NetworkpolicylistFromJson(json);

    Map<String, dynamic> toJson() => _$NetworkpolicylistToJson(this);
}
...
class IoK8SApiNetworkingV1NetworkPolicy {
    ...
    factory IoK8SApiNetworkingV1NetworkPolicy.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1NetworkPolicyFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1NetworkPolicyToJson(this);
}
...
final itemKindValues = EnumValues({
    "NetworkPolicy": ItemKind.NETWORK_POLICY
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum NetworkpolicylistKind {
    @JsonValue("NetworkPolicyList")
    NETWORK_POLICY_LIST
}

final networkpolicylistKindValues = EnumValues({
    "NetworkPolicyList": NetworkpolicylistKind.NETWORK_POLICY_LIST
});
