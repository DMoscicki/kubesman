...
part 'networkpolicypeer_networking_v1.g.dart';


///NetworkPolicyPeer describes a peer to allow traffic to/from. Only certain combinations of
///fields are allowed
@JsonSerializable()
class NetworkpolicypeerNetworkingV1 {
    ...
    NetworkpolicypeerNetworkingV1({
        this.ipBlock,
        this.namespaceSelector,
        this.podSelector,
    });

    factory NetworkpolicypeerNetworkingV1.fromJson(Map<String, dynamic> json) => _$NetworkpolicypeerNetworkingV1FromJson(json);

    Map<String, dynamic> toJson() => _$NetworkpolicypeerNetworkingV1ToJson(this);
}
