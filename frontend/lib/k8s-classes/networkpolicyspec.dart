...
class Networkpolicyspec {
    ...
    factory Networkpolicyspec.fromJson(Map<String, dynamic> json) => _$NetworkpolicyspecFromJson(json);

    Map<String, dynamic> toJson() => _$NetworkpolicyspecToJson(this);
}
