...
part 'nodeaffinity_v1.g.dart';


///Node affinity is a group of node affinity scheduling rules.
@JsonSerializable()
class NodeaffinityV1 {
    ...
    factory NodeaffinityV1.fromJson(Map<String, dynamic> json) => _$NodeaffinityV1FromJson(json);

    Map<String, dynamic> toJson() => _$NodeaffinityV1ToJson(this);
}
