...
class Nodeconfigsource {
    ...
    factory Nodeconfigsource.fromJson(Map<String, dynamic> json) => _$NodeconfigsourceFromJson(json);

    Map<String, dynamic> toJson() => _$NodeconfigsourceToJson(this);
}
