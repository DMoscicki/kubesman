...
class Nodeconfigstatus {
    ...
    factory Nodeconfigstatus.fromJson(Map<String, dynamic> json) => _$NodeconfigstatusFromJson(json);

    Map<String, dynamic> toJson() => _$NodeconfigstatusToJson(this);
}
