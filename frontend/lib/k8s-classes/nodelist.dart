...
class Nodelist {
    ...
    factory Nodelist.fromJson(Map<String, dynamic> json) => _$NodelistFromJson(json);
...
class IoK8SApiCoreV1Node {
    ...
    factory IoK8SApiCoreV1Node.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1NodeFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1NodeToJson(this);
}
...
final nodelistKindValues = EnumValues({
    "NodeList": NodelistKind.NODE_LIST
});
