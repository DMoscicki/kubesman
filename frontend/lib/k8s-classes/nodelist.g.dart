...
part of 'nodelist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Nodelist _$NodelistFromJson(Map<String, dynamic> json) => Nodelist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiCoreV1Node.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$NodelistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$NodelistToJson(Nodelist instance) => <String, dynamic>{
      ...
      'kind': _$NodelistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$NodelistKindEnumMap = {
  NodelistKind.NODE_LIST: 'NodeList',
};

IoK8SApiCoreV1Node _$IoK8SApiCoreV1NodeFromJson(Map<String, dynamic> json) =>
    IoK8SApiCoreV1Node(
      apiVersion: json['apiVersion'] as String?,
...
Map<String, dynamic> _$IoK8SApiCoreV1NodeToJson(IoK8SApiCoreV1Node instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
