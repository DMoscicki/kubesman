...
class NodeselectorV1 {
    ...
    factory NodeselectorV1.fromJson(Map<String, dynamic> json) => _$NodeselectorV1FromJson(json);

    Map<String, dynamic> toJson() => _$NodeselectorV1ToJson(this);
}
