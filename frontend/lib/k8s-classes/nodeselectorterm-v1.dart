...
part 'nodeselectorterm_v1.g.dart';
...
class NodeselectortermV1 {
    ...
    factory NodeselectortermV1.fromJson(Map<String, dynamic> json) => _$NodeselectortermV1FromJson(json);

    Map<String, dynamic> toJson() => _$NodeselectortermV1ToJson(this);
}
