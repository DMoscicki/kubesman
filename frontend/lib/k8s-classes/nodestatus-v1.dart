...
class NodestatusV1 {
    ...
    factory NodestatusV1.fromJson(Map<String, dynamic> json) => _$NodestatusV1FromJson(json);

    Map<String, dynamic> toJson() => _$NodestatusV1ToJson(this);
}
