...
part 'nodesysteminfo_v1.g.dart';


///NodeSystemInfo is a set of ids/uuids to uniquely identify the node.
@JsonSerializable()
class NodesysteminfoV1 {
    ...
    factory NodesysteminfoV1.fromJson(Map<String, dynamic> json) => _$NodesysteminfoV1FromJson(json);

    Map<String, dynamic> toJson() => _$NodesysteminfoV1ToJson(this);
}
