...
part 'nonresourcepolicyrule_flowcontrol_v1_beta3.g.dart';
...
@JsonSerializable()
class NonresourcepolicyruleFlowcontrolV1Beta3 {
    ...
    NonresourcepolicyruleFlowcontrolV1Beta3({
        required this.nonResourceUrLs,
        required this.verbs,
    });

    factory NonresourcepolicyruleFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$NonresourcepolicyruleFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$NonresourcepolicyruleFlowcontrolV1Beta3ToJson(this);
}
