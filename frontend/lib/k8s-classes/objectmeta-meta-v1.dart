...
part 'objectmeta_meta_v1.g.dart';


///ObjectMeta is metadata that all persisted resources must have, which includes all objects
///users must create.
@JsonSerializable()
class ObjectmetaMetaV1 {
    ...
    factory ObjectmetaMetaV1.fromJson(Map<String, dynamic> json) => _$ObjectmetaMetaV1FromJson(json);

    Map<String, dynamic> toJson() => _$ObjectmetaMetaV1ToJson(this);
}
