...
part 'objectmetricsource.g.dart';
...
class Objectmetricsource {
    ...
    factory Objectmetricsource.fromJson(Map<String, dynamic> json) => _$ObjectmetricsourceFromJson(json);

    Map<String, dynamic> toJson() => _$ObjectmetricsourceToJson(this);
}
