...
class ObjectmetricstatusAutoscalingV2 {
    ...
    ObjectmetricstatusAutoscalingV2({
        required this.current,
        required this.describedObject,
        required this.metric,
    });

    factory ObjectmetricstatusAutoscalingV2.fromJson(Map<String, dynamic> json) => _$ObjectmetricstatusAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$ObjectmetricstatusAutoscalingV2ToJson(this);
}
