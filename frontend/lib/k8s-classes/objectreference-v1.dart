...
part 'objectreference_v1.g.dart';
...
class ObjectreferenceV1 {
    ...
    factory ObjectreferenceV1.fromJson(Map<String, dynamic> json) => _$ObjectreferenceV1FromJson(json);

    Map<String, dynamic> toJson() => _$ObjectreferenceV1ToJson(this);
}
