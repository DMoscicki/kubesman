...
class ParamrefAdmissionregistrationV1 {
    ...
    ParamrefAdmissionregistrationV1({
        this.name,
        this.namespace,
    ...
    factory ParamrefAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ParamrefAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ParamrefAdmissionregistrationV1ToJson(this);
}
