...
class ParamrefAdmissionregistrationV1Beta1 {
    ...
    ParamrefAdmissionregistrationV1Beta1({
        this.name,
        this.namespace,
    ...
    factory ParamrefAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ParamrefAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ParamrefAdmissionregistrationV1Beta1ToJson(this);
}
