...
part 'persistentvolume_v1.g.dart';
...
class PersistentvolumeV1 {
    ...
    factory PersistentvolumeV1.fromJson(Map<String, dynamic> json) => _$PersistentvolumeV1FromJson(json);

    Map<String, dynamic> toJson() => _$PersistentvolumeV1ToJson(this);
}
