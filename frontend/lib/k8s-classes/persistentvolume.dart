...
class Persistentvolume {
    ...
    factory Persistentvolume.fromJson(Map<String, dynamic> json) => _$PersistentvolumeFromJson(json);

    Map<String, dynamic> toJson() => _$PersistentvolumeToJson(this);
}
