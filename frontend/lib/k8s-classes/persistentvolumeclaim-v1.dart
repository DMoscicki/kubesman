...
part 'persistentvolumeclaim_v1.g.dart';
...
class PersistentvolumeclaimV1 {
    ...
    factory PersistentvolumeclaimV1.fromJson(Map<String, dynamic> json) => _$PersistentvolumeclaimV1FromJson(json);

    Map<String, dynamic> toJson() => _$PersistentvolumeclaimV1ToJson(this);
}
