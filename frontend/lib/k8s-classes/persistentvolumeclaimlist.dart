...
part 'persistentvolumeclaimlist.g.dart';
...
class Persistentvolumeclaimlist {
    ...
    @JsonKey(name: "kind")
    PersistentvolumeclaimlistKind? kind;
    ...
    factory Persistentvolumeclaimlist.fromJson(Map<String, dynamic> json) => _$PersistentvolumeclaimlistFromJson(json);

    Map<String, dynamic> toJson() => _$PersistentvolumeclaimlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PersistentvolumeclaimlistKind {
    @JsonValue("PersistentVolumeClaimList")
    PERSISTENT_VOLUME_CLAIM_LIST
}

final persistentvolumeclaimlistKindValues = EnumValues({
    "PersistentVolumeClaimList": PersistentvolumeclaimlistKind.PERSISTENT_VOLUME_CLAIM_LIST
});
