...
part of 'persistentvolumeclaimlist.dart';
...
Persistentvolumeclaimlist _$PersistentvolumeclaimlistFromJson(
    ...
    Persistentvolumeclaimlist(
      ...
      kind: $enumDecodeNullable(
          _$PersistentvolumeclaimlistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$PersistentvolumeclaimlistToJson(
        Persistentvolumeclaimlist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$PersistentvolumeclaimlistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$PersistentvolumeclaimlistKindEnumMap = {
  PersistentvolumeclaimlistKind.PERSISTENT_VOLUME_CLAIM_LIST:
      'PersistentVolumeClaimList',
};
