...
part 'persistentvolumeclaimstatus.g.dart';
...
class Persistentvolumeclaimstatus {
    ...
    factory Persistentvolumeclaimstatus.fromJson(Map<String, dynamic> json) => _$PersistentvolumeclaimstatusFromJson(json);
