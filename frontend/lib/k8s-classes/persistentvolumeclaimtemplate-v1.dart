...
class PersistentvolumeclaimtemplateV1 {
    ...
    factory PersistentvolumeclaimtemplateV1.fromJson(Map<String, dynamic> json) => _$PersistentvolumeclaimtemplateV1FromJson(json);

    Map<String, dynamic> toJson() => _$PersistentvolumeclaimtemplateV1ToJson(this);
}
