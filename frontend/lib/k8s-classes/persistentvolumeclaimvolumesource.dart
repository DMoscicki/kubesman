...
part 'persistentvolumeclaimvolumesource.g.dart';
...
class Persistentvolumeclaimvolumesource {
    ...
    factory Persistentvolumeclaimvolumesource.fromJson(Map<String, dynamic> json) => _$PersistentvolumeclaimvolumesourceFromJson(json);
