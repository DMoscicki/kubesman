...
part 'persistentvolumelist.g.dart';
...
class Persistentvolumelist {
    ...
    factory Persistentvolumelist.fromJson(Map<String, dynamic> json) => _$PersistentvolumelistFromJson(json);

    Map<String, dynamic> toJson() => _$PersistentvolumelistToJson(this);
}
...
class IoK8SApiCoreV1PersistentVolume {
    ...
    factory IoK8SApiCoreV1PersistentVolume.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1PersistentVolumeFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1PersistentVolumeToJson(this);
}
...
class IoK8SApiCoreV1PersistentVolumeStatus {
    ...
    factory IoK8SApiCoreV1PersistentVolumeStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1PersistentVolumeStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1PersistentVolumeStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PersistentvolumelistKind {
    @JsonValue("PersistentVolumeList")
    PERSISTENT_VOLUME_LIST
}

final persistentvolumelistKindValues = EnumValues({
    "PersistentVolumeList": PersistentvolumelistKind.PERSISTENT_VOLUME_LIST
});
