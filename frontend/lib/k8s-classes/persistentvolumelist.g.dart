...
part of 'persistentvolumelist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Persistentvolumelist _$PersistentvolumelistFromJson(
        Map<String, dynamic> json) =>
    Persistentvolumelist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiCoreV1PersistentVolume.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      kind:
          $enumDecodeNullable(_$PersistentvolumelistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$PersistentvolumelistToJson(
        Persistentvolumelist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$PersistentvolumelistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$PersistentvolumelistKindEnumMap = {
  PersistentvolumelistKind.PERSISTENT_VOLUME_LIST: 'PersistentVolumeList',
};

IoK8SApiCoreV1PersistentVolume _$IoK8SApiCoreV1PersistentVolumeFromJson(
        Map<String, dynamic> json) =>
    IoK8SApiCoreV1PersistentVolume(
      ...
      status: json['status'] == null
          ? null
          : IoK8SApiCoreV1PersistentVolumeStatus.fromJson(
              json['status'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$IoK8SApiCoreV1PersistentVolumeToJson(
        IoK8SApiCoreV1PersistentVolume instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.PERSISTENT_VOLUME: 'PersistentVolume',
};
...
IoK8SApiCoreV1PersistentVolumeStatus
    _$IoK8SApiCoreV1PersistentVolumeStatusFromJson(Map<String, dynamic> json) =>
        IoK8SApiCoreV1PersistentVolumeStatus(
...
Map<String, dynamic> _$IoK8SApiCoreV1PersistentVolumeStatusToJson(
        IoK8SApiCoreV1PersistentVolumeStatus instance) =>
    <String, dynamic>{
