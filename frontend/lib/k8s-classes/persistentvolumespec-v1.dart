...
part 'persistentvolumespec_v1.g.dart';


///PersistentVolumeSpec is the specification of a persistent volume.
@JsonSerializable()
class PersistentvolumespecV1 {
    ...
    factory PersistentvolumespecV1.fromJson(Map<String, dynamic> json) => _$PersistentvolumespecV1FromJson(json);

    Map<String, dynamic> toJson() => _$PersistentvolumespecV1ToJson(this);
}
