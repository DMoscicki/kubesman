...
class PodaffinityV1 {
    ...
    factory PodaffinityV1.fromJson(Map<String, dynamic> json) => _$PodaffinityV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodaffinityV1ToJson(this);
}
