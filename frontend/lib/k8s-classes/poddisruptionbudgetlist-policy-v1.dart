...
class PoddisruptionbudgetlistPolicyV1 {
    ...
    factory PoddisruptionbudgetlistPolicyV1.fromJson(Map<String, dynamic> json) => _$PoddisruptionbudgetlistPolicyV1FromJson(json);

    Map<String, dynamic> toJson() => _$PoddisruptionbudgetlistPolicyV1ToJson(this);
}
...
final poddisruptionbudgetlistPolicyV1KindValues = EnumValues({
    "PodDisruptionBudgetList": PoddisruptionbudgetlistPolicyV1Kind.POD_DISRUPTION_BUDGET_LIST
});
