...
part 'poddisruptionbudgetlist.g.dart';
...
class Poddisruptionbudgetlist {
    ...
    @JsonKey(name: "kind")
    PoddisruptionbudgetlistKind? kind;
    ...
    factory Poddisruptionbudgetlist.fromJson(Map<String, dynamic> json) => _$PoddisruptionbudgetlistFromJson(json);

    Map<String, dynamic> toJson() => _$PoddisruptionbudgetlistToJson(this);
}
...
class IoK8SApiPolicyV1PodDisruptionBudget {
    ...
    factory IoK8SApiPolicyV1PodDisruptionBudget.fromJson(Map<String, dynamic> json) => _$IoK8SApiPolicyV1PodDisruptionBudgetFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiPolicyV1PodDisruptionBudgetToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PoddisruptionbudgetlistKind {
    @JsonValue("PodDisruptionBudgetList")
    POD_DISRUPTION_BUDGET_LIST
}

final poddisruptionbudgetlistKindValues = EnumValues({
    "PodDisruptionBudgetList": PoddisruptionbudgetlistKind.POD_DISRUPTION_BUDGET_LIST
});
