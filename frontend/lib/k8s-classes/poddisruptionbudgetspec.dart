...
part 'poddisruptionbudgetspec.g.dart';
...
class Poddisruptionbudgetspec {
    ...
    factory Poddisruptionbudgetspec.fromJson(Map<String, dynamic> json) => _$PoddisruptionbudgetspecFromJson(json);

    Map<String, dynamic> toJson() => _$PoddisruptionbudgetspecToJson(this);
}
