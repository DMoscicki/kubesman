...
part 'podfailurepolicy_batch_v1.g.dart';


///PodFailurePolicy describes how failed pods influence the backoffLimit.
@JsonSerializable()
class PodfailurepolicyBatchV1 {
    ...
    PodfailurepolicyBatchV1({
        required this.rules,
    });

    factory PodfailurepolicyBatchV1.fromJson(Map<String, dynamic> json) => _$PodfailurepolicyBatchV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodfailurepolicyBatchV1ToJson(this);
}
