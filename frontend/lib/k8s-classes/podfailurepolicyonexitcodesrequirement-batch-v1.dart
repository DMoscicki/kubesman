...
part 'podfailurepolicyonexitcodesrequirement_batch_v1.g.dart';
...
@JsonSerializable()
class PodfailurepolicyonexitcodesrequirementBatchV1 {
    ...
    String? podfailurepolicyonexitcodesrequirementBatchV1Operator;
    ...
    PodfailurepolicyonexitcodesrequirementBatchV1({
        this.containerName,
        required this.podfailurepolicyonexitcodesrequirementBatchV1Operator,
        required this.values,
    });

    factory PodfailurepolicyonexitcodesrequirementBatchV1.fromJson(Map<String, dynamic> json) => _$PodfailurepolicyonexitcodesrequirementBatchV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodfailurepolicyonexitcodesrequirementBatchV1ToJson(this);
}
