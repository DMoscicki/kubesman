...
part 'podfailurepolicyonexitcodesrequirement.g.dart';
...
class Podfailurepolicyonexitcodesrequirement {
    ...
    String? podfailurepolicyonexitcodesrequirementOperator;
    ...
    Podfailurepolicyonexitcodesrequirement({
        this.containerName,
        required this.podfailurepolicyonexitcodesrequirementOperator,
        required this.values,
    });

    factory Podfailurepolicyonexitcodesrequirement.fromJson(Map<String, dynamic> json) => _$PodfailurepolicyonexitcodesrequirementFromJson(json);

    Map<String, dynamic> toJson() => _$PodfailurepolicyonexitcodesrequirementToJson(this);
}
