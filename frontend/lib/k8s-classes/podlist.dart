...
class PodV1 {
    ...
    factory PodV1.fromJson(Map<String, dynamic> json) => _$PodV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodV1ToJson(this);
}
...
class PodlistMetadata {
    ...
    factory PodlistMetadata.fromJson(Map<String, dynamic> json) => _$PodlistMetadataFromJson(json);

    Map<String, dynamic> toJson() => _$PodlistMetadataToJson(this);
}
