...
class Podlist {
    ...
    factory Podlist.fromJson(Map<String, dynamic> json) => _$PodlistFromJson(json);

    Map<String, dynamic> toJson() => _$PodlistToJson(this);
}
...
class IoK8SApiCoreV1Pod {
    ...
    factory IoK8SApiCoreV1Pod.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1PodFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1PodToJson(this);
}
...
class IoK8SApiCoreV1PodStatus {
    ...
    factory IoK8SApiCoreV1PodStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1PodStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1PodStatusToJson(this);
}
...
final podlistKindValues = EnumValues({
    "PodList": PodlistKind.POD_LIST
});
