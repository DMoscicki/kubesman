...
part 'podresourceclaimstatus.g.dart';
...
class Podresourceclaimstatus {
    ...
    factory Podresourceclaimstatus.fromJson(Map<String, dynamic> json) => _$PodresourceclaimstatusFromJson(json);

    Map<String, dynamic> toJson() => _$PodresourceclaimstatusToJson(this);
}
