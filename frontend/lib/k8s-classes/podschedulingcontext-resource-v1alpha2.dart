...
part 'podschedulingcontext_resource_v1_alpha2.g.dart';
...
@JsonSerializable()
class PodschedulingcontextResourceV1Alpha2 {
    ...
    PodschedulingcontextResourceV1Alpha2({
        this.apiVersion,
        this.kind,
        this.metadata,
        required this.spec,
    ...
    factory PodschedulingcontextResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$PodschedulingcontextResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$PodschedulingcontextResourceV1Alpha2ToJson(this);
}
...
final kindValues = EnumValues({
    "PodSchedulingContext": Kind.POD_SCHEDULING_CONTEXT
});
