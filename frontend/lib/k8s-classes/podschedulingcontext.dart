...
part 'podschedulingcontext.g.dart';
...
class Podschedulingcontext {
    ...
    factory Podschedulingcontext.fromJson(Map<String, dynamic> json) => _$PodschedulingcontextFromJson(json);

    Map<String, dynamic> toJson() => _$PodschedulingcontextToJson(this);
}
