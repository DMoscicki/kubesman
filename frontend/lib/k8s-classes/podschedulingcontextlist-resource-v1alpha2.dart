...
part 'podschedulingcontextlist_resource_v1_alpha2.g.dart';


///PodSchedulingContextList is a collection of Pod scheduling objects.
@JsonSerializable()
class PodschedulingcontextlistResourceV1Alpha2 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiResourceV1Alpha2PodSchedulingContext>? items;
    ...
    @JsonKey(name: "kind")
    PodschedulingcontextlistResourceV1Alpha2Kind? kind;
    
    ///Standard list metadata
    @JsonKey(name: "metadata")
    Metadata? metadata;

    PodschedulingcontextlistResourceV1Alpha2({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory PodschedulingcontextlistResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$PodschedulingcontextlistResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$PodschedulingcontextlistResourceV1Alpha2ToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2PodSchedulingContext {
    ...
    @JsonKey(name: "spec")
    IoK8SApiResourceV1Alpha2PodSchedulingContextSpec spec;
    
    ///Status describes where resources for the Pod can be allocated.
    @JsonKey(name: "status")
    IoK8SApiResourceV1Alpha2PodSchedulingContextStatus? status;
    ...
    factory IoK8SApiResourceV1Alpha2PodSchedulingContext.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2PodSchedulingContextFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2PodSchedulingContextToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
    @JsonValue("PodSchedulingContext")
    POD_SCHEDULING_CONTEXT
}

final itemKindValues = EnumValues({
    "PodSchedulingContext": ItemKind.POD_SCHEDULING_CONTEXT
});
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2PodSchedulingContextSpec {
    ...
    factory IoK8SApiResourceV1Alpha2PodSchedulingContextSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2PodSchedulingContextSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2PodSchedulingContextSpecToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2PodSchedulingContextStatus {
    ...
    factory IoK8SApiResourceV1Alpha2PodSchedulingContextStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2PodSchedulingContextStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2PodSchedulingContextStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PodschedulingcontextlistResourceV1Alpha2Kind {
    @JsonValue("PodSchedulingContextList")
    POD_SCHEDULING_CONTEXT_LIST
}

final podschedulingcontextlistResourceV1Alpha2KindValues = EnumValues({
    "PodSchedulingContextList": PodschedulingcontextlistResourceV1Alpha2Kind.POD_SCHEDULING_CONTEXT_LIST
});
