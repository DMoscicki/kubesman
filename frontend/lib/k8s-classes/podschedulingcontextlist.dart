...
part 'podschedulingcontextlist.g.dart';
...
class Podschedulingcontextlist {
    ...
    @JsonKey(name: "kind")
    PodschedulingcontextlistKind? kind;
    ...
    factory Podschedulingcontextlist.fromJson(Map<String, dynamic> json) => _$PodschedulingcontextlistFromJson(json);

    Map<String, dynamic> toJson() => _$PodschedulingcontextlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PodschedulingcontextlistKind {
    @JsonValue("PodSchedulingContextList")
    POD_SCHEDULING_CONTEXT_LIST
}

final podschedulingcontextlistKindValues = EnumValues({
    "PodSchedulingContextList": PodschedulingcontextlistKind.POD_SCHEDULING_CONTEXT_LIST
});
