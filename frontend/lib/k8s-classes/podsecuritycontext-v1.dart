...
part 'podsecuritycontext_v1.g.dart';
...
class PodsecuritycontextV1 {
    ...
    factory PodsecuritycontextV1.fromJson(Map<String, dynamic> json) => _$PodsecuritycontextV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodsecuritycontextV1ToJson(this);
}
