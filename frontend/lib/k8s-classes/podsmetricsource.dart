...
class Podsmetricsource {
    ...
    factory Podsmetricsource.fromJson(Map<String, dynamic> json) => _$PodsmetricsourceFromJson(json);

    Map<String, dynamic> toJson() => _$PodsmetricsourceToJson(this);
}
