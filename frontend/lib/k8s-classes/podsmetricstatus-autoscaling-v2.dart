...
part 'podsmetricstatus_autoscaling_v2.g.dart';
...
@JsonSerializable()
class PodsmetricstatusAutoscalingV2 {
    ...
    PodsmetricstatusAutoscalingV2({
        required this.current,
        required this.metric,
    });

    factory PodsmetricstatusAutoscalingV2.fromJson(Map<String, dynamic> json) => _$PodsmetricstatusAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$PodsmetricstatusAutoscalingV2ToJson(this);
}
