...
class Podsmetricstatus {
    ...
    factory Podsmetricstatus.fromJson(Map<String, dynamic> json) => _$PodsmetricstatusFromJson(json);

    Map<String, dynamic> toJson() => _$PodsmetricstatusToJson(this);
}
