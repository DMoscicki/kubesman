...
class PodstatusV1 {
    ...
    factory PodstatusV1.fromJson(Map<String, dynamic> json) => _$PodstatusV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodstatusV1ToJson(this);
}
