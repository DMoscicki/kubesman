...
class PodtemplateV1 {
    ...
    factory PodtemplateV1.fromJson(Map<String, dynamic> json) => _$PodtemplateV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodtemplateV1ToJson(this);
}
