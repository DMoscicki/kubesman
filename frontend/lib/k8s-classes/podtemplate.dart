...
class Podtemplate {
    ...
    factory Podtemplate.fromJson(Map<String, dynamic> json) => _$PodtemplateFromJson(json);

    Map<String, dynamic> toJson() => _$PodtemplateToJson(this);
}
