...
class Podtemplatelist {
    ...
    factory Podtemplatelist.fromJson(Map<String, dynamic> json) => _$PodtemplatelistFromJson(json);

    Map<String, dynamic> toJson() => _$PodtemplatelistToJson(this);
}
...
class IoK8SApiCoreV1PodTemplate {
    ...
    factory IoK8SApiCoreV1PodTemplate.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1PodTemplateFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1PodTemplateToJson(this);
}
...
final itemKindValues = EnumValues({
    "PodTemplate": ItemKind.POD_TEMPLATE
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PodtemplatelistKind {
    @JsonValue("PodTemplateList")
    POD_TEMPLATE_LIST
}

final podtemplatelistKindValues = EnumValues({
    "PodTemplateList": PodtemplatelistKind.POD_TEMPLATE_LIST
});
