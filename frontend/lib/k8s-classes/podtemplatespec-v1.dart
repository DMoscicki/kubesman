...
part 'podtemplatespec_v1.g.dart';
...
class PodtemplatespecV1 {
    ...
    factory PodtemplatespecV1.fromJson(Map<String, dynamic> json) => _$PodtemplatespecV1FromJson(json);

    Map<String, dynamic> toJson() => _$PodtemplatespecV1ToJson(this);
}
