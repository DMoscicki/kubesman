...
part 'policyruleswithsubjects_flowcontrol_v1.g.dart';
...
@JsonSerializable()
class PolicyruleswithsubjectsFlowcontrolV1 {
    ...
    PolicyruleswithsubjectsFlowcontrolV1({
        this.nonResourceRules,
        this.resourceRules,
        required this.subjects,
    });

    factory PolicyruleswithsubjectsFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$PolicyruleswithsubjectsFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$PolicyruleswithsubjectsFlowcontrolV1ToJson(this);
}
