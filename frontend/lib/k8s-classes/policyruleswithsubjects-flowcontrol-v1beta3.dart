...
part 'policyruleswithsubjects_flowcontrol_v1_beta3.g.dart';
...
@JsonSerializable()
class PolicyruleswithsubjectsFlowcontrolV1Beta3 {
    ...
    PolicyruleswithsubjectsFlowcontrolV1Beta3({
        this.nonResourceRules,
        this.resourceRules,
        required this.subjects,
    });

    factory PolicyruleswithsubjectsFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$PolicyruleswithsubjectsFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$PolicyruleswithsubjectsFlowcontrolV1Beta3ToJson(this);
}
