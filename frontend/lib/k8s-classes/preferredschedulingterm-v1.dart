...
part 'preferredschedulingterm_v1.g.dart';
...
@JsonSerializable()
class PreferredschedulingtermV1 {
    ...
    factory PreferredschedulingtermV1.fromJson(Map<String, dynamic> json) => _$PreferredschedulingtermV1FromJson(json);

    Map<String, dynamic> toJson() => _$PreferredschedulingtermV1ToJson(this);
}
