...
part 'priorityclass_scheduling_v1.g.dart';


///PriorityClass defines mapping from a priority class name to the priority integer value.
///The value can be any valid integer.
@JsonSerializable()
class PriorityclassSchedulingV1 {
    ...
    factory PriorityclassSchedulingV1.fromJson(Map<String, dynamic> json) => _$PriorityclassSchedulingV1FromJson(json);

    Map<String, dynamic> toJson() => _$PriorityclassSchedulingV1ToJson(this);
}
...
final kindValues = EnumValues({
    "PriorityClass": Kind.PRIORITY_CLASS
});
