...
class Priorityclass {
    ...
    factory Priorityclass.fromJson(Map<String, dynamic> json) => _$PriorityclassFromJson(json);

    Map<String, dynamic> toJson() => _$PriorityclassToJson(this);
}
