...
class Priorityclasslist {
    ...
    factory Priorityclasslist.fromJson(Map<String, dynamic> json) => _$PriorityclasslistFromJson(json);

    Map<String, dynamic> toJson() => _$PriorityclasslistToJson(this);
}
...
class IoK8SApiSchedulingV1PriorityClass {
    ...
    factory IoK8SApiSchedulingV1PriorityClass.fromJson(Map<String, dynamic> json) => _$IoK8SApiSchedulingV1PriorityClassFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiSchedulingV1PriorityClassToJson(this);
}
...
final itemKindValues = EnumValues({
    "PriorityClass": ItemKind.PRIORITY_CLASS
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PriorityclasslistKind {
    @JsonValue("PriorityClassList")
    PRIORITY_CLASS_LIST
}

final priorityclasslistKindValues = EnumValues({
    "PriorityClassList": PriorityclasslistKind.PRIORITY_CLASS_LIST
});
