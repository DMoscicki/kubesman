...
part of 'priorityclasslist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Priorityclasslist _$PriorityclasslistFromJson(Map<String, dynamic> json) =>
    Priorityclasslist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiSchedulingV1PriorityClass.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$PriorityclasslistKindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$PriorityclasslistToJson(Priorityclasslist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$PriorityclasslistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$PriorityclasslistKindEnumMap = {
  PriorityclasslistKind.PRIORITY_CLASS_LIST: 'PriorityClassList',
};

IoK8SApiSchedulingV1PriorityClass _$IoK8SApiSchedulingV1PriorityClassFromJson(
...
Map<String, dynamic> _$IoK8SApiSchedulingV1PriorityClassToJson(
        IoK8SApiSchedulingV1PriorityClass instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.PRIORITY_CLASS: 'PriorityClass',
};
