...
part 'prioritylevelconfiguration_flowcontrol_v1.g.dart';


///PriorityLevelConfiguration represents the configuration of a priority level.
@JsonSerializable()
class PrioritylevelconfigurationFlowcontrolV1 {
    ...
    PrioritylevelconfigurationFlowcontrolV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.spec,
    ...
    factory PrioritylevelconfigurationFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$PrioritylevelconfigurationFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$PrioritylevelconfigurationFlowcontrolV1ToJson(this);
}
