...
class PrioritylevelconfigurationlistFlowcontrolV1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiFlowcontrolV1PriorityLevelConfiguration>? items;
    ...
    factory PrioritylevelconfigurationlistFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$PrioritylevelconfigurationlistFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$PrioritylevelconfigurationlistFlowcontrolV1ToJson(this);
}
...
class IoK8SApiFlowcontrolV1PriorityLevelConfiguration {
    ...
    @JsonKey(name: "spec")
    IoK8SApiFlowcontrolV1PriorityLevelConfigurationSpec? spec;
    
    ///`status` is the current status of a "request-priority". More info:
    ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    @JsonKey(name: "status")
    IoK8SApiFlowcontrolV1PriorityLevelConfigurationStatus? status;
    ...
    factory IoK8SApiFlowcontrolV1PriorityLevelConfiguration.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1PriorityLevelConfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1PriorityLevelConfigurationToJson(this);
}
...
class IoK8SApiFlowcontrolV1PriorityLevelConfigurationSpec {
    ...
    @JsonKey(name: "exempt")
    IoK8SApiFlowcontrolV1ExemptPriorityLevelConfiguration? exempt;
    ...
    IoK8SApiFlowcontrolV1LimitedPriorityLevelConfiguration? limited;
    ...
    factory IoK8SApiFlowcontrolV1PriorityLevelConfigurationSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1PriorityLevelConfigurationSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1PriorityLevelConfigurationSpecToJson(this);
}
...
class IoK8SApiFlowcontrolV1ExemptPriorityLevelConfiguration {
    ...
    factory IoK8SApiFlowcontrolV1ExemptPriorityLevelConfiguration.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1ExemptPriorityLevelConfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1ExemptPriorityLevelConfigurationToJson(this);
}
...
class IoK8SApiFlowcontrolV1LimitedPriorityLevelConfiguration {
    ...
    IoK8SApiFlowcontrolV1LimitResponse? limitResponse;
    ...
    factory IoK8SApiFlowcontrolV1LimitedPriorityLevelConfiguration.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1LimitedPriorityLevelConfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1LimitedPriorityLevelConfigurationToJson(this);
}
...
class IoK8SApiFlowcontrolV1LimitResponse {
    ...
    IoK8SApiFlowcontrolV1QueuingConfiguration? queuing;
    ...
    factory IoK8SApiFlowcontrolV1LimitResponse.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1LimitResponseFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1LimitResponseToJson(this);
}
...
class IoK8SApiFlowcontrolV1QueuingConfiguration {
    ...
    factory IoK8SApiFlowcontrolV1QueuingConfiguration.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1QueuingConfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1QueuingConfigurationToJson(this);
}
...
class IoK8SApiFlowcontrolV1PriorityLevelConfigurationStatus {
    ...
    factory IoK8SApiFlowcontrolV1PriorityLevelConfigurationStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1PriorityLevelConfigurationStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1PriorityLevelConfigurationStatusToJson(this);
}
...
final prioritylevelconfigurationlistFlowcontrolV1KindValues = EnumValues({
    "PriorityLevelConfigurationList": PrioritylevelconfigurationlistFlowcontrolV1Kind.PRIORITY_LEVEL_CONFIGURATION_LIST
});
