...
part 'prioritylevelconfigurationlist_flowcontrol_v1_beta3.g.dart';


///PriorityLevelConfigurationList is a list of PriorityLevelConfiguration objects.
@JsonSerializable()
class PrioritylevelconfigurationlistFlowcontrolV1Beta3 {
    ...
    @JsonKey(name: "kind")
    PrioritylevelconfigurationlistFlowcontrolV1Beta3Kind? kind;
    ...
    PrioritylevelconfigurationlistFlowcontrolV1Beta3({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory PrioritylevelconfigurationlistFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$PrioritylevelconfigurationlistFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$PrioritylevelconfigurationlistFlowcontrolV1Beta3ToJson(this);
}
...
class IoK8SApiFlowcontrolV1Beta3PriorityLevelConfiguration {
    ...
    factory IoK8SApiFlowcontrolV1Beta3PriorityLevelConfiguration.fromJson(Map<String, dynamic> json) => _$IoK8SApiFlowcontrolV1Beta3PriorityLevelConfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiFlowcontrolV1Beta3PriorityLevelConfigurationToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PrioritylevelconfigurationlistFlowcontrolV1Beta3Kind {
    @JsonValue("PriorityLevelConfigurationList")
    PRIORITY_LEVEL_CONFIGURATION_LIST
}

final prioritylevelconfigurationlistFlowcontrolV1Beta3KindValues = EnumValues({
    "PriorityLevelConfigurationList": PrioritylevelconfigurationlistFlowcontrolV1Beta3Kind.PRIORITY_LEVEL_CONFIGURATION_LIST
});
