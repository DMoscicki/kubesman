...
part 'prioritylevelconfigurationlist.g.dart';
...
class Prioritylevelconfigurationlist {
    ...
    @JsonKey(name: "kind")
    PrioritylevelconfigurationlistKind? kind;
    ...
    factory Prioritylevelconfigurationlist.fromJson(Map<String, dynamic> json) => _$PrioritylevelconfigurationlistFromJson(json);

    Map<String, dynamic> toJson() => _$PrioritylevelconfigurationlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PrioritylevelconfigurationlistKind {
    @JsonValue("PriorityLevelConfigurationList")
    PRIORITY_LEVEL_CONFIGURATION_LIST
}

final prioritylevelconfigurationlistKindValues = EnumValues({
    "PriorityLevelConfigurationList": PrioritylevelconfigurationlistKind.PRIORITY_LEVEL_CONFIGURATION_LIST
});
