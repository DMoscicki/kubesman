...
part of 'prioritylevelconfigurationlist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Prioritylevelconfigurationlist _$PrioritylevelconfigurationlistFromJson(
        Map<String, dynamic> json) =>
    Prioritylevelconfigurationlist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) =>
              IoK8SApiFlowcontrolV1Beta3PriorityLevelConfiguration.fromJson(
                  e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(
          _$PrioritylevelconfigurationlistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$PrioritylevelconfigurationlistToJson(
        Prioritylevelconfigurationlist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$PrioritylevelconfigurationlistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$PrioritylevelconfigurationlistKindEnumMap = {
  PrioritylevelconfigurationlistKind.PRIORITY_LEVEL_CONFIGURATION_LIST:
      'PriorityLevelConfigurationList',
};

IoK8SApiFlowcontrolV1Beta3PriorityLevelConfiguration
    _$IoK8SApiFlowcontrolV1Beta3PriorityLevelConfigurationFromJson(
            Map<String, dynamic> json) =>
        IoK8SApiFlowcontrolV1Beta3PriorityLevelConfiguration(
          apiVersion: json['apiVersion'] as String?,
...
Map<String, dynamic>
    _$IoK8SApiFlowcontrolV1Beta3PriorityLevelConfigurationToJson(
            IoK8SApiFlowcontrolV1Beta3PriorityLevelConfiguration instance) =>
        <String, dynamic>{
          'apiVersion': instance.apiVersion,
