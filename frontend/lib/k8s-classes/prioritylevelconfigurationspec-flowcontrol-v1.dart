...
part 'prioritylevelconfigurationspec_flowcontrol_v1.g.dart';


///PriorityLevelConfigurationSpec specifies the configuration of a priority level.
@JsonSerializable()
class PrioritylevelconfigurationspecFlowcontrolV1 {
    ...
    PrioritylevelconfigurationspecFlowcontrolV1({
        this.exempt,
        this.limited,
        required this.type,
    });

    factory PrioritylevelconfigurationspecFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$PrioritylevelconfigurationspecFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$PrioritylevelconfigurationspecFlowcontrolV1ToJson(this);
}
