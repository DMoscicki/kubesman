...
part 'prioritylevelconfigurationspec_flowcontrol_v1_beta3.g.dart';


///PriorityLevelConfigurationSpec specifies the configuration of a priority level.
@JsonSerializable()
class PrioritylevelconfigurationspecFlowcontrolV1Beta3 {
    ...
    PrioritylevelconfigurationspecFlowcontrolV1Beta3({
        this.exempt,
        this.limited,
        required this.type,
    });

    factory PrioritylevelconfigurationspecFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$PrioritylevelconfigurationspecFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$PrioritylevelconfigurationspecFlowcontrolV1Beta3ToJson(this);
}
