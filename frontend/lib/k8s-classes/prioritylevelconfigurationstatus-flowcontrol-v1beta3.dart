...
part 'prioritylevelconfigurationstatus_flowcontrol_v1_beta3.g.dart';


///PriorityLevelConfigurationStatus represents the current state of a "request-priority".
@JsonSerializable()
class PrioritylevelconfigurationstatusFlowcontrolV1Beta3 {
    
    ///`conditions` is the current state of "request-priority".
    @JsonKey(name: "conditions")
    List<IoK8SApiFlowcontrolV1Beta3PriorityLevelConfigurationCondition>? conditions;

    PrioritylevelconfigurationstatusFlowcontrolV1Beta3({
        this.conditions,
    });

    factory PrioritylevelconfigurationstatusFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$PrioritylevelconfigurationstatusFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$PrioritylevelconfigurationstatusFlowcontrolV1Beta3ToJson(this);
}
