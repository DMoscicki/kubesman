...
part 'projectedvolumesource_v1.g.dart';


///Represents a projected volume source
@JsonSerializable()
class ProjectedvolumesourceV1 {
    ...
    factory ProjectedvolumesourceV1.fromJson(Map<String, dynamic> json) => _$ProjectedvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$ProjectedvolumesourceV1ToJson(this);
}
