...
part 'queuingconfiguration_flowcontrol_v1.g.dart';


///QueuingConfiguration holds the configuration parameters for queuing
@JsonSerializable()
class QueuingconfigurationFlowcontrolV1 {
    ...
    QueuingconfigurationFlowcontrolV1({
        this.handSize,
        this.queueLengthLimit,
        this.queues,
    });

    factory QueuingconfigurationFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$QueuingconfigurationFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$QueuingconfigurationFlowcontrolV1ToJson(this);
}
