...
part 'queuingconfiguration_flowcontrol_v1_beta3.g.dart';


///QueuingConfiguration holds the configuration parameters for queuing
@JsonSerializable()
class QueuingconfigurationFlowcontrolV1Beta3 {
    ...
    QueuingconfigurationFlowcontrolV1Beta3({
        this.handSize,
        this.queueLengthLimit,
        this.queues,
    });

    factory QueuingconfigurationFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$QueuingconfigurationFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$QueuingconfigurationFlowcontrolV1Beta3ToJson(this);
}
