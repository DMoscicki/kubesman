...
part 'queuingconfiguration.g.dart';
...
class Queuingconfiguration {
    ...
    factory Queuingconfiguration.fromJson(Map<String, dynamic> json) => _$QueuingconfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$QueuingconfigurationToJson(this);
}
