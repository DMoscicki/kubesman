...
class QuobytevolumesourceV1 {
    ...
    factory QuobytevolumesourceV1.fromJson(Map<String, dynamic> json) => _$QuobytevolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$QuobytevolumesourceV1ToJson(this);
}
