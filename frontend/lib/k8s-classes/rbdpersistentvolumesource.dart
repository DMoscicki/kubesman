...
part 'rbdpersistentvolumesource.g.dart';
...
class Rbdpersistentvolumesource {
    ...
    factory Rbdpersistentvolumesource.fromJson(Map<String, dynamic> json) => _$RbdpersistentvolumesourceFromJson(json);

    Map<String, dynamic> toJson() => _$RbdpersistentvolumesourceToJson(this);
}
