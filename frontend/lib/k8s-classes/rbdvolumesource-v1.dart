...
class RbdvolumesourceV1 {
    ...
    factory RbdvolumesourceV1.fromJson(Map<String, dynamic> json) => _$RbdvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$RbdvolumesourceV1ToJson(this);
}
