...
part 'replicaset_apps_v1.g.dart';


///ReplicaSet ensures that a specified number of pod replicas are running at any given time.
@JsonSerializable()
class ReplicasetAppsV1 {
    ...
    factory ReplicasetAppsV1.fromJson(Map<String, dynamic> json) => _$ReplicasetAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$ReplicasetAppsV1ToJson(this);
}
