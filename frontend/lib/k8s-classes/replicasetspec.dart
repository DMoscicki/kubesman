...
class Replicasetspec {
    ...
    factory Replicasetspec.fromJson(Map<String, dynamic> json) => _$ReplicasetspecFromJson(json);

    Map<String, dynamic> toJson() => _$ReplicasetspecToJson(this);
}
