...
part 'replicasetstatus_apps_v1.g.dart';


///ReplicaSetStatus represents the current status of a ReplicaSet.
@JsonSerializable()
class ReplicasetstatusAppsV1 {
    ...
    factory ReplicasetstatusAppsV1.fromJson(Map<String, dynamic> json) => _$ReplicasetstatusAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$ReplicasetstatusAppsV1ToJson(this);
}
