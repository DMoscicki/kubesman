...
part 'replicationcontroller_v1.g.dart';
...
class ReplicationcontrollerV1 {
    ...
    factory ReplicationcontrollerV1.fromJson(Map<String, dynamic> json) => _$ReplicationcontrollerV1FromJson(json);

    Map<String, dynamic> toJson() => _$ReplicationcontrollerV1ToJson(this);
}
...
final kindValues = EnumValues({
    "ReplicationController": Kind.REPLICATION_CONTROLLER
});
