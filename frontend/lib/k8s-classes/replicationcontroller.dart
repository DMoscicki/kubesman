...
part 'replicationcontroller.g.dart';
...
class Replicationcontroller {
    ...
    factory Replicationcontroller.fromJson(Map<String, dynamic> json) => _$ReplicationcontrollerFromJson(json);

    Map<String, dynamic> toJson() => _$ReplicationcontrollerToJson(this);
}
