...
class ReplicationcontrollerlistV1 {
    ...
    factory ReplicationcontrollerlistV1.fromJson(Map<String, dynamic> json) => _$ReplicationcontrollerlistV1FromJson(json);
...
final replicationcontrollerlistV1KindValues = EnumValues({
    "ReplicationControllerList": ReplicationcontrollerlistV1Kind.REPLICATION_CONTROLLER_LIST
});
