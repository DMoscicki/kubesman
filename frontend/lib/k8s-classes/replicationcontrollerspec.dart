...
part 'replicationcontrollerspec.g.dart';
...
class Replicationcontrollerspec {
    ...
    factory Replicationcontrollerspec.fromJson(Map<String, dynamic> json) => _$ReplicationcontrollerspecFromJson(json);

    Map<String, dynamic> toJson() => _$ReplicationcontrollerspecToJson(this);
}
