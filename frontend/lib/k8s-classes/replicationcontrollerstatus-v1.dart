...
part 'replicationcontrollerstatus_v1.g.dart';


///ReplicationControllerStatus represents the current status of a replication controller.
@JsonSerializable()
class ReplicationcontrollerstatusV1 {
    ...
    factory ReplicationcontrollerstatusV1.fromJson(Map<String, dynamic> json) => _$ReplicationcontrollerstatusV1FromJson(json);

    Map<String, dynamic> toJson() => _$ReplicationcontrollerstatusV1ToJson(this);
}
