...
class ResourceattributesAuthorizationV1 {
    ...
    ResourceattributesAuthorizationV1({
        this.group,
        this.name,
        this.namespace,
        this.resource,
    ...
    factory ResourceattributesAuthorizationV1.fromJson(Map<String, dynamic> json) => _$ResourceattributesAuthorizationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceattributesAuthorizationV1ToJson(this);
}
