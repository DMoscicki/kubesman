...
part 'resourceclaim_resource_v1_alpha2.g.dart';
...
@JsonSerializable()
class ResourceclaimResourceV1Alpha2 {
    ...
    factory ResourceclaimResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclaimResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimResourceV1Alpha2ToJson(this);
}
...
final kindValues = EnumValues({
    "ResourceClaim": Kind.RESOURCE_CLAIM
});
