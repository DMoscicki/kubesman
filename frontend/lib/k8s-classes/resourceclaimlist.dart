...
class Resourceclaimlist {
    ...
    factory Resourceclaimlist.fromJson(Map<String, dynamic> json) => _$ResourceclaimlistFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclaimlistKind {
    @JsonValue("ResourceClaimList")
    RESOURCE_CLAIM_LIST
}

final resourceclaimlistKindValues = EnumValues({
    "ResourceClaimList": ResourceclaimlistKind.RESOURCE_CLAIM_LIST
});
