...
class ResourceclaimparametersResourceV1Alpha2 {
    ...
    ResourceclaimparametersResourceV1Alpha2({
        this.apiVersion,
        this.driverRequests,
        this.generatedFrom,
        this.kind,
    ...
    factory ResourceclaimparametersResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclaimparametersResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimparametersResourceV1Alpha2ToJson(this);
}
...
final kindValues = EnumValues({
    "ResourceClaimParameters": Kind.RESOURCE_CLAIM_PARAMETERS
});
