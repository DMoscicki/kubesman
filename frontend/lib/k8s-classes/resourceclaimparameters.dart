...
part 'resourceclaimparameters.g.dart';
...
class Resourceclaimparameters {
    ...
    factory Resourceclaimparameters.fromJson(Map<String, dynamic> json) => _$ResourceclaimparametersFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimparametersToJson(this);
}
