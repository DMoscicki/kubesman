...
part 'resourceclaimparameterslist_resource_v1_alpha2.g.dart';


///ResourceClaimParametersList is a collection of ResourceClaimParameters.
@JsonSerializable()
class ResourceclaimparameterslistResourceV1Alpha2 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiResourceV1Alpha2ResourceClaimParameters>? items;
    ...
    @JsonKey(name: "kind")
    ResourceclaimparameterslistResourceV1Alpha2Kind? kind;
    
    ///Standard list metadata
    @JsonKey(name: "metadata")
    Metadata? metadata;

    ResourceclaimparameterslistResourceV1Alpha2({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory ResourceclaimparameterslistResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclaimparameterslistResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimparameterslistResourceV1Alpha2ToJson(this);
}
...
///ResourceClaimParameters defines resource requests for a ResourceClaim in an in-tree
///format understood by Kubernetes.
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceClaimParameters {
    ...
    ///DriverRequests describes all resources that are needed for the allocated claim. A single
    ///claim may use resources coming from different drivers. For each driver, this array has at
    ///most one entry which then may have one or more per-driver requests.
    ///
    ///May be empty, in which case the claim can always be allocated.
    @JsonKey(name: "driverRequests")
    List<IoK8SApiResourceV1Alpha2DriverRequests>? driverRequests;
    
    ///If this object was created from some other resource, then this links back to that
    ///resource. This field is used to find the in-tree representation of the claim parameters
    ///when the parameter reference of the claim refers to some unknown type.
    @JsonKey(name: "generatedFrom")
    IoK8SApiResourceV1Alpha2ResourceClaimParametersReference? generatedFrom;
    ...
    ///Shareable indicates whether the allocated claim is meant to be shareable by multiple
    ...
    factory IoK8SApiResourceV1Alpha2ResourceClaimParameters.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceClaimParametersFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceClaimParametersToJson(this);
}


///DriverRequests describes all resources that are needed from one particular driver.
@JsonSerializable()
class IoK8SApiResourceV1Alpha2DriverRequests {
    ...
    factory IoK8SApiResourceV1Alpha2DriverRequests.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2DriverRequestsFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2DriverRequestsToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
    @JsonValue("ResourceClaimParameters")
    RESOURCE_CLAIM_PARAMETERS
}

final itemKindValues = EnumValues({
    "ResourceClaimParameters": ItemKind.RESOURCE_CLAIM_PARAMETERS
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclaimparameterslistResourceV1Alpha2Kind {
    @JsonValue("ResourceClaimParametersList")
    RESOURCE_CLAIM_PARAMETERS_LIST
}

final resourceclaimparameterslistResourceV1Alpha2KindValues = EnumValues({
    "ResourceClaimParametersList": ResourceclaimparameterslistResourceV1Alpha2Kind.RESOURCE_CLAIM_PARAMETERS_LIST
});
