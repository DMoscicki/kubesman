...
part 'resourceclaimparameterslist.g.dart';
...
class Resourceclaimparameterslist {
    ...
    @JsonKey(name: "kind")
    ResourceclaimparameterslistKind? kind;
    ...
    factory Resourceclaimparameterslist.fromJson(Map<String, dynamic> json) => _$ResourceclaimparameterslistFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimparameterslistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclaimparameterslistKind {
    @JsonValue("ResourceClaimParametersList")
    RESOURCE_CLAIM_PARAMETERS_LIST
}

final resourceclaimparameterslistKindValues = EnumValues({
    "ResourceClaimParametersList": ResourceclaimparameterslistKind.RESOURCE_CLAIM_PARAMETERS_LIST
});
