...
part of 'resourceclaimparameterslist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Resourceclaimparameterslist _$ResourceclaimparameterslistFromJson(
        Map<String, dynamic> json) =>
    Resourceclaimparameterslist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiResourceV1Alpha2ResourceClaimParameters.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(
          _$ResourceclaimparameterslistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$ResourceclaimparameterslistToJson(
        Resourceclaimparameterslist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$ResourceclaimparameterslistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ResourceclaimparameterslistKindEnumMap = {
  ResourceclaimparameterslistKind.RESOURCE_CLAIM_PARAMETERS_LIST:
      'ResourceClaimParametersList',
};

IoK8SApiResourceV1Alpha2ResourceClaimParameters
    _$IoK8SApiResourceV1Alpha2ResourceClaimParametersFromJson(
            Map<String, dynamic> json) =>
        IoK8SApiResourceV1Alpha2ResourceClaimParameters(
          apiVersion: json['apiVersion'] as String?,
...
Map<String, dynamic> _$IoK8SApiResourceV1Alpha2ResourceClaimParametersToJson(
        IoK8SApiResourceV1Alpha2ResourceClaimParameters instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.RESOURCE_CLAIM_PARAMETERS: 'ResourceClaimParameters',
};
