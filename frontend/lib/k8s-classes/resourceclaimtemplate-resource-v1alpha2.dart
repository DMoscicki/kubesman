...
part 'resourceclaimtemplate_resource_v1_alpha2.g.dart';


///ResourceClaimTemplate is used to produce ResourceClaim objects.
@JsonSerializable()
class ResourceclaimtemplateResourceV1Alpha2 {
    ...
    ResourceclaimtemplateResourceV1Alpha2({
        this.apiVersion,
        this.kind,
        this.metadata,
        required this.spec,
    ...
    factory ResourceclaimtemplateResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclaimtemplateResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimtemplateResourceV1Alpha2ToJson(this);
}
...
final kindValues = EnumValues({
    "ResourceClaimTemplate": Kind.RESOURCE_CLAIM_TEMPLATE
});
