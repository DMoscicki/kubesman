...
part 'resourceclaimtemplate.g.dart';
...
class Resourceclaimtemplate {
    ...
    factory Resourceclaimtemplate.fromJson(Map<String, dynamic> json) => _$ResourceclaimtemplateFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimtemplateToJson(this);
}
