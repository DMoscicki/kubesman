...
part 'resourceclaimtemplatelist_resource_v1_alpha2.g.dart';


///ResourceClaimTemplateList is a collection of claim templates.
@JsonSerializable()
class ResourceclaimtemplatelistResourceV1Alpha2 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiResourceV1Alpha2ResourceClaimTemplate>? items;
    ...
    @JsonKey(name: "kind")
    ResourceclaimtemplatelistResourceV1Alpha2Kind? kind;
    
    ///Standard list metadata
    @JsonKey(name: "metadata")
    Metadata? metadata;

    ResourceclaimtemplatelistResourceV1Alpha2({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory ResourceclaimtemplatelistResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclaimtemplatelistResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimtemplatelistResourceV1Alpha2ToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceClaimTemplate {
    ...
    @JsonKey(name: "spec")
    IoK8SApiResourceV1Alpha2ResourceClaimTemplateSpec spec;
    ...
    factory IoK8SApiResourceV1Alpha2ResourceClaimTemplate.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceClaimTemplateFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceClaimTemplateToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceClaimTemplateSpec {
    ...
    ///Spec for the ResourceClaim. The entire content is copied unchanged into the ResourceClaim
    ///that gets created from this template. The same fields as in a ResourceClaim are also
    ///valid here.
    @JsonKey(name: "spec")
    ...
    factory IoK8SApiResourceV1Alpha2ResourceClaimTemplateSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceClaimTemplateSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceClaimTemplateSpecToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclaimtemplatelistResourceV1Alpha2Kind {
    @JsonValue("ResourceClaimTemplateList")
    RESOURCE_CLAIM_TEMPLATE_LIST
}

final resourceclaimtemplatelistResourceV1Alpha2KindValues = EnumValues({
    "ResourceClaimTemplateList": ResourceclaimtemplatelistResourceV1Alpha2Kind.RESOURCE_CLAIM_TEMPLATE_LIST
});
