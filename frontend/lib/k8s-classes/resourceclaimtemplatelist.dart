...
part 'resourceclaimtemplatelist.g.dart';
...
class Resourceclaimtemplatelist {
    ...
    @JsonKey(name: "kind")
    ResourceclaimtemplatelistKind? kind;
    ...
    factory Resourceclaimtemplatelist.fromJson(Map<String, dynamic> json) => _$ResourceclaimtemplatelistFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimtemplatelistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclaimtemplatelistKind {
    @JsonValue("ResourceClaimTemplateList")
    RESOURCE_CLAIM_TEMPLATE_LIST
}

final resourceclaimtemplatelistKindValues = EnumValues({
    "ResourceClaimTemplateList": ResourceclaimtemplatelistKind.RESOURCE_CLAIM_TEMPLATE_LIST
});
