...
part 'resourceclaimtemplatespec_resource_v1_alpha2.g.dart';


///ResourceClaimTemplateSpec contains the metadata and fields for a ResourceClaim.
@JsonSerializable()
class ResourceclaimtemplatespecResourceV1Alpha2 {
    ...
    ResourceclaimtemplatespecResourceV1Alpha2({
        this.metadata,
        required this.spec,
    });

    factory ResourceclaimtemplatespecResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclaimtemplatespecResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimtemplatespecResourceV1Alpha2ToJson(this);
}
