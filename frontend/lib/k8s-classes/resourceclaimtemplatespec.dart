...
part 'resourceclaimtemplatespec.g.dart';
...
class Resourceclaimtemplatespec {
    ...
    factory Resourceclaimtemplatespec.fromJson(Map<String, dynamic> json) => _$ResourceclaimtemplatespecFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclaimtemplatespecToJson(this);
}
