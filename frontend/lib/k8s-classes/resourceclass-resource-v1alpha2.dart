...
part 'resourceclass_resource_v1_alpha2.g.dart';
...
@JsonSerializable()
class ResourceclassResourceV1Alpha2 {
    ...
    factory ResourceclassResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclassResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclassResourceV1Alpha2ToJson(this);
}
...
final kindValues = EnumValues({
    "ResourceClass": Kind.RESOURCE_CLASS
});
