...
class Resourceclass {
    ...
    factory Resourceclass.fromJson(Map<String, dynamic> json) => _$ResourceclassFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclassToJson(this);
}
