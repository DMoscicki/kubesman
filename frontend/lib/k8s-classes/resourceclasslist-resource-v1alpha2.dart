...
part 'resourceclasslist_resource_v1_alpha2.g.dart';


///ResourceClassList is a collection of classes.
@JsonSerializable()
class ResourceclasslistResourceV1Alpha2 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiResourceV1Alpha2ResourceClass>? items;
    ...
    @JsonKey(name: "kind")
    ResourceclasslistResourceV1Alpha2Kind? kind;
    
    ///Standard list metadata
    @JsonKey(name: "metadata")
    Metadata? metadata;

    ResourceclasslistResourceV1Alpha2({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory ResourceclasslistResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclasslistResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclasslistResourceV1Alpha2ToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceClass {
    ...
    IoK8SApiResourceV1Alpha2ResourceClassParametersReference? parametersRef;
    
    ///If and only if allocation of claims using this class is handled via structured
    ///parameters, then StructuredParameters must be set to true.
    @JsonKey(name: "structuredParameters")
    ...
    factory IoK8SApiResourceV1Alpha2ResourceClass.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceClassFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceClassToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
    @JsonValue("ResourceClass")
    RESOURCE_CLASS
}

final itemKindValues = EnumValues({
    "ResourceClass": ItemKind.RESOURCE_CLASS
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclasslistResourceV1Alpha2Kind {
    @JsonValue("ResourceClassList")
    RESOURCE_CLASS_LIST
}

final resourceclasslistResourceV1Alpha2KindValues = EnumValues({
    "ResourceClassList": ResourceclasslistResourceV1Alpha2Kind.RESOURCE_CLASS_LIST
});
