...
class Resourceclasslist {
    ...
    factory Resourceclasslist.fromJson(Map<String, dynamic> json) => _$ResourceclasslistFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclasslistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclasslistKind {
    @JsonValue("ResourceClassList")
    RESOURCE_CLASS_LIST
}

final resourceclasslistKindValues = EnumValues({
    "ResourceClassList": ResourceclasslistKind.RESOURCE_CLASS_LIST
});
