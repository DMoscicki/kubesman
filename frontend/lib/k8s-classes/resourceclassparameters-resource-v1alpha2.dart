...
class ResourceclassparametersResourceV1Alpha2 {
    ...
    ResourceclassparametersResourceV1Alpha2({
        this.apiVersion,
        this.filters,
        this.generatedFrom,
        this.kind,
    ...
    factory ResourceclassparametersResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclassparametersResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclassparametersResourceV1Alpha2ToJson(this);
}
...
final kindValues = EnumValues({
    "ResourceClassParameters": Kind.RESOURCE_CLASS_PARAMETERS
});
