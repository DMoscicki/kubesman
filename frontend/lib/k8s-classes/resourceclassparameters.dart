...
part 'resourceclassparameters.g.dart';
...
class Resourceclassparameters {
    ...
    factory Resourceclassparameters.fromJson(Map<String, dynamic> json) => _$ResourceclassparametersFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclassparametersToJson(this);
}
