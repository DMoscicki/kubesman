...
part 'resourceclassparameterslist_resource_v1_alpha2.g.dart';


///ResourceClassParametersList is a collection of ResourceClassParameters.
@JsonSerializable()
class ResourceclassparameterslistResourceV1Alpha2 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiResourceV1Alpha2ResourceClassParameters>? items;
    ...
    @JsonKey(name: "kind")
    ResourceclassparameterslistResourceV1Alpha2Kind? kind;
    
    ///Standard list metadata
    @JsonKey(name: "metadata")
    Metadata? metadata;

    ResourceclassparameterslistResourceV1Alpha2({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory ResourceclassparameterslistResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceclassparameterslistResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclassparameterslistResourceV1Alpha2ToJson(this);
}
...
///ResourceClassParameters defines resource requests for a ResourceClass in an in-tree
///format understood by Kubernetes.
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceClassParameters {
    ...
    List<IoK8SApiResourceV1Alpha2ResourceFilter>? filters;
    
    ///If this object was created from some other resource, then this links back to that
    ///resource. This field is used to find the in-tree representation of the class parameters
    ///when the parameter reference of the class refers to some unknown type.
    @JsonKey(name: "generatedFrom")
    IoK8SApiResourceV1Alpha2ResourceClassParametersReference? generatedFrom;
    ...
    ///VendorParameters are arbitrary setup parameters for all claims using this class. They are
    ///ignored while allocating the claim. There must not be more than one entry per driver.
    @JsonKey(name: "vendorParameters")
    List<IoK8SApiResourceV1Alpha2VendorParameters>? vendorParameters;
    ...
    factory IoK8SApiResourceV1Alpha2ResourceClassParameters.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceClassParametersFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceClassParametersToJson(this);
}


///ResourceFilter is a filter for resources from one particular driver.
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceFilter {
    ...
    factory IoK8SApiResourceV1Alpha2ResourceFilter.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceFilterFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceFilterToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceClassParametersReference {
    ...
    factory IoK8SApiResourceV1Alpha2ResourceClassParametersReference.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceClassParametersReferenceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceClassParametersReferenceToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
    @JsonValue("ResourceClassParameters")
    RESOURCE_CLASS_PARAMETERS
}

final itemKindValues = EnumValues({
    "ResourceClassParameters": ItemKind.RESOURCE_CLASS_PARAMETERS
});
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2VendorParameters {
    ...
    factory IoK8SApiResourceV1Alpha2VendorParameters.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2VendorParametersFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2VendorParametersToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclassparameterslistResourceV1Alpha2Kind {
    @JsonValue("ResourceClassParametersList")
    RESOURCE_CLASS_PARAMETERS_LIST
}

final resourceclassparameterslistResourceV1Alpha2KindValues = EnumValues({
    "ResourceClassParametersList": ResourceclassparameterslistResourceV1Alpha2Kind.RESOURCE_CLASS_PARAMETERS_LIST
});
