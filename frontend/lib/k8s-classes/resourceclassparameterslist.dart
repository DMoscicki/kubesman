...
part 'resourceclassparameterslist.g.dart';
...
class Resourceclassparameterslist {
    ...
    @JsonKey(name: "kind")
    ResourceclassparameterslistKind? kind;
    ...
    factory Resourceclassparameterslist.fromJson(Map<String, dynamic> json) => _$ResourceclassparameterslistFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceclassparameterslistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclassparameterslistKind {
    @JsonValue("ResourceClassParametersList")
    RESOURCE_CLASS_PARAMETERS_LIST
}

final resourceclassparameterslistKindValues = EnumValues({
    "ResourceClassParametersList": ResourceclassparameterslistKind.RESOURCE_CLASS_PARAMETERS_LIST
});
