...
part 'resourcehandle_resource_v1_alpha2.g.dart';


///ResourceHandle holds opaque resource data for processing by a specific kubelet plugin.
@JsonSerializable()
class ResourcehandleResourceV1Alpha2 {
    ...
    ResourcehandleResourceV1Alpha2({
        this.data,
        this.driverName,
        this.structuredData,
    });

    factory ResourcehandleResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourcehandleResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourcehandleResourceV1Alpha2ToJson(this);
}
