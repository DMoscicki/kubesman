...
part 'resourcemetricsource_autoscaling_v2.g.dart';
...
///type should be set.
@JsonSerializable()
class ResourcemetricsourceAutoscalingV2 {
    ...
    ResourcemetricsourceAutoscalingV2({
        required this.name,
        required this.target,
    });

    factory ResourcemetricsourceAutoscalingV2.fromJson(Map<String, dynamic> json) => _$ResourcemetricsourceAutoscalingV2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourcemetricsourceAutoscalingV2ToJson(this);
}
