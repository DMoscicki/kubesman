...
part 'resourcemetricsource.g.dart';
...
class Resourcemetricsource {
    ...
    factory Resourcemetricsource.fromJson(Map<String, dynamic> json) => _$ResourcemetricsourceFromJson(json);

    Map<String, dynamic> toJson() => _$ResourcemetricsourceToJson(this);
}
