...
part 'resourcepolicyrule_flowcontrol_v1.g.dart';
...
@JsonSerializable()
class ResourcepolicyruleFlowcontrolV1 {
    ...
    ResourcepolicyruleFlowcontrolV1({
    ...
    factory ResourcepolicyruleFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$ResourcepolicyruleFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$ResourcepolicyruleFlowcontrolV1ToJson(this);
}
