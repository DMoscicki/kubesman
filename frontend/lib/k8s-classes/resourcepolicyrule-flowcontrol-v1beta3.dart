...
part 'resourcepolicyrule_flowcontrol_v1_beta3.g.dart';
...
@JsonSerializable()
class ResourcepolicyruleFlowcontrolV1Beta3 {
    ...
    ResourcepolicyruleFlowcontrolV1Beta3({
    ...
    factory ResourcepolicyruleFlowcontrolV1Beta3.fromJson(Map<String, dynamic> json) => _$ResourcepolicyruleFlowcontrolV1Beta3FromJson(json);

    Map<String, dynamic> toJson() => _$ResourcepolicyruleFlowcontrolV1Beta3ToJson(this);
}
