...
class ResourcequotaV1 {
    ...
    factory ResourcequotaV1.fromJson(Map<String, dynamic> json) => _$ResourcequotaV1FromJson(json);

    Map<String, dynamic> toJson() => _$ResourcequotaV1ToJson(this);
}
...
final kindValues = EnumValues({
    "ResourceQuota": Kind.RESOURCE_QUOTA
});
