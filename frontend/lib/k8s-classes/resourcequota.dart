...
class Resourcequota {
    ...
    factory Resourcequota.fromJson(Map<String, dynamic> json) => _$ResourcequotaFromJson(json);

    Map<String, dynamic> toJson() => _$ResourcequotaToJson(this);
}
