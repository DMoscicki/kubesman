...
class Resourcequotalist {
    ...
    factory Resourcequotalist.fromJson(Map<String, dynamic> json) => _$ResourcequotalistFromJson(json);

    Map<String, dynamic> toJson() => _$ResourcequotalistToJson(this);
}
...
class IoK8SApiCoreV1ResourceQuota {
    ...
    factory IoK8SApiCoreV1ResourceQuota.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ResourceQuotaFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ResourceQuotaToJson(this);
}
...
final itemKindValues = EnumValues({
    "ResourceQuota": ItemKind.RESOURCE_QUOTA
});
...
class IoK8SApiCoreV1ResourceQuotaSpec {
    ...
    factory IoK8SApiCoreV1ResourceQuotaSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ResourceQuotaSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ResourceQuotaSpecToJson(this);
}
...
class IoK8SApiCoreV1ResourceQuotaStatus {
    ...
    factory IoK8SApiCoreV1ResourceQuotaStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ResourceQuotaStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ResourceQuotaStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourcequotalistKind {
    @JsonValue("ResourceQuotaList")
    RESOURCE_QUOTA_LIST
}

final resourcequotalistKindValues = EnumValues({
    "ResourceQuotaList": ResourcequotalistKind.RESOURCE_QUOTA_LIST
});
