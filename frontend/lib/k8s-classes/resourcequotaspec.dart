...
class Resourcequotaspec {
    ...
    factory Resourcequotaspec.fromJson(Map<String, dynamic> json) => _$ResourcequotaspecFromJson(json);

    Map<String, dynamic> toJson() => _$ResourcequotaspecToJson(this);
}
