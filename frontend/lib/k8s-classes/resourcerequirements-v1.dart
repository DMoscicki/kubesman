...
part 'resourcerequirements_v1.g.dart';
...
class ResourcerequirementsV1 {
    ...
    factory ResourcerequirementsV1.fromJson(Map<String, dynamic> json) => _$ResourcerequirementsV1FromJson(json);

    Map<String, dynamic> toJson() => _$ResourcerequirementsV1ToJson(this);
}
