...
part 'resourceslice_resource_v1_alpha2.g.dart';


///ResourceSlice provides information about available resources on individual nodes.
@JsonSerializable()
class ResourcesliceResourceV1Alpha2 {
    ...
    factory ResourcesliceResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourcesliceResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourcesliceResourceV1Alpha2ToJson(this);
}
...
final kindValues = EnumValues({
    "ResourceSlice": Kind.RESOURCE_SLICE
});
