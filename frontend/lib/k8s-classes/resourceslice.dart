...
class Resourceslice {
    ...
    factory Resourceslice.fromJson(Map<String, dynamic> json) => _$ResourcesliceFromJson(json);

    Map<String, dynamic> toJson() => _$ResourcesliceToJson(this);
}
