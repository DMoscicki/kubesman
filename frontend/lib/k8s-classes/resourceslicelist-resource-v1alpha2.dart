...
part 'resourceslicelist_resource_v1_alpha2.g.dart';


///ResourceSliceList is a collection of ResourceSlices.
@JsonSerializable()
class ResourceslicelistResourceV1Alpha2 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiResourceV1Alpha2ResourceSlice>? items;
    ...
    @JsonKey(name: "kind")
    ResourceslicelistResourceV1Alpha2Kind? kind;
    
    ///Standard list metadata
    @JsonKey(name: "metadata")
    Metadata? metadata;

    ResourceslicelistResourceV1Alpha2({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory ResourceslicelistResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$ResourceslicelistResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$ResourceslicelistResourceV1Alpha2ToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2ResourceSlice {
    ...
    ///DriverName identifies the DRA driver providing the capacity information. A field selector
    ...
    IoK8SApiResourceV1Alpha2NamedResourcesResources? namedResources;
    ...
    factory IoK8SApiResourceV1Alpha2ResourceSlice.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2ResourceSliceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2ResourceSliceToJson(this);
}
...
final itemKindValues = EnumValues({
    "ResourceSlice": ItemKind.RESOURCE_SLICE
});
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2NamedResourcesResources {
    
    ///The list of all individual resources instances currently available.
    @JsonKey(name: "instances")
    List<IoK8SApiResourceV1Alpha2NamedResourcesInstance> instances;

    IoK8SApiResourceV1Alpha2NamedResourcesResources({
        required this.instances,
    });

    factory IoK8SApiResourceV1Alpha2NamedResourcesResources.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2NamedResourcesResourcesFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2NamedResourcesResourcesToJson(this);
}
...
@JsonSerializable()
class IoK8SApiResourceV1Alpha2NamedResourcesInstance {
    ...
    factory IoK8SApiResourceV1Alpha2NamedResourcesInstance.fromJson(Map<String, dynamic> json) => _$IoK8SApiResourceV1Alpha2NamedResourcesInstanceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiResourceV1Alpha2NamedResourcesInstanceToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceslicelistResourceV1Alpha2Kind {
    @JsonValue("ResourceSliceList")
    RESOURCE_SLICE_LIST
}

final resourceslicelistResourceV1Alpha2KindValues = EnumValues({
    "ResourceSliceList": ResourceslicelistResourceV1Alpha2Kind.RESOURCE_SLICE_LIST
});
