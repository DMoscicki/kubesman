...
class Resourceslicelist {
    ...
    factory Resourceslicelist.fromJson(Map<String, dynamic> json) => _$ResourceslicelistFromJson(json);

    Map<String, dynamic> toJson() => _$ResourceslicelistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceslicelistKind {
    @JsonValue("ResourceSliceList")
    RESOURCE_SLICE_LIST
}

final resourceslicelistKindValues = EnumValues({
    "ResourceSliceList": ResourceslicelistKind.RESOURCE_SLICE_LIST
});
