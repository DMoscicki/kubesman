...
part of 'resourceslicelist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Resourceslicelist _$ResourceslicelistFromJson(Map<String, dynamic> json) =>
    Resourceslicelist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiResourceV1Alpha2ResourceSlice.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$ResourceslicelistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$ResourceslicelistToJson(Resourceslicelist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$ResourceslicelistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ResourceslicelistKindEnumMap = {
  ResourceslicelistKind.RESOURCE_SLICE_LIST: 'ResourceSliceList',
};

IoK8SApiResourceV1Alpha2ResourceSlice
    _$IoK8SApiResourceV1Alpha2ResourceSliceFromJson(
...
Map<String, dynamic> _$IoK8SApiResourceV1Alpha2ResourceSliceToJson(
        IoK8SApiResourceV1Alpha2ResourceSlice instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.RESOURCE_SLICE: 'ResourceSlice',
};
