...
class RoleRbacV1 {
    ...
    factory RoleRbacV1.fromJson(Map<String, dynamic> json) => _$RoleRbacV1FromJson(json);

    Map<String, dynamic> toJson() => _$RoleRbacV1ToJson(this);
}
