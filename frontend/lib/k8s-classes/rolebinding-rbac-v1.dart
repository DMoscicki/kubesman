...
part 'rolebinding_rbac_v1.g.dart';
...
class RolebindingRbacV1 {
    ...
    factory RolebindingRbacV1.fromJson(Map<String, dynamic> json) => _$RolebindingRbacV1FromJson(json);

    Map<String, dynamic> toJson() => _$RolebindingRbacV1ToJson(this);
}
