...
class Rolebinding {
    ...
    factory Rolebinding.fromJson(Map<String, dynamic> json) => _$RolebindingFromJson(json);

    Map<String, dynamic> toJson() => _$RolebindingToJson(this);
}
