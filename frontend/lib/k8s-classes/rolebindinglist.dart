...
class Rolebindinglist {
    ...
    factory Rolebindinglist.fromJson(Map<String, dynamic> json) => _$RolebindinglistFromJson(json);

    Map<String, dynamic> toJson() => _$RolebindinglistToJson(this);
}
...
class IoK8SApiRbacV1RoleBinding {
    ...
    ///namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. This
    ///field is immutable.
    ...
    factory IoK8SApiRbacV1RoleBinding.fromJson(Map<String, dynamic> json) => _$IoK8SApiRbacV1RoleBindingFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiRbacV1RoleBindingToJson(this);
}
...
final itemKindValues = EnumValues({
    "RoleBinding": ItemKind.ROLE_BINDING
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum RolebindinglistKind {
    @JsonValue("RoleBindingList")
    ROLE_BINDING_LIST
}

final rolebindinglistKindValues = EnumValues({
    "RoleBindingList": RolebindinglistKind.ROLE_BINDING_LIST
});
