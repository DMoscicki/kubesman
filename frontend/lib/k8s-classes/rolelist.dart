...
class IoK8SApiRbacV1Role {
    ...
    factory IoK8SApiRbacV1Role.fromJson(Map<String, dynamic> json) => _$IoK8SApiRbacV1RoleFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiRbacV1RoleToJson(this);
}
...
final rolelistKindValues = EnumValues({
    "RoleList": RolelistKind.ROLE_LIST
});
