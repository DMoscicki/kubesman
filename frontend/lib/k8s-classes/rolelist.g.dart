...
Rolelist _$RolelistFromJson(Map<String, dynamic> json) => Rolelist(
      ...
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiRbacV1Role.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$RolelistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$RolelistToJson(Rolelist instance) => <String, dynamic>{
      ...
      'kind': _$RolelistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$RolelistKindEnumMap = {
  RolelistKind.ROLE_LIST: 'RoleList',
};

IoK8SApiRbacV1Role _$IoK8SApiRbacV1RoleFromJson(Map<String, dynamic> json) =>
    IoK8SApiRbacV1Role(
      apiVersion: json['apiVersion'] as String?,
...
Map<String, dynamic> _$IoK8SApiRbacV1RoleToJson(IoK8SApiRbacV1Role instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
