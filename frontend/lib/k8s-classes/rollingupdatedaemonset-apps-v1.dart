...
part 'rollingupdatedaemonset_apps_v1.g.dart';


///Spec to control the desired behavior of daemon set rolling update.
@JsonSerializable()
class RollingupdatedaemonsetAppsV1 {
    ...
    RollingupdatedaemonsetAppsV1({
        this.maxSurge,
        this.maxUnavailable,
    });

    factory RollingupdatedaemonsetAppsV1.fromJson(Map<String, dynamic> json) => _$RollingupdatedaemonsetAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$RollingupdatedaemonsetAppsV1ToJson(this);
}
