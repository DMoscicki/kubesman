...
part 'rollingupdatedaemonset.g.dart';
...
class Rollingupdatedaemonset {
    ...
    factory Rollingupdatedaemonset.fromJson(Map<String, dynamic> json) => _$RollingupdatedaemonsetFromJson(json);

    Map<String, dynamic> toJson() => _$RollingupdatedaemonsetToJson(this);
}
