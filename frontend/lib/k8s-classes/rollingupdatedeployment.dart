...
part 'rollingupdatedeployment.g.dart';
...
class Rollingupdatedeployment {
    ...
    factory Rollingupdatedeployment.fromJson(Map<String, dynamic> json) => _$RollingupdatedeploymentFromJson(json);

    Map<String, dynamic> toJson() => _$RollingupdatedeploymentToJson(this);
}
