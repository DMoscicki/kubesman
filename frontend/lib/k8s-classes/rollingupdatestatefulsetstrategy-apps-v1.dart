...
part 'rollingupdatestatefulsetstrategy_apps_v1.g.dart';


///RollingUpdateStatefulSetStrategy is used to communicate parameter for
///RollingUpdateStatefulSetStrategyType.
@JsonSerializable()
class RollingupdatestatefulsetstrategyAppsV1 {
    ...
    RollingupdatestatefulsetstrategyAppsV1({
        this.maxUnavailable,
        this.partition,
    });

    factory RollingupdatestatefulsetstrategyAppsV1.fromJson(Map<String, dynamic> json) => _$RollingupdatestatefulsetstrategyAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$RollingupdatestatefulsetstrategyAppsV1ToJson(this);
}
