...
part 'rulewithoperations_admissionregistration_v1.g.dart';
...
@JsonSerializable()
class RulewithoperationsAdmissionregistrationV1 {
    ...
    RulewithoperationsAdmissionregistrationV1({
        this.apiGroups,
        this.apiVersions,
        this.operations,
        this.resources,
    ...
    factory RulewithoperationsAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$RulewithoperationsAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$RulewithoperationsAdmissionregistrationV1ToJson(this);
}
