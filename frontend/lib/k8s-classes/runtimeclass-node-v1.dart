...
part 'runtimeclass_node_v1.g.dart';
...
class RuntimeclassNodeV1 {
    ...
    factory RuntimeclassNodeV1.fromJson(Map<String, dynamic> json) => _$RuntimeclassNodeV1FromJson(json);

    Map<String, dynamic> toJson() => _$RuntimeclassNodeV1ToJson(this);
}
...
final kindValues = EnumValues({
    "RuntimeClass": Kind.RUNTIME_CLASS
});
