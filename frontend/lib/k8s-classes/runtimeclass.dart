...
class Runtimeclass {
    ...
    factory Runtimeclass.fromJson(Map<String, dynamic> json) => _$RuntimeclassFromJson(json);

    Map<String, dynamic> toJson() => _$RuntimeclassToJson(this);
}
