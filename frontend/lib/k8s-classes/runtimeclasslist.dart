...
class Runtimeclasslist {
    ...
    factory Runtimeclasslist.fromJson(Map<String, dynamic> json) => _$RuntimeclasslistFromJson(json);

    Map<String, dynamic> toJson() => _$RuntimeclasslistToJson(this);
}


///RuntimeClass defines a class of container runtime supported in the cluster. The
///RuntimeClass is used to determine which container runtime is used to run all containers
///in a pod. RuntimeClasses are manually defined by a user or cluster provisioner, and
...
class IoK8SApiNodeV1RuntimeClass {
    ...
    factory IoK8SApiNodeV1RuntimeClass.fromJson(Map<String, dynamic> json) => _$IoK8SApiNodeV1RuntimeClassFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNodeV1RuntimeClassToJson(this);
}
...
final itemKindValues = EnumValues({
    "RuntimeClass": ItemKind.RUNTIME_CLASS
});
...
class IoK8SApiNodeV1Overhead {
    ...
    factory IoK8SApiNodeV1Overhead.fromJson(Map<String, dynamic> json) => _$IoK8SApiNodeV1OverheadFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNodeV1OverheadToJson(this);
}
...
class IoK8SApiNodeV1Scheduling {
    ...
    factory IoK8SApiNodeV1Scheduling.fromJson(Map<String, dynamic> json) => _$IoK8SApiNodeV1SchedulingFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNodeV1SchedulingToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum RuntimeclasslistKind {
    @JsonValue("RuntimeClassList")
    RUNTIME_CLASS_LIST
}

final runtimeclasslistKindValues = EnumValues({
    "RuntimeClassList": RuntimeclasslistKind.RUNTIME_CLASS_LIST
});
