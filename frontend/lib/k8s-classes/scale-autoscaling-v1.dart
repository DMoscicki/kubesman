...
part 'scale_autoscaling_v1.g.dart';


///Scale represents a scaling request for a resource.
@JsonSerializable()
class ScaleAutoscalingV1 {
    ...
    factory ScaleAutoscalingV1.fromJson(Map<String, dynamic> json) => _$ScaleAutoscalingV1FromJson(json);

    Map<String, dynamic> toJson() => _$ScaleAutoscalingV1ToJson(this);
}
...
class IoK8SApiAutoscalingV1ScaleSpec {
    ...
    factory IoK8SApiAutoscalingV1ScaleSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAutoscalingV1ScaleSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAutoscalingV1ScaleSpecToJson(this);
}
...
class IoK8SApiAutoscalingV1ScaleStatus {
    ...
    factory IoK8SApiAutoscalingV1ScaleStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAutoscalingV1ScaleStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAutoscalingV1ScaleStatusToJson(this);
}
