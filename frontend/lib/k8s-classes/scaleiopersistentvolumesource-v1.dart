...
part 'scaleiopersistentvolumesource_v1.g.dart';


///ScaleIOPersistentVolumeSource represents a persistent ScaleIO volume
@JsonSerializable()
class ScaleiopersistentvolumesourceV1 {
    ...
    ScaleiopersistentvolumesourceV1({
        this.fsType,
    ...
    factory ScaleiopersistentvolumesourceV1.fromJson(Map<String, dynamic> json) => _$ScaleiopersistentvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$ScaleiopersistentvolumesourceV1ToJson(this);
}
