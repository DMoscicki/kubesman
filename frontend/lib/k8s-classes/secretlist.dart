...
class Secretlist {
    ...
    factory Secretlist.fromJson(Map<String, dynamic> json) => _$SecretlistFromJson(json);

    Map<String, dynamic> toJson() => _$SecretlistToJson(this);
}
...
class IoK8SApiCoreV1Secret {
    ...
    factory IoK8SApiCoreV1Secret.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1SecretFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1SecretToJson(this);
}
...
final secretlistKindValues = EnumValues({
    "SecretList": SecretlistKind.SECRET_LIST
});
