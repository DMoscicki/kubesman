...
part 'secretprojection_v1.g.dart';
...
class SecretprojectionV1 {
    ...
    factory SecretprojectionV1.fromJson(Map<String, dynamic> json) => _$SecretprojectionV1FromJson(json);

    Map<String, dynamic> toJson() => _$SecretprojectionV1ToJson(this);
}
