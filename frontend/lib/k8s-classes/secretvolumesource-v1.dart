...
part 'secretvolumesource_v1.g.dart';
...
class SecretvolumesourceV1 {
    ...
    factory SecretvolumesourceV1.fromJson(Map<String, dynamic> json) => _$SecretvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$SecretvolumesourceV1ToJson(this);
}
