...
part 'securitycontext_v1.g.dart';
...
class SecuritycontextV1 {
    ...
    factory SecuritycontextV1.fromJson(Map<String, dynamic> json) => _$SecuritycontextV1FromJson(json);

    Map<String, dynamic> toJson() => _$SecuritycontextV1ToJson(this);
}
