...
part 'selfsubjectaccessreview_authorization_v1.g.dart';
...
@JsonSerializable()
class SelfsubjectaccessreviewAuthorizationV1 {
    ...
    SelfsubjectaccessreviewAuthorizationV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        required this.spec,
    ...
    factory SelfsubjectaccessreviewAuthorizationV1.fromJson(Map<String, dynamic> json) => _$SelfsubjectaccessreviewAuthorizationV1FromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectaccessreviewAuthorizationV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum Kind {
    @JsonValue("SelfSubjectAccessReview")
    SELF_SUBJECT_ACCESS_REVIEW
}

final kindValues = EnumValues({
    "SelfSubjectAccessReview": Kind.SELF_SUBJECT_ACCESS_REVIEW
});
...
class IoK8SApiAuthorizationV1SelfSubjectAccessReviewSpec {
    ...
    factory IoK8SApiAuthorizationV1SelfSubjectAccessReviewSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthorizationV1SelfSubjectAccessReviewSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthorizationV1SelfSubjectAccessReviewSpecToJson(this);
}
