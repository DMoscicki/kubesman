...
part 'selfsubjectaccessreview.g.dart';
...
class Selfsubjectaccessreview {
    ...
    factory Selfsubjectaccessreview.fromJson(Map<String, dynamic> json) => _$SelfsubjectaccessreviewFromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectaccessreviewToJson(this);
}
