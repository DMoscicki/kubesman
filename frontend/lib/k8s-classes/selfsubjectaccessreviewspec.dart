...
part 'selfsubjectaccessreviewspec.g.dart';
...
class Selfsubjectaccessreviewspec {
    ...
    factory Selfsubjectaccessreviewspec.fromJson(Map<String, dynamic> json) => _$SelfsubjectaccessreviewspecFromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectaccessreviewspecToJson(this);
}
