...
part 'selfsubjectreview_authentication_v1.g.dart';
...
@JsonSerializable()
class SelfsubjectreviewAuthenticationV1 {
    ...
    @JsonKey(name: "status")
    IoK8SApiAuthenticationV1SelfSubjectReviewStatus? status;

    SelfsubjectreviewAuthenticationV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.status,
    ...
    factory SelfsubjectreviewAuthenticationV1.fromJson(Map<String, dynamic> json) => _$SelfsubjectreviewAuthenticationV1FromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectreviewAuthenticationV1ToJson(this);
}
...
class IoK8SApiAuthenticationV1SelfSubjectReviewStatus {
    ...
    factory IoK8SApiAuthenticationV1SelfSubjectReviewStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthenticationV1SelfSubjectReviewStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthenticationV1SelfSubjectReviewStatusToJson(this);
}
