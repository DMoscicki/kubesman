...
part 'selfsubjectreview_authentication_v1_alpha1.g.dart';
...
@JsonSerializable()
class SelfsubjectreviewAuthenticationV1Alpha1 {
    ...
    SelfsubjectreviewAuthenticationV1Alpha1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.status,
    ...
    factory SelfsubjectreviewAuthenticationV1Alpha1.fromJson(Map<String, dynamic> json) => _$SelfsubjectreviewAuthenticationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectreviewAuthenticationV1Alpha1ToJson(this);
}
...
class IoK8SApiAuthenticationV1Alpha1SelfSubjectReviewStatus {
    ...
    factory IoK8SApiAuthenticationV1Alpha1SelfSubjectReviewStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthenticationV1Alpha1SelfSubjectReviewStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthenticationV1Alpha1SelfSubjectReviewStatusToJson(this);
}
