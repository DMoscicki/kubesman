...
part 'selfsubjectreview_authentication_v1_beta1.g.dart';


///SelfSubjectReview contains the user information that the kube-apiserver has about the
///user making this request. When using impersonation, users will receive the user info of
///the user being impersonated.  If impersonation or request header authentication is used,
///any extra keys will have their case ignored and returned as lowercase.
@JsonSerializable()
class SelfsubjectreviewAuthenticationV1Beta1 {
    ...
    @JsonKey(name: "status")
    IoK8SApiAuthenticationV1Beta1SelfSubjectReviewStatus? status;

    SelfsubjectreviewAuthenticationV1Beta1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.status,
    ...
    factory SelfsubjectreviewAuthenticationV1Beta1.fromJson(Map<String, dynamic> json) => _$SelfsubjectreviewAuthenticationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectreviewAuthenticationV1Beta1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum Kind {
    @JsonValue("SelfSubjectReview")
    SELF_SUBJECT_REVIEW
}

final kindValues = EnumValues({
    "SelfSubjectReview": Kind.SELF_SUBJECT_REVIEW
});
...
@JsonSerializable()
class IoK8SApiAuthenticationV1Beta1SelfSubjectReviewStatus {
    ...
    factory IoK8SApiAuthenticationV1Beta1SelfSubjectReviewStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthenticationV1Beta1SelfSubjectReviewStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthenticationV1Beta1SelfSubjectReviewStatusToJson(this);
}
