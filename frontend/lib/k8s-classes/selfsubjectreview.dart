...
class Selfsubjectreview {
    ...
    factory Selfsubjectreview.fromJson(Map<String, dynamic> json) => _$SelfsubjectreviewFromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectreviewToJson(this);
}
