...
part 'selfsubjectreviewstatus_authentication_v1_beta1.g.dart';


///SelfSubjectReviewStatus is filled by the kube-apiserver and sent back to a user.
@JsonSerializable()
class SelfsubjectreviewstatusAuthenticationV1Beta1 {
    
    ///User attributes of the user making this request.
    @JsonKey(name: "userInfo")
    IoK8SApiAuthenticationV1UserInfo? userInfo;

    SelfsubjectreviewstatusAuthenticationV1Beta1({
        this.userInfo,
    });

    factory SelfsubjectreviewstatusAuthenticationV1Beta1.fromJson(Map<String, dynamic> json) => _$SelfsubjectreviewstatusAuthenticationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectreviewstatusAuthenticationV1Beta1ToJson(this);
}
