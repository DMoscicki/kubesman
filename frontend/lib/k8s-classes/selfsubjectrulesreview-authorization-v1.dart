...
part 'selfsubjectrulesreview_authorization_v1.g.dart';


///SelfSubjectRulesReview enumerates the set of actions the current user can perform within
///a namespace. The returned list of actions may be incomplete depending on the server's
///authorization mode, and any errors experienced during the evaluation.
///SelfSubjectRulesReview should be used by UIs to show/hide actions, or to quickly let an
///end user reason about their permissions. It should NOT Be used by external systems to
///drive authorization decisions as this raises confused deputy, cache lifetime/revocation,
///and correctness concerns. SubjectAccessReview, and LocalAccessReview are the correct way
///to defer authorization decisions to the API server.
@JsonSerializable()
class SelfsubjectrulesreviewAuthorizationV1 {
    ...
    SelfsubjectrulesreviewAuthorizationV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        required this.spec,
    ...
    factory SelfsubjectrulesreviewAuthorizationV1.fromJson(Map<String, dynamic> json) => _$SelfsubjectrulesreviewAuthorizationV1FromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectrulesreviewAuthorizationV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum Kind {
    @JsonValue("SelfSubjectRulesReview")
    SELF_SUBJECT_RULES_REVIEW
}

final kindValues = EnumValues({
    "SelfSubjectRulesReview": Kind.SELF_SUBJECT_RULES_REVIEW
});
...
class IoK8SApiAuthorizationV1SelfSubjectRulesReviewSpec {
    ...
    factory IoK8SApiAuthorizationV1SelfSubjectRulesReviewSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthorizationV1SelfSubjectRulesReviewSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthorizationV1SelfSubjectRulesReviewSpecToJson(this);
}
...
class IoK8SApiAuthorizationV1SubjectRulesReviewStatus {
    ...
    factory IoK8SApiAuthorizationV1SubjectRulesReviewStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthorizationV1SubjectRulesReviewStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthorizationV1SubjectRulesReviewStatusToJson(this);
}
