...
part 'selfsubjectrulesreview.g.dart';
...
class Selfsubjectrulesreview {
    ...
    factory Selfsubjectrulesreview.fromJson(Map<String, dynamic> json) => _$SelfsubjectrulesreviewFromJson(json);

    Map<String, dynamic> toJson() => _$SelfsubjectrulesreviewToJson(this);
}
