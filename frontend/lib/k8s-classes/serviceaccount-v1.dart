...
class ServiceaccountV1 {
    ...
    factory ServiceaccountV1.fromJson(Map<String, dynamic> json) => _$ServiceaccountV1FromJson(json);

    Map<String, dynamic> toJson() => _$ServiceaccountV1ToJson(this);
}
