...
part 'serviceaccountlist.g.dart';
...
class Serviceaccountlist {
    ...
    factory Serviceaccountlist.fromJson(Map<String, dynamic> json) => _$ServiceaccountlistFromJson(json);
...
class IoK8SApiCoreV1ServiceAccount {
    ...
    ///account has a "kubernetes.io/enforce-mountable-secrets" annotation set to "true". This
    ///field should not be used to find auto-generated service account token secrets for use
    ///outside of pods. Instead, tokens can be requested directly using the TokenRequest API, or
    ...
    factory IoK8SApiCoreV1ServiceAccount.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ServiceAccountFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ServiceAccountToJson(this);
}
...
final itemKindValues = EnumValues({
    "ServiceAccount": ItemKind.SERVICE_ACCOUNT
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ServiceaccountlistKind {
    @JsonValue("ServiceAccountList")
    SERVICE_ACCOUNT_LIST
}

final serviceaccountlistKindValues = EnumValues({
    "ServiceAccountList": ServiceaccountlistKind.SERVICE_ACCOUNT_LIST
});
