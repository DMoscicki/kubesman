...
part of 'serviceaccountlist.dart';
...
Serviceaccountlist _$ServiceaccountlistFromJson(Map<String, dynamic> json) =>
    Serviceaccountlist(
      ...
      items: (json['items'] as List<dynamic>?)
          ?.map((e) =>
              IoK8SApiCoreV1ServiceAccount.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$ServiceaccountlistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$ServiceaccountlistToJson(Serviceaccountlist instance) =>
    <String, dynamic>{
      ...
      'kind': _$ServiceaccountlistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ServiceaccountlistKindEnumMap = {
  ServiceaccountlistKind.SERVICE_ACCOUNT_LIST: 'ServiceAccountList',
};

IoK8SApiCoreV1ServiceAccount _$IoK8SApiCoreV1ServiceAccountFromJson(
...
Map<String, dynamic> _$IoK8SApiCoreV1ServiceAccountToJson(
        IoK8SApiCoreV1ServiceAccount instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.SERVICE_ACCOUNT: 'ServiceAccount',
};
