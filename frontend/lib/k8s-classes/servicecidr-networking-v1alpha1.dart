...
part 'servicecidr_networking_v1_alpha1.g.dart';
...
@JsonSerializable()
class ServicecidrNetworkingV1Alpha1 {
    ...
    factory ServicecidrNetworkingV1Alpha1.fromJson(Map<String, dynamic> json) => _$ServicecidrNetworkingV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ServicecidrNetworkingV1Alpha1ToJson(this);
}
