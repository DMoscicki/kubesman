...
class Servicecidr {
    ...
    factory Servicecidr.fromJson(Map<String, dynamic> json) => _$ServicecidrFromJson(json);

    Map<String, dynamic> toJson() => _$ServicecidrToJson(this);
}
