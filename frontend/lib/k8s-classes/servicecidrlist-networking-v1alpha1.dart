...
part 'servicecidrlist_networking_v1_alpha1.g.dart';


///ServiceCIDRList contains a list of ServiceCIDR objects.
@JsonSerializable()
class ServicecidrlistNetworkingV1Alpha1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiNetworkingV1Alpha1ServiceCidr>? items;
    ...
    @JsonKey(name: "kind")
    ServicecidrlistNetworkingV1Alpha1Kind? kind;
    ...
    ServicecidrlistNetworkingV1Alpha1({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory ServicecidrlistNetworkingV1Alpha1.fromJson(Map<String, dynamic> json) => _$ServicecidrlistNetworkingV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ServicecidrlistNetworkingV1Alpha1ToJson(this);
}
...
@JsonSerializable()
class IoK8SApiNetworkingV1Alpha1ServiceCidr {
    ...
    @JsonKey(name: "spec")
    IoK8SApiNetworkingV1Alpha1ServiceCidrSpec? spec;
    
    ///status represents the current state of the ServiceCIDR. More info:
    ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    @JsonKey(name: "status")
    IoK8SApiNetworkingV1Alpha1ServiceCidrStatus? status;
    ...
    factory IoK8SApiNetworkingV1Alpha1ServiceCidr.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1Alpha1ServiceCidrFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1Alpha1ServiceCidrToJson(this);
}
...
final itemKindValues = EnumValues({
    "ServiceCIDR": ItemKind.SERVICE_CIDR
});
...
///Services.
@JsonSerializable()
class IoK8SApiNetworkingV1Alpha1ServiceCidrSpec {
    ...
    factory IoK8SApiNetworkingV1Alpha1ServiceCidrSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1Alpha1ServiceCidrSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1Alpha1ServiceCidrSpecToJson(this);
}
...
@JsonSerializable()
class IoK8SApiNetworkingV1Alpha1ServiceCidrStatus {
    ...
    factory IoK8SApiNetworkingV1Alpha1ServiceCidrStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiNetworkingV1Alpha1ServiceCidrStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiNetworkingV1Alpha1ServiceCidrStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ServicecidrlistNetworkingV1Alpha1Kind {
    @JsonValue("ServiceCIDRList")
    SERVICE_CIDR_LIST
}

final servicecidrlistNetworkingV1Alpha1KindValues = EnumValues({
    "ServiceCIDRList": ServicecidrlistNetworkingV1Alpha1Kind.SERVICE_CIDR_LIST
});
