...
class Servicecidrlist {
    ...
    factory Servicecidrlist.fromJson(Map<String, dynamic> json) => _$ServicecidrlistFromJson(json);

    Map<String, dynamic> toJson() => _$ServicecidrlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ServicecidrlistKind {
    @JsonValue("ServiceCIDRList")
    SERVICE_CIDR_LIST
}

final servicecidrlistKindValues = EnumValues({
    "ServiceCIDRList": ServicecidrlistKind.SERVICE_CIDR_LIST
});
