...
class Servicecidrstatus {
    ...
    factory Servicecidrstatus.fromJson(Map<String, dynamic> json) => _$ServicecidrstatusFromJson(json);

    Map<String, dynamic> toJson() => _$ServicecidrstatusToJson(this);
}
