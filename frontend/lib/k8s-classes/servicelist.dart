...
class IoK8SApiCoreV1Service {
    ...
    factory IoK8SApiCoreV1Service.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1ServiceFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1ServiceToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ServicelistKind {
    @JsonValue("ServiceList")
    SERVICE_LIST
}

final servicelistKindValues = EnumValues({
    "ServiceList": ServicelistKind.SERVICE_LIST
});
