...
Servicelist _$ServicelistFromJson(Map<String, dynamic> json) => Servicelist(
      ...
      items: (json['items'] as List<dynamic>?)
          ?.map(
              (e) => IoK8SApiCoreV1Service.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$ServicelistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$ServicelistToJson(Servicelist instance) =>
    <String, dynamic>{
      ...
      'kind': _$ServicelistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ServicelistKindEnumMap = {
  ServicelistKind.SERVICE_LIST: 'ServiceList',
};

IoK8SApiCoreV1Service _$IoK8SApiCoreV1ServiceFromJson(
...
Map<String, dynamic> _$IoK8SApiCoreV1ServiceToJson(
        IoK8SApiCoreV1Service instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
