...
class ServiceportV1 {
    ...
    factory ServiceportV1.fromJson(Map<String, dynamic> json) => _$ServiceportV1FromJson(json);

    Map<String, dynamic> toJson() => _$ServiceportV1ToJson(this);
}
