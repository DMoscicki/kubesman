...
class ServicespecV1 {
    ...
    factory ServicespecV1.fromJson(Map<String, dynamic> json) => _$ServicespecV1FromJson(json);

    Map<String, dynamic> toJson() => _$ServicespecV1ToJson(this);
}
