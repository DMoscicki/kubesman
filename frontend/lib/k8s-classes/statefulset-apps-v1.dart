...
part 'statefulset_apps_v1.g.dart';
...
class StatefulsetAppsV1 {
    ...
    factory StatefulsetAppsV1.fromJson(Map<String, dynamic> json) => _$StatefulsetAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$StatefulsetAppsV1ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StatefulsetAppsV1Kind {
    @JsonValue("StatefulSet")
    STATEFUL_SET
}

final statefulsetAppsV1KindValues = EnumValues({
    "StatefulSet": StatefulsetAppsV1Kind.STATEFUL_SET
});
