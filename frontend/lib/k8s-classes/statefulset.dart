...
class Statefulset {
    ...
    factory Statefulset.fromJson(Map<String, dynamic> json) => _$StatefulsetFromJson(json);

    Map<String, dynamic> toJson() => _$StatefulsetToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StatefulsetKind {
    @JsonValue("StatefulSet")
    STATEFUL_SET
}

final statefulsetKindValues = EnumValues({
    "StatefulSet": StatefulsetKind.STATEFUL_SET
});
