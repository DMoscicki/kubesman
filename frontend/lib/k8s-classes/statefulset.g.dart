...
part of 'statefulset.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Statefulset _$StatefulsetFromJson(Map<String, dynamic> json) => Statefulset(
      apiVersion: json['apiVersion'] as String?,
      kind: $enumDecodeNullable(_$StatefulsetKindEnumMap, json['kind']),
...
Map<String, dynamic> _$StatefulsetToJson(Statefulset instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'kind': _$StatefulsetKindEnumMap[instance.kind],
      'metadata': instance.metadata,
      'spec': instance.spec,
      'status': instance.status,
    };

const _$StatefulsetKindEnumMap = {
  StatefulsetKind.STATEFUL_SET: 'StatefulSet',
};
