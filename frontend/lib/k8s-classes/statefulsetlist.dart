...
class Statefulsetlist {
    ...
    factory Statefulsetlist.fromJson(Map<String, dynamic> json) => _$StatefulsetlistFromJson(json);

    Map<String, dynamic> toJson() => _$StatefulsetlistToJson(this);
}
...
///
///The StatefulSet guarantees that a given network identity will always map to the same
///storage identity.
@JsonSerializable()
class IoK8SApiAppsV1StatefulSet {
    ...
    factory IoK8SApiAppsV1StatefulSet.fromJson(Map<String, dynamic> json) => _$IoK8SApiAppsV1StatefulSetFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAppsV1StatefulSetToJson(this);
}
...
final itemKindValues = EnumValues({
    "StatefulSet": ItemKind.STATEFUL_SET
});
...
class IoK8SApiAppsV1StatefulSetSpec {
    ...
    ///behavior assigns a "0" index to the first replica and increments the index by one for
    ///each additional replica requested. Using the ordinals field requires the
    ///StatefulSetStartOrdinal feature gate to be enabled, which is beta.
    ...
    ///created from volumeClaimTemplates. By default, all persistent volume claims are created
    ///as needed and retained until manually deleted. This policy allows the lifecycle to be
    ///altered, for example by deleting persistent volume claims when their stateful set is
    ///deleted, or when their pod is scaled down. This requires the StatefulSetAutoDeletePVC
    ///feature gate to be enabled, which is alpha.  +optional
    ...
    ///Template, but have a unique identity from the rest of the StatefulSet. Each pod will be
    ///named with the format <statefulsetname>-<podindex>. For example, a pod in a StatefulSet
    ///named "web" with index number "3" would be named "web-3". The only allowed
    ...
    factory IoK8SApiAppsV1StatefulSetSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAppsV1StatefulSetSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAppsV1StatefulSetSpecToJson(this);
}
...
class IoK8SApiAppsV1StatefulSetOrdinals {
    ...
    factory IoK8SApiAppsV1StatefulSetOrdinals.fromJson(Map<String, dynamic> json) => _$IoK8SApiAppsV1StatefulSetOrdinalsFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAppsV1StatefulSetOrdinalsToJson(this);
}
...
class IoK8SApiAppsV1StatefulSetPersistentVolumeClaimRetentionPolicy {
    ...
    factory IoK8SApiAppsV1StatefulSetPersistentVolumeClaimRetentionPolicy.fromJson(Map<String, dynamic> json) => _$IoK8SApiAppsV1StatefulSetPersistentVolumeClaimRetentionPolicyFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAppsV1StatefulSetPersistentVolumeClaimRetentionPolicyToJson(this);
}
...
class IoK8SApiAppsV1StatefulSetUpdateStrategy {
    ...
    factory IoK8SApiAppsV1StatefulSetUpdateStrategy.fromJson(Map<String, dynamic> json) => _$IoK8SApiAppsV1StatefulSetUpdateStrategyFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAppsV1StatefulSetUpdateStrategyToJson(this);
}
...
class IoK8SApiAppsV1StatefulSetStatus {
    ...
    factory IoK8SApiAppsV1StatefulSetStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAppsV1StatefulSetStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAppsV1StatefulSetStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StatefulsetlistKind {
    @JsonValue("StatefulSetList")
    STATEFUL_SET_LIST
}

final statefulsetlistKindValues = EnumValues({
    "StatefulSetList": StatefulsetlistKind.STATEFUL_SET_LIST
});
