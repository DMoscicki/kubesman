...
class Statefulsetspec {
    ...
    factory Statefulsetspec.fromJson(Map<String, dynamic> json) => _$StatefulsetspecFromJson(json);

    Map<String, dynamic> toJson() => _$StatefulsetspecToJson(this);
}
