...
part 'statefulsetstatus_apps_v1.g.dart';


///StatefulSetStatus represents the current state of a StatefulSet.
@JsonSerializable()
class StatefulsetstatusAppsV1 {
    ...
    factory StatefulsetstatusAppsV1.fromJson(Map<String, dynamic> json) => _$StatefulsetstatusAppsV1FromJson(json);

    Map<String, dynamic> toJson() => _$StatefulsetstatusAppsV1ToJson(this);
}
