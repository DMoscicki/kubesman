...
part 'statefulsetupdatestrategy.g.dart';
...
class Statefulsetupdatestrategy {
    ...
    factory Statefulsetupdatestrategy.fromJson(Map<String, dynamic> json) => _$StatefulsetupdatestrategyFromJson(json);

    Map<String, dynamic> toJson() => _$StatefulsetupdatestrategyToJson(this);
}
