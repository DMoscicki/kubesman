...
class StatusMetaV1 {
    ...
    factory StatusMetaV1.fromJson(Map<String, dynamic> json) => _$StatusMetaV1FromJson(json);

    Map<String, dynamic> toJson() => _$StatusMetaV1ToJson(this);
}
