...
part 'statusdetails_meta_v1.g.dart';
...
class StatusdetailsMetaV1 {
    ...
    factory StatusdetailsMetaV1.fromJson(Map<String, dynamic> json) => _$StatusdetailsMetaV1FromJson(json);

    Map<String, dynamic> toJson() => _$StatusdetailsMetaV1ToJson(this);
}
