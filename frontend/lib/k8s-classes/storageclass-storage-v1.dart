...
part 'storageclass_storage_v1.g.dart';
...
class StorageclassStorageV1 {
    ...
    factory StorageclassStorageV1.fromJson(Map<String, dynamic> json) => _$StorageclassStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$StorageclassStorageV1ToJson(this);
}
...
final kindValues = EnumValues({
    "StorageClass": Kind.STORAGE_CLASS
});
