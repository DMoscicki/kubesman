...
class Storageclass {
    ...
    factory Storageclass.fromJson(Map<String, dynamic> json) => _$StorageclassFromJson(json);

    Map<String, dynamic> toJson() => _$StorageclassToJson(this);
}
