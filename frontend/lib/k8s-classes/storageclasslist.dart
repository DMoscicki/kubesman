...
class Storageclasslist {
    ...
    factory Storageclasslist.fromJson(Map<String, dynamic> json) => _$StorageclasslistFromJson(json);

    Map<String, dynamic> toJson() => _$StorageclasslistToJson(this);
}
...
class IoK8SApiStorageV1StorageClass {
    ...
    factory IoK8SApiStorageV1StorageClass.fromJson(Map<String, dynamic> json) => _$IoK8SApiStorageV1StorageClassFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStorageV1StorageClassToJson(this);
}
...
class IoK8SApiCoreV1TopologySelectorTerm {
    ...
    factory IoK8SApiCoreV1TopologySelectorTerm.fromJson(Map<String, dynamic> json) => _$IoK8SApiCoreV1TopologySelectorTermFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiCoreV1TopologySelectorTermToJson(this);
}
...
final itemKindValues = EnumValues({
    "StorageClass": ItemKind.STORAGE_CLASS
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StorageclasslistKind {
    @JsonValue("StorageClassList")
    STORAGE_CLASS_LIST
}

final storageclasslistKindValues = EnumValues({
    "StorageClassList": StorageclasslistKind.STORAGE_CLASS_LIST
});
