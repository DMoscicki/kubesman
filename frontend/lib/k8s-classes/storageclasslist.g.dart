...
part of 'storageclasslist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Storageclasslist _$StorageclasslistFromJson(Map<String, dynamic> json) =>
    Storageclasslist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) =>
              IoK8SApiStorageV1StorageClass.fromJson(e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$StorageclasslistKindEnumMap, json['kind']),
...
Map<String, dynamic> _$StorageclasslistToJson(Storageclasslist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$StorageclasslistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$StorageclasslistKindEnumMap = {
  StorageclasslistKind.STORAGE_CLASS_LIST: 'StorageClassList',
};

IoK8SApiStorageV1StorageClass _$IoK8SApiStorageV1StorageClassFromJson(
...
Map<String, dynamic> _$IoK8SApiStorageV1StorageClassToJson(
        IoK8SApiStorageV1StorageClass instance) =>
    <String, dynamic>{
...
const _$ItemKindEnumMap = {
  ItemKind.STORAGE_CLASS: 'StorageClass',
};
