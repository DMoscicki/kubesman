...
part 'storageospersistentvolumesource_v1.g.dart';


///Represents a StorageOS persistent volume resource.
@JsonSerializable()
class StorageospersistentvolumesourceV1 {
    ...
    StorageospersistentvolumesourceV1({
        this.fsType,
        this.readOnly,
        this.secretRef,
        this.volumeName,
    ...
    factory StorageospersistentvolumesourceV1.fromJson(Map<String, dynamic> json) => _$StorageospersistentvolumesourceV1FromJson(json);

    Map<String, dynamic> toJson() => _$StorageospersistentvolumesourceV1ToJson(this);
}
