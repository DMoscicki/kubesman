...
part 'storageversion_apiserverinternal_v1_alpha1.g.dart';


///Storage version of a specific resource.
@JsonSerializable()
class StorageversionApiserverinternalV1Alpha1 {
    ...
    StorageversionApiserverinternalV1Alpha1({
        this.apiVersion,
        this.kind,
        this.metadata,
        required this.spec,
    ...
    factory StorageversionApiserverinternalV1Alpha1.fromJson(Map<String, dynamic> json) => _$StorageversionApiserverinternalV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionApiserverinternalV1Alpha1ToJson(this);
}
...
final kindValues = EnumValues({
    "StorageVersion": Kind.STORAGE_VERSION
});
