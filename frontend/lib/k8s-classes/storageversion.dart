...
class Storageversion {
    ...
    factory Storageversion.fromJson(Map<String, dynamic> json) => _$StorageversionFromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionToJson(this);
}
