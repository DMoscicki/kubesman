...
part 'storageversionlist_apiserverinternal_v1_alpha1.g.dart';


///A list of StorageVersions.
@JsonSerializable()
class StorageversionlistApiserverinternalV1Alpha1 {
    ...
    @JsonKey(name: "kind")
    StorageversionlistApiserverinternalV1Alpha1Kind? kind;
    ...
    StorageversionlistApiserverinternalV1Alpha1({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory StorageversionlistApiserverinternalV1Alpha1.fromJson(Map<String, dynamic> json) => _$StorageversionlistApiserverinternalV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionlistApiserverinternalV1Alpha1ToJson(this);
}
...
class IoK8SApiApiserverinternalV1Alpha1StorageVersion {
    ...
    ///API server instances report the version they can decode and the version they encode
    ...
    factory IoK8SApiApiserverinternalV1Alpha1StorageVersion.fromJson(Map<String, dynamic> json) => _$IoK8SApiApiserverinternalV1Alpha1StorageVersionFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiApiserverinternalV1Alpha1StorageVersionToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
    @JsonValue("StorageVersion")
    STORAGE_VERSION
}

final itemKindValues = EnumValues({
    "StorageVersion": ItemKind.STORAGE_VERSION
});
...
class IoK8SApiApiserverinternalV1Alpha1StorageVersionStatus {
    ...
    factory IoK8SApiApiserverinternalV1Alpha1StorageVersionStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiApiserverinternalV1Alpha1StorageVersionStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiApiserverinternalV1Alpha1StorageVersionStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StorageversionlistApiserverinternalV1Alpha1Kind {
    @JsonValue("StorageVersionList")
    STORAGE_VERSION_LIST
}

final storageversionlistApiserverinternalV1Alpha1KindValues = EnumValues({
    "StorageVersionList": StorageversionlistApiserverinternalV1Alpha1Kind.STORAGE_VERSION_LIST
});
