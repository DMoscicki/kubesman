...
part 'storageversionlist.g.dart';
...
class Storageversionlist {
    ...
    factory Storageversionlist.fromJson(Map<String, dynamic> json) => _$StorageversionlistFromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StorageversionlistKind {
    @JsonValue("StorageVersionList")
    STORAGE_VERSION_LIST
}

final storageversionlistKindValues = EnumValues({
    "StorageVersionList": StorageversionlistKind.STORAGE_VERSION_LIST
});
