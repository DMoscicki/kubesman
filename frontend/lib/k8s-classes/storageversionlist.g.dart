...
part of 'storageversionlist.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Storageversionlist _$StorageversionlistFromJson(Map<String, dynamic> json) =>
    Storageversionlist(
      apiVersion: json['apiVersion'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => IoK8SApiApiserverinternalV1Alpha1StorageVersion.fromJson(
              e as Map<String, dynamic>))
          .toList(),
      kind: $enumDecodeNullable(_$StorageversionlistKindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$StorageversionlistToJson(Storageversionlist instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'items': instance.items,
      'kind': _$StorageversionlistKindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$StorageversionlistKindEnumMap = {
  StorageversionlistKind.STORAGE_VERSION_LIST: 'StorageVersionList',
};

IoK8SApiApiserverinternalV1Alpha1StorageVersion
    _$IoK8SApiApiserverinternalV1Alpha1StorageVersionFromJson(
...
Map<String, dynamic> _$IoK8SApiApiserverinternalV1Alpha1StorageVersionToJson(
        IoK8SApiApiserverinternalV1Alpha1StorageVersion instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
...
const _$ItemKindEnumMap = {
  ItemKind.STORAGE_VERSION: 'StorageVersion',
};
