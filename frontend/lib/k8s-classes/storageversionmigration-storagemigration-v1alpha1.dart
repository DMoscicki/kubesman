...
part 'storageversionmigration_storagemigration_v1_alpha1.g.dart';


///StorageVersionMigration represents a migration of stored data to the latest storage
///version.
@JsonSerializable()
class StorageversionmigrationStoragemigrationV1Alpha1 {
    ...
    StorageversionmigrationStoragemigrationV1Alpha1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.spec,
    ...
    factory StorageversionmigrationStoragemigrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$StorageversionmigrationStoragemigrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionmigrationStoragemigrationV1Alpha1ToJson(this);
}
...
final kindValues = EnumValues({
    "StorageVersionMigration": Kind.STORAGE_VERSION_MIGRATION
});
