...
part 'storageversionmigration.g.dart';
...
class Storageversionmigration {
    ...
    factory Storageversionmigration.fromJson(Map<String, dynamic> json) => _$StorageversionmigrationFromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionmigrationToJson(this);
}
