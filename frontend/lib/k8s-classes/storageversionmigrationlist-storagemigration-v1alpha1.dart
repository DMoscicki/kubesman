...
part 'storageversionmigrationlist_storagemigration_v1_alpha1.g.dart';


///StorageVersionMigrationList is a collection of storage version migrations.
@JsonSerializable()
class StorageversionmigrationlistStoragemigrationV1Alpha1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiStoragemigrationV1Alpha1StorageVersionMigration>? items;
    ...
    @JsonKey(name: "kind")
    StorageversionmigrationlistStoragemigrationV1Alpha1Kind? kind;
    ...
    factory StorageversionmigrationlistStoragemigrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$StorageversionmigrationlistStoragemigrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionmigrationlistStoragemigrationV1Alpha1ToJson(this);
}
...
///StorageVersionMigration represents a migration of stored data to the latest storage
///version.
@JsonSerializable()
class IoK8SApiStoragemigrationV1Alpha1StorageVersionMigration {
    ...
    @JsonKey(name: "spec")
    IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationSpec? spec;
    
    ///Status of the migration.
    @JsonKey(name: "status")
    IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationStatus? status;
    ...
    factory IoK8SApiStoragemigrationV1Alpha1StorageVersionMigration.fromJson(Map<String, dynamic> json) => _$IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
    @JsonValue("StorageVersionMigration")
    STORAGE_VERSION_MIGRATION
}

final itemKindValues = EnumValues({
    "StorageVersionMigration": ItemKind.STORAGE_VERSION_MIGRATION
});
...
@JsonSerializable()
class IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationSpec {
    ...
    factory IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationSpecToJson(this);
}
...
@JsonSerializable()
class IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationStatus {
    ...
    factory IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStoragemigrationV1Alpha1StorageVersionMigrationStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StorageversionmigrationlistStoragemigrationV1Alpha1Kind {
    @JsonValue("StorageVersionMigrationList")
    STORAGE_VERSION_MIGRATION_LIST
}

final storageversionmigrationlistStoragemigrationV1Alpha1KindValues = EnumValues({
    "StorageVersionMigrationList": StorageversionmigrationlistStoragemigrationV1Alpha1Kind.STORAGE_VERSION_MIGRATION_LIST
});
