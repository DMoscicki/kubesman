...
part 'storageversionmigrationlist.g.dart';
...
class Storageversionmigrationlist {
    ...
    @JsonKey(name: "kind")
    StorageversionmigrationlistKind? kind;
    ...
    factory Storageversionmigrationlist.fromJson(Map<String, dynamic> json) => _$StorageversionmigrationlistFromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionmigrationlistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StorageversionmigrationlistKind {
    @JsonValue("StorageVersionMigrationList")
    STORAGE_VERSION_MIGRATION_LIST
}

final storageversionmigrationlistKindValues = EnumValues({
    "StorageVersionMigrationList": StorageversionmigrationlistKind.STORAGE_VERSION_MIGRATION_LIST
});
