...
part 'storageversionstatus.g.dart';
...
class Storageversionstatus {
    ...
    factory Storageversionstatus.fromJson(Map<String, dynamic> json) => _$StorageversionstatusFromJson(json);

    Map<String, dynamic> toJson() => _$StorageversionstatusToJson(this);
}
