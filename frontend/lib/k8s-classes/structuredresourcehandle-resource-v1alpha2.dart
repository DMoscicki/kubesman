...
part 'structuredresourcehandle_resource_v1_alpha2.g.dart';


///StructuredResourceHandle is the in-tree representation of the allocation result.
@JsonSerializable()
class StructuredresourcehandleResourceV1Alpha2 {
    ...
    StructuredresourcehandleResourceV1Alpha2({
        this.nodeName,
    ...
    factory StructuredresourcehandleResourceV1Alpha2.fromJson(Map<String, dynamic> json) => _$StructuredresourcehandleResourceV1Alpha2FromJson(json);

    Map<String, dynamic> toJson() => _$StructuredresourcehandleResourceV1Alpha2ToJson(this);
}
