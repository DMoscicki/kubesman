...
part 'subject_flowcontrol_v1.g.dart';
...
class SubjectFlowcontrolV1 {
    ...
    factory SubjectFlowcontrolV1.fromJson(Map<String, dynamic> json) => _$SubjectFlowcontrolV1FromJson(json);

    Map<String, dynamic> toJson() => _$SubjectFlowcontrolV1ToJson(this);
}
