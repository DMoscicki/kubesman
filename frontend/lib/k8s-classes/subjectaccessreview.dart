...
part 'subjectaccessreview.g.dart';
...
class Subjectaccessreview {
    ...
    factory Subjectaccessreview.fromJson(Map<String, dynamic> json) => _$SubjectaccessreviewFromJson(json);

    Map<String, dynamic> toJson() => _$SubjectaccessreviewToJson(this);
}
