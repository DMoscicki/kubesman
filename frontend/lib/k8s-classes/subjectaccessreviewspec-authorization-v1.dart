...
part 'subjectaccessreviewspec_authorization_v1.g.dart';
...
@JsonSerializable()
class SubjectaccessreviewspecAuthorizationV1 {
    ...
    SubjectaccessreviewspecAuthorizationV1({
        this.extra,
        this.groups,
    ...
    factory SubjectaccessreviewspecAuthorizationV1.fromJson(Map<String, dynamic> json) => _$SubjectaccessreviewspecAuthorizationV1FromJson(json);

    Map<String, dynamic> toJson() => _$SubjectaccessreviewspecAuthorizationV1ToJson(this);
}
