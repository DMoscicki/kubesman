...
part 'subjectrulesreviewstatus.g.dart';
...
class Subjectrulesreviewstatus {
    ...
    factory Subjectrulesreviewstatus.fromJson(Map<String, dynamic> json) => _$SubjectrulesreviewstatusFromJson(json);

    Map<String, dynamic> toJson() => _$SubjectrulesreviewstatusToJson(this);
}
