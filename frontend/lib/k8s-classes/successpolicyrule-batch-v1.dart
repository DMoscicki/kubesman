...
part 'successpolicyrule_batch_v1.g.dart';
...
@JsonSerializable()
class SuccesspolicyruleBatchV1 {
    ...
    SuccesspolicyruleBatchV1({
        this.succeededCount,
        this.succeededIndexes,
    });

    factory SuccesspolicyruleBatchV1.fromJson(Map<String, dynamic> json) => _$SuccesspolicyruleBatchV1FromJson(json);

    Map<String, dynamic> toJson() => _$SuccesspolicyruleBatchV1ToJson(this);
}
