...
part 'tokenrequest_authentication_v1.g.dart';


///TokenRequest requests a token for a given service account.
@JsonSerializable()
class TokenrequestAuthenticationV1 {
    ...
    factory TokenrequestAuthenticationV1.fromJson(Map<String, dynamic> json) => _$TokenrequestAuthenticationV1FromJson(json);

    Map<String, dynamic> toJson() => _$TokenrequestAuthenticationV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum Kind {
    @JsonValue("TokenRequest")
    TOKEN_REQUEST
}

final kindValues = EnumValues({
    "TokenRequest": Kind.TOKEN_REQUEST
});
...
class IoK8SApiAuthenticationV1TokenRequestSpec {
    ...
    factory IoK8SApiAuthenticationV1TokenRequestSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthenticationV1TokenRequestSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthenticationV1TokenRequestSpecToJson(this);
}
...
class IoK8SApiAuthenticationV1TokenRequestStatus {
    ...
    factory IoK8SApiAuthenticationV1TokenRequestStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthenticationV1TokenRequestStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthenticationV1TokenRequestStatusToJson(this);
}
