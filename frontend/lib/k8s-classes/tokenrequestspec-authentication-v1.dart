...
part 'tokenrequestspec_authentication_v1.g.dart';


///TokenRequestSpec contains client provided parameters of a token request.
@JsonSerializable()
class TokenrequestspecAuthenticationV1 {
    ...
    TokenrequestspecAuthenticationV1({
        required this.audiences,
        this.boundObjectRef,
        this.expirationSeconds,
    });

    factory TokenrequestspecAuthenticationV1.fromJson(Map<String, dynamic> json) => _$TokenrequestspecAuthenticationV1FromJson(json);

    Map<String, dynamic> toJson() => _$TokenrequestspecAuthenticationV1ToJson(this);
}
