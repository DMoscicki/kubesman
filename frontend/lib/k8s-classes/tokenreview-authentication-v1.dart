...
part 'tokenreview_authentication_v1.g.dart';
...
@JsonSerializable()
class TokenreviewAuthenticationV1 {
    ...
    factory TokenreviewAuthenticationV1.fromJson(Map<String, dynamic> json) => _$TokenreviewAuthenticationV1FromJson(json);

    Map<String, dynamic> toJson() => _$TokenreviewAuthenticationV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum Kind {
    @JsonValue("TokenReview")
    TOKEN_REVIEW
}

final kindValues = EnumValues({
    "TokenReview": Kind.TOKEN_REVIEW
});
...
class IoK8SApiAuthenticationV1TokenReviewSpec {
    ...
    factory IoK8SApiAuthenticationV1TokenReviewSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthenticationV1TokenReviewSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthenticationV1TokenReviewSpecToJson(this);
}
...
class IoK8SApiAuthenticationV1TokenReviewStatus {
    ...
    factory IoK8SApiAuthenticationV1TokenReviewStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAuthenticationV1TokenReviewStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAuthenticationV1TokenReviewStatusToJson(this);
}
