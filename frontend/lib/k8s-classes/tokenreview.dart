...
class Tokenreview {
    ...
    factory Tokenreview.fromJson(Map<String, dynamic> json) => _$TokenreviewFromJson(json);

    Map<String, dynamic> toJson() => _$TokenreviewToJson(this);
}
