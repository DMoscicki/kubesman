...
class Tokenreviewstatus {
    ...
    factory Tokenreviewstatus.fromJson(Map<String, dynamic> json) => _$TokenreviewstatusFromJson(json);

    Map<String, dynamic> toJson() => _$TokenreviewstatusToJson(this);
}
