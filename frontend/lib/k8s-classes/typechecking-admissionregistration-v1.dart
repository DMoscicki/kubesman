...
part 'typechecking_admissionregistration_v1.g.dart';


///TypeChecking contains results of type checking the expressions in the
///ValidatingAdmissionPolicy
@JsonSerializable()
class TypecheckingAdmissionregistrationV1 {
    
    ///The type checking warnings for each expression.
    @JsonKey(name: "expressionWarnings")
    List<IoK8SApiAdmissionregistrationV1ExpressionWarning>? expressionWarnings;

    TypecheckingAdmissionregistrationV1({
        this.expressionWarnings,
    });

    factory TypecheckingAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$TypecheckingAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$TypecheckingAdmissionregistrationV1ToJson(this);
}
