...
part 'typedobjectreference_v1.g.dart';

@JsonSerializable()
class TypedobjectreferenceV1 {
    ...
    factory TypedobjectreferenceV1.fromJson(Map<String, dynamic> json) => _$TypedobjectreferenceV1FromJson(json);

    Map<String, dynamic> toJson() => _$TypedobjectreferenceV1ToJson(this);
}
