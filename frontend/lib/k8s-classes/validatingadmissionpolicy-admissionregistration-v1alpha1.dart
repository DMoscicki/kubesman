...
part 'validatingadmissionpolicy_admissionregistration_v1_alpha1.g.dart';
...
@JsonSerializable()
class ValidatingadmissionpolicyAdmissionregistrationV1Alpha1 {
    ...
    ValidatingadmissionpolicyAdmissionregistrationV1Alpha1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.spec,
    ...
    factory ValidatingadmissionpolicyAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicyAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicyAdmissionregistrationV1Alpha1ToJson(this);
}
