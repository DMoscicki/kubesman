...
part 'validatingadmissionpolicy_admissionregistration_v1_beta1.g.dart';
...
@JsonSerializable()
class ValidatingadmissionpolicyAdmissionregistrationV1Beta1 {
    ...
    ValidatingadmissionpolicyAdmissionregistrationV1Beta1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.spec,
    ...
    factory ValidatingadmissionpolicyAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicyAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicyAdmissionregistrationV1Beta1ToJson(this);
}
