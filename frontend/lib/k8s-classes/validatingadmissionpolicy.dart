...
part 'validatingadmissionpolicy.g.dart';
...
class Validatingadmissionpolicy {
    ...
    factory Validatingadmissionpolicy.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicyFromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicyToJson(this);
}
