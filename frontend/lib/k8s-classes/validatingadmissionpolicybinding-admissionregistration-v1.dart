...
part 'validatingadmissionpolicybinding_admissionregistration_v1.g.dart';
...
@JsonSerializable()
class ValidatingadmissionpolicybindingAdmissionregistrationV1 {
    ...
    ValidatingadmissionpolicybindingAdmissionregistrationV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.spec,
    ...
    factory ValidatingadmissionpolicybindingAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindingAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindingAdmissionregistrationV1ToJson(this);
}
