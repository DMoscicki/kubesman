...
part 'validatingadmissionpolicybinding_admissionregistration_v1_alpha1.g.dart';
...
@JsonSerializable()
class ValidatingadmissionpolicybindingAdmissionregistrationV1Alpha1 {
    ...
    ValidatingadmissionpolicybindingAdmissionregistrationV1Alpha1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.spec,
    ...
    factory ValidatingadmissionpolicybindingAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindingAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindingAdmissionregistrationV1Alpha1ToJson(this);
}
