...
part 'validatingadmissionpolicybinding_admissionregistration_v1_beta1.g.dart';
...
@JsonSerializable()
class ValidatingadmissionpolicybindingAdmissionregistrationV1Beta1 {
    ...
    ValidatingadmissionpolicybindingAdmissionregistrationV1Beta1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.spec,
    ...
    factory ValidatingadmissionpolicybindingAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindingAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindingAdmissionregistrationV1Beta1ToJson(this);
}
