...
class ValidatingadmissionpolicybindinglistAdmissionregistrationV1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBinding>? items;
    ...
    factory ValidatingadmissionpolicybindinglistAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindinglistAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindinglistAdmissionregistrationV1ToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBinding {
    ...
    @JsonKey(name: "spec")
    IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingSpec? spec;
    ...
    factory IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBinding.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingSpec {
    ...
    IoK8SApiAdmissionregistrationV1MatchResources? matchResources;
    ...
    IoK8SApiAdmissionregistrationV1ParamRef? paramRef;
    ...
    factory IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingSpecToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1ParamRef {
    ...
    factory IoK8SApiAdmissionregistrationV1ParamRef.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1ParamRefFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1ParamRefToJson(this);
}
...
final validatingadmissionpolicybindinglistAdmissionregistrationV1KindValues = EnumValues({
    "ValidatingAdmissionPolicyBindingList": ValidatingadmissionpolicybindinglistAdmissionregistrationV1Kind.VALIDATING_ADMISSION_POLICY_BINDING_LIST
});
