...
part 'validatingadmissionpolicybindinglist_admissionregistration_v1_alpha1.g.dart';


///ValidatingAdmissionPolicyBindingList is a list of ValidatingAdmissionPolicyBinding.
@JsonSerializable()
class ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1 {
    ...
    @JsonKey(name: "kind")
    ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1Kind? kind;
    ...
    ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1({
        this.apiVersion,
        this.items,
        this.kind,
        this.metadata,
    ...
    factory ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1ToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBinding {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBinding.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBindingFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBindingToJson(this);
}
...
final itemKindValues = EnumValues({
    "ValidatingAdmissionPolicyBinding": ItemKind.VALIDATING_ADMISSION_POLICY_BINDING
});
...
class IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBindingSpec {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBindingSpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBindingSpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyBindingSpecToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1Alpha1ParamRef {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1ParamRef.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ParamRefFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ParamRefToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1Kind {
    @JsonValue("ValidatingAdmissionPolicyBindingList")
    VALIDATING_ADMISSION_POLICY_BINDING_LIST
}

final validatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1KindValues = EnumValues({
    "ValidatingAdmissionPolicyBindingList": ValidatingadmissionpolicybindinglistAdmissionregistrationV1Alpha1Kind.VALIDATING_ADMISSION_POLICY_BINDING_LIST
});
