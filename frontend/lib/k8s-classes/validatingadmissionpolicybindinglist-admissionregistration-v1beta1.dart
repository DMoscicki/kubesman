...
part 'validatingadmissionpolicybindinglist_admissionregistration_v1_beta1.g.dart';


///ValidatingAdmissionPolicyBindingList is a list of ValidatingAdmissionPolicyBinding.
@JsonSerializable()
class ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyBinding>? items;
    ...
    @JsonKey(name: "kind")
    ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1Kind? kind;
    ...
    ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1({
        this.apiVersion,
        this.items,
        this.kind,
        this.metadata,
    ...
    factory ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1ToJson(this);
}
...
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyBinding {
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyBinding.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyBindingFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyBindingToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1Kind {
    @JsonValue("ValidatingAdmissionPolicyBindingList")
    VALIDATING_ADMISSION_POLICY_BINDING_LIST
}

final validatingadmissionpolicybindinglistAdmissionregistrationV1Beta1KindValues = EnumValues({
    "ValidatingAdmissionPolicyBindingList": ValidatingadmissionpolicybindinglistAdmissionregistrationV1Beta1Kind.VALIDATING_ADMISSION_POLICY_BINDING_LIST
});
