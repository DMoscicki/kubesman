...
part 'validatingadmissionpolicybindinglist.g.dart';
...
class Validatingadmissionpolicybindinglist {
    ...
    @JsonKey(name: "kind")
    ValidatingadmissionpolicybindinglistKind? kind;
    ...
    factory Validatingadmissionpolicybindinglist.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindinglistFromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindinglistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ValidatingadmissionpolicybindinglistKind {
    @JsonValue("ValidatingAdmissionPolicyBindingList")
    VALIDATING_ADMISSION_POLICY_BINDING_LIST
}

final validatingadmissionpolicybindinglistKindValues = EnumValues({
    "ValidatingAdmissionPolicyBindingList": ValidatingadmissionpolicybindinglistKind.VALIDATING_ADMISSION_POLICY_BINDING_LIST
});
