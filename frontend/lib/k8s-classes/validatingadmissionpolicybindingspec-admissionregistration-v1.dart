...
part 'validatingadmissionpolicybindingspec_admissionregistration_v1.g.dart';


///ValidatingAdmissionPolicyBindingSpec is the specification of the
///ValidatingAdmissionPolicyBinding.
@JsonSerializable()
class ValidatingadmissionpolicybindingspecAdmissionregistrationV1 {
    ...
    ValidatingadmissionpolicybindingspecAdmissionregistrationV1({
        this.matchResources,
        this.paramRef,
        this.policyName,
    ...
    factory ValidatingadmissionpolicybindingspecAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindingspecAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindingspecAdmissionregistrationV1ToJson(this);
}
