...
part 'validatingadmissionpolicybindingspec_admissionregistration_v1_alpha1.g.dart';


///ValidatingAdmissionPolicyBindingSpec is the specification of the
///ValidatingAdmissionPolicyBinding.
@JsonSerializable()
class ValidatingadmissionpolicybindingspecAdmissionregistrationV1Alpha1 {
    ...
    ValidatingadmissionpolicybindingspecAdmissionregistrationV1Alpha1({
        this.matchResources,
        this.paramRef,
        this.policyName,
    ...
    factory ValidatingadmissionpolicybindingspecAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindingspecAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindingspecAdmissionregistrationV1Alpha1ToJson(this);
}
