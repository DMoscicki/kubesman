...
part 'validatingadmissionpolicybindingspec_admissionregistration_v1_beta1.g.dart';


///ValidatingAdmissionPolicyBindingSpec is the specification of the
///ValidatingAdmissionPolicyBinding.
@JsonSerializable()
class ValidatingadmissionpolicybindingspecAdmissionregistrationV1Beta1 {
    ...
    ValidatingadmissionpolicybindingspecAdmissionregistrationV1Beta1({
        this.matchResources,
        this.paramRef,
        this.policyName,
    ...
    factory ValidatingadmissionpolicybindingspecAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicybindingspecAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicybindingspecAdmissionregistrationV1Beta1ToJson(this);
}
