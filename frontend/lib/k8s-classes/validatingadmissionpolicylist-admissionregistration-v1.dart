...
class ValidatingadmissionpolicylistAdmissionregistrationV1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicy>? items;
    ...
    factory ValidatingadmissionpolicylistAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicylistAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicylistAdmissionregistrationV1ToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicy {
    ...
    factory IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicy.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1ValidatingAdmissionPolicyToJson(this);
}
...
final validatingadmissionpolicylistAdmissionregistrationV1KindValues = EnumValues({
    "ValidatingAdmissionPolicyList": ValidatingadmissionpolicylistAdmissionregistrationV1Kind.VALIDATING_ADMISSION_POLICY_LIST
});
