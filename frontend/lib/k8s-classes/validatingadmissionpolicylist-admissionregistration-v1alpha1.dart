...
part 'validatingadmissionpolicylist_admissionregistration_v1_alpha1.g.dart';


///ValidatingAdmissionPolicyList is a list of ValidatingAdmissionPolicy.
@JsonSerializable()
class ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1 {
    ...
    @JsonKey(name: "kind")
    ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1Kind? kind;
    ...
    ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1({
        this.apiVersion,
        this.items,
        this.kind,
        this.metadata,
    ...
    factory ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1ToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicy {
    ...
    @JsonKey(name: "status")
    IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyStatus? status;
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicy.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicySpec {
    ...
    List<IoK8SApiAdmissionregistrationV1Alpha1AuditAnnotation>? auditAnnotations;
    ...
    List<IoK8SApiAdmissionregistrationV1Alpha1MatchCondition>? matchConditions;
    ...
    List<IoK8SApiAdmissionregistrationV1Alpha1Variable>? variables;
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicySpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicySpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicySpecToJson(this);
}


///AuditAnnotation describes how to produce an audit annotation for an API request.
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Alpha1AuditAnnotation {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1AuditAnnotation.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1AuditAnnotationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1AuditAnnotationToJson(this);
}

@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Alpha1MatchCondition {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1MatchCondition.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1MatchConditionFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1MatchConditionToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1Alpha1MatchResources {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1MatchResources.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1MatchResourcesFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1MatchResourcesToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1Alpha1ParamKind {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1ParamKind.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ParamKindFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ParamKindToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1Alpha1Validation {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1Validation.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ValidationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ValidationToJson(this);
}


///Variable is the definition of a variable that is used for composition.
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Alpha1Variable {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1Variable.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1VariableFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1VariableToJson(this);
}
...
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyStatus {
    ...
    factory IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Alpha1ValidatingAdmissionPolicyStatusToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1Kind {
    @JsonValue("ValidatingAdmissionPolicyList")
    VALIDATING_ADMISSION_POLICY_LIST
}

final validatingadmissionpolicylistAdmissionregistrationV1Alpha1KindValues = EnumValues({
    "ValidatingAdmissionPolicyList": ValidatingadmissionpolicylistAdmissionregistrationV1Alpha1Kind.VALIDATING_ADMISSION_POLICY_LIST
});
