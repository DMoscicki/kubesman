...
part 'validatingadmissionpolicylist_admissionregistration_v1_beta1.g.dart';


///ValidatingAdmissionPolicyList is a list of ValidatingAdmissionPolicy.
@JsonSerializable()
class ValidatingadmissionpolicylistAdmissionregistrationV1Beta1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicy>? items;
    ...
    @JsonKey(name: "kind")
    ValidatingadmissionpolicylistAdmissionregistrationV1Beta1Kind? kind;
    ...
    ValidatingadmissionpolicylistAdmissionregistrationV1Beta1({
        this.apiVersion,
        this.items,
        this.kind,
        this.metadata,
    ...
    factory ValidatingadmissionpolicylistAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicylistAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicylistAdmissionregistrationV1Beta1ToJson(this);
}
...
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicy {
    ...
    @JsonKey(name: "spec")
    IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicySpec? spec;
    ...
    @JsonKey(name: "status")
    IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyStatus? status;
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicy.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyToJson(this);
}
...
///AdmissionPolicy.
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicySpec {
    ...
    List<IoK8SApiAdmissionregistrationV1Beta1AuditAnnotation>? auditAnnotations;
    ...
    List<IoK8SApiAdmissionregistrationV1Beta1MatchCondition>? matchConditions;
    ...
    IoK8SApiAdmissionregistrationV1Beta1MatchResources? matchConstraints;
    ...
    IoK8SApiAdmissionregistrationV1Beta1ParamKind? paramKind;
    ...
    List<IoK8SApiAdmissionregistrationV1Beta1Validation>? validations;
    ...
    List<IoK8SApiAdmissionregistrationV1Beta1Variable>? variables;
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicySpec.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicySpecFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicySpecToJson(this);
}


///AuditAnnotation describes how to produce an audit annotation for an API request.
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1AuditAnnotation {
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1AuditAnnotation.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1AuditAnnotationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1AuditAnnotationToJson(this);
}


///MatchCondition represents a condition which must be fulfilled for a request to be sent to
///a webhook.
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1MatchCondition {
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1MatchCondition.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1MatchConditionFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1MatchConditionToJson(this);
}
...
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1ParamKind {
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1ParamKind.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1ParamKindFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1ParamKindToJson(this);
}


///Validation specifies the CEL expression which is used to apply the validation.
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1Validation {
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1Validation.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1ValidationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1ValidationToJson(this);
}
...
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1Variable {
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1Variable.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1VariableFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1VariableToJson(this);
}
...
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyStatus {
    ...
    IoK8SApiAdmissionregistrationV1Beta1TypeChecking? typeChecking;
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyStatus.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyStatusFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1ValidatingAdmissionPolicyStatusToJson(this);
}
...
///ValidatingAdmissionPolicy
@JsonSerializable()
class IoK8SApiAdmissionregistrationV1Beta1TypeChecking {
    ...
    factory IoK8SApiAdmissionregistrationV1Beta1TypeChecking.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1Beta1TypeCheckingFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1Beta1TypeCheckingToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ValidatingadmissionpolicylistAdmissionregistrationV1Beta1Kind {
    @JsonValue("ValidatingAdmissionPolicyList")
    VALIDATING_ADMISSION_POLICY_LIST
}

final validatingadmissionpolicylistAdmissionregistrationV1Beta1KindValues = EnumValues({
    "ValidatingAdmissionPolicyList": ValidatingadmissionpolicylistAdmissionregistrationV1Beta1Kind.VALIDATING_ADMISSION_POLICY_LIST
});
