...
part 'validatingadmissionpolicylist.g.dart';
...
class Validatingadmissionpolicylist {
    ...
    @JsonKey(name: "kind")
    ValidatingadmissionpolicylistKind? kind;
    ...
    factory Validatingadmissionpolicylist.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicylistFromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicylistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ValidatingadmissionpolicylistKind {
    @JsonValue("ValidatingAdmissionPolicyList")
    VALIDATING_ADMISSION_POLICY_LIST
}

final validatingadmissionpolicylistKindValues = EnumValues({
    "ValidatingAdmissionPolicyList": ValidatingadmissionpolicylistKind.VALIDATING_ADMISSION_POLICY_LIST
});
