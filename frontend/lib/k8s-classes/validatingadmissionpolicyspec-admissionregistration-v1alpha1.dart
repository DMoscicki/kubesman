...
part 'validatingadmissionpolicyspec_admissionregistration_v1_alpha1.g.dart';


///ValidatingAdmissionPolicySpec is the specification of the desired behavior of the
///AdmissionPolicy.
@JsonSerializable()
class ValidatingadmissionpolicyspecAdmissionregistrationV1Alpha1 {
    ...
    ValidatingadmissionpolicyspecAdmissionregistrationV1Alpha1({
    ...
    factory ValidatingadmissionpolicyspecAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicyspecAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicyspecAdmissionregistrationV1Alpha1ToJson(this);
}
