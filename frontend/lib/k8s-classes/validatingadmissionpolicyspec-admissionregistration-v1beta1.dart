...
part 'validatingadmissionpolicyspec_admissionregistration_v1_beta1.g.dart';


///ValidatingAdmissionPolicySpec is the specification of the desired behavior of the
///AdmissionPolicy.
@JsonSerializable()
class ValidatingadmissionpolicyspecAdmissionregistrationV1Beta1 {
    ...
    ValidatingadmissionpolicyspecAdmissionregistrationV1Beta1({
    ...
    factory ValidatingadmissionpolicyspecAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicyspecAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicyspecAdmissionregistrationV1Beta1ToJson(this);
}
