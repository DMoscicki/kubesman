...
part 'validatingadmissionpolicyspec.g.dart';
...
class Validatingadmissionpolicyspec {
    ...
    factory Validatingadmissionpolicyspec.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicyspecFromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicyspecToJson(this);
}
