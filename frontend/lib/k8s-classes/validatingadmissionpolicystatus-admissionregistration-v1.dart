...
part 'validatingadmissionpolicystatus_admissionregistration_v1.g.dart';


///ValidatingAdmissionPolicyStatus represents the status of an admission validation policy.
@JsonSerializable()
class ValidatingadmissionpolicystatusAdmissionregistrationV1 {
    ...
    ValidatingadmissionpolicystatusAdmissionregistrationV1({
        this.conditions,
        this.observedGeneration,
        this.typeChecking,
    });

    factory ValidatingadmissionpolicystatusAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicystatusAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicystatusAdmissionregistrationV1ToJson(this);
}
