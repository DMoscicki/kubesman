...
part 'validatingadmissionpolicystatus_admissionregistration_v1_beta1.g.dart';


///ValidatingAdmissionPolicyStatus represents the status of an admission validation policy.
@JsonSerializable()
class ValidatingadmissionpolicystatusAdmissionregistrationV1Beta1 {
    ...
    ValidatingadmissionpolicystatusAdmissionregistrationV1Beta1({
        this.conditions,
        this.observedGeneration,
        this.typeChecking,
    });

    factory ValidatingadmissionpolicystatusAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicystatusAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicystatusAdmissionregistrationV1Beta1ToJson(this);
}
