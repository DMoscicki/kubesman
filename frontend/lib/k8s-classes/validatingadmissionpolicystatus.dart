...
part 'validatingadmissionpolicystatus.g.dart';
...
class Validatingadmissionpolicystatus {
    ...
    factory Validatingadmissionpolicystatus.fromJson(Map<String, dynamic> json) => _$ValidatingadmissionpolicystatusFromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingadmissionpolicystatusToJson(this);
}
