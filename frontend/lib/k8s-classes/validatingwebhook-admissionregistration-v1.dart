...
part 'validatingwebhook_admissionregistration_v1.g.dart';


///ValidatingWebhook describes an admission webhook and the resources and operations it
///applies to.
@JsonSerializable()
class ValidatingwebhookAdmissionregistrationV1 {
    ...
    ValidatingwebhookAdmissionregistrationV1({
    ...
    factory ValidatingwebhookAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingwebhookAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingwebhookAdmissionregistrationV1ToJson(this);
}
