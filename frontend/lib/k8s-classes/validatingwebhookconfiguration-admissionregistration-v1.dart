...
part 'validatingwebhookconfiguration_admissionregistration_v1.g.dart';
...
@JsonSerializable()
class ValidatingwebhookconfigurationAdmissionregistrationV1 {
    ...
    ValidatingwebhookconfigurationAdmissionregistrationV1({
        this.apiVersion,
        this.kind,
        this.metadata,
        this.webhooks,
    ...
    factory ValidatingwebhookconfigurationAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingwebhookconfigurationAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingwebhookconfigurationAdmissionregistrationV1ToJson(this);
}
