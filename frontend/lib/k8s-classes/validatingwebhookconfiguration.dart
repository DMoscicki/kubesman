...
part 'validatingwebhookconfiguration.g.dart';
...
class Validatingwebhookconfiguration {
    ...
    factory Validatingwebhookconfiguration.fromJson(Map<String, dynamic> json) => _$ValidatingwebhookconfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingwebhookconfigurationToJson(this);
}
