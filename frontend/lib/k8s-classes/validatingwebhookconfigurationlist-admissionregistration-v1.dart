...
class ValidatingwebhookconfigurationlistAdmissionregistrationV1 {
    ...
    factory ValidatingwebhookconfigurationlistAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidatingwebhookconfigurationlistAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingwebhookconfigurationlistAdmissionregistrationV1ToJson(this);
}
...
final validatingwebhookconfigurationlistAdmissionregistrationV1KindValues = EnumValues({
    "ValidatingWebhookConfigurationList": ValidatingwebhookconfigurationlistAdmissionregistrationV1Kind.VALIDATING_WEBHOOK_CONFIGURATION_LIST
});
