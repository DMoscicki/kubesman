...
part 'validatingwebhookconfigurationlist.g.dart';
...
class Validatingwebhookconfigurationlist {
    ...
    @JsonKey(name: "kind")
    ValidatingwebhookconfigurationlistKind? kind;
    ...
    factory Validatingwebhookconfigurationlist.fromJson(Map<String, dynamic> json) => _$ValidatingwebhookconfigurationlistFromJson(json);

    Map<String, dynamic> toJson() => _$ValidatingwebhookconfigurationlistToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1ValidatingWebhookConfiguration {
    ...
    factory IoK8SApiAdmissionregistrationV1ValidatingWebhookConfiguration.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1ValidatingWebhookConfigurationFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1ValidatingWebhookConfigurationToJson(this);
}
...
class IoK8SApiAdmissionregistrationV1ValidatingWebhook {
    ...
    factory IoK8SApiAdmissionregistrationV1ValidatingWebhook.fromJson(Map<String, dynamic> json) => _$IoK8SApiAdmissionregistrationV1ValidatingWebhookFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiAdmissionregistrationV1ValidatingWebhookToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ValidatingwebhookconfigurationlistKind {
    @JsonValue("ValidatingWebhookConfigurationList")
    VALIDATING_WEBHOOK_CONFIGURATION_LIST
}

final validatingwebhookconfigurationlistKindValues = EnumValues({
    "ValidatingWebhookConfigurationList": ValidatingwebhookconfigurationlistKind.VALIDATING_WEBHOOK_CONFIGURATION_LIST
});
