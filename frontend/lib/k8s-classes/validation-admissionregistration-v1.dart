...
part 'validation_admissionregistration_v1.g.dart';


///Validation specifies the CEL expression which is used to apply the validation.
@JsonSerializable()
class ValidationAdmissionregistrationV1 {
    ...
    ValidationAdmissionregistrationV1({
    ...
    factory ValidationAdmissionregistrationV1.fromJson(Map<String, dynamic> json) => _$ValidationAdmissionregistrationV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidationAdmissionregistrationV1ToJson(this);
}
