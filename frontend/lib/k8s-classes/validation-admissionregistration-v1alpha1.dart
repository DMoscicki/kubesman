...
part 'validation_admissionregistration_v1_alpha1.g.dart';


///Validation specifies the CEL expression which is used to apply the validation.
@JsonSerializable()
class ValidationAdmissionregistrationV1Alpha1 {
    ...
    ValidationAdmissionregistrationV1Alpha1({
    ...
    factory ValidationAdmissionregistrationV1Alpha1.fromJson(Map<String, dynamic> json) => _$ValidationAdmissionregistrationV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidationAdmissionregistrationV1Alpha1ToJson(this);
}
