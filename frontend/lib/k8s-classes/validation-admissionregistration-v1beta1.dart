...
part 'validation_admissionregistration_v1_beta1.g.dart';


///Validation specifies the CEL expression which is used to apply the validation.
@JsonSerializable()
class ValidationAdmissionregistrationV1Beta1 {
    ...
    ValidationAdmissionregistrationV1Beta1({
    ...
    factory ValidationAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$ValidationAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidationAdmissionregistrationV1Beta1ToJson(this);
}
