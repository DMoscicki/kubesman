...
part 'validationrule_apiextensions_v1.g.dart';


///ValidationRule describes a validation rule written in the CEL expression language.
@JsonSerializable()
class ValidationruleApiextensionsV1 {
    ...
    factory ValidationruleApiextensionsV1.fromJson(Map<String, dynamic> json) => _$ValidationruleApiextensionsV1FromJson(json);

    Map<String, dynamic> toJson() => _$ValidationruleApiextensionsV1ToJson(this);
}
