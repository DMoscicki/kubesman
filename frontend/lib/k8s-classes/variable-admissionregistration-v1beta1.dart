...
class VariableAdmissionregistrationV1Beta1 {
    ...
    VariableAdmissionregistrationV1Beta1({
        required this.expression,
        required this.name,
    });

    factory VariableAdmissionregistrationV1Beta1.fromJson(Map<String, dynamic> json) => _$VariableAdmissionregistrationV1Beta1FromJson(json);

    Map<String, dynamic> toJson() => _$VariableAdmissionregistrationV1Beta1ToJson(this);
}
