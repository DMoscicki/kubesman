...
part 'volumeattachment_storage_v1.g.dart';
...
@JsonSerializable()
class VolumeattachmentStorageV1 {
    ...
    factory VolumeattachmentStorageV1.fromJson(Map<String, dynamic> json) => _$VolumeattachmentStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattachmentStorageV1ToJson(this);
}
...
final kindValues = EnumValues({
    "VolumeAttachment": Kind.VOLUME_ATTACHMENT
});
