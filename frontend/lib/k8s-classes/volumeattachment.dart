...
class Volumeattachment {
    ...
    factory Volumeattachment.fromJson(Map<String, dynamic> json) => _$VolumeattachmentFromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattachmentToJson(this);
}
