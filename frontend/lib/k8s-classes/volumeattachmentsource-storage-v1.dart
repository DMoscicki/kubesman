...
part 'volumeattachmentsource_storage_v1.g.dart';
...
@JsonSerializable()
class VolumeattachmentsourceStorageV1 {
    ...
    VolumeattachmentsourceStorageV1({
        this.inlineVolumeSpec,
        this.persistentVolumeName,
    });

    factory VolumeattachmentsourceStorageV1.fromJson(Map<String, dynamic> json) => _$VolumeattachmentsourceStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattachmentsourceStorageV1ToJson(this);
}
