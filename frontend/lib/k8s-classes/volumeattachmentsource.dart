...
part 'volumeattachmentsource.g.dart';
...
class Volumeattachmentsource {
    ...
    factory Volumeattachmentsource.fromJson(Map<String, dynamic> json) => _$VolumeattachmentsourceFromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattachmentsourceToJson(this);
}
