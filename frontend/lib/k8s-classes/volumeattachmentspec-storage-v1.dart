...
part 'volumeattachmentspec_storage_v1.g.dart';


///VolumeAttachmentSpec is the specification of a VolumeAttachment request.
@JsonSerializable()
class VolumeattachmentspecStorageV1 {
    ...
    VolumeattachmentspecStorageV1({
        required this.attacher,
        required this.nodeName,
        required this.source,
    });

    factory VolumeattachmentspecStorageV1.fromJson(Map<String, dynamic> json) => _$VolumeattachmentspecStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattachmentspecStorageV1ToJson(this);
}
