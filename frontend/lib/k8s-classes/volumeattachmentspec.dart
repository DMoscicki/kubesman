...
part 'volumeattachmentspec.g.dart';
...
class Volumeattachmentspec {
    ...
    factory Volumeattachmentspec.fromJson(Map<String, dynamic> json) => _$VolumeattachmentspecFromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattachmentspecToJson(this);
}
