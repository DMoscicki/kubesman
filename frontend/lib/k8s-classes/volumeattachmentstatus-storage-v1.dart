...
part 'volumeattachmentstatus_storage_v1.g.dart';


///VolumeAttachmentStatus is the status of a VolumeAttachment request.
@JsonSerializable()
class VolumeattachmentstatusStorageV1 {
    ...
    VolumeattachmentstatusStorageV1({
    ...
    factory VolumeattachmentstatusStorageV1.fromJson(Map<String, dynamic> json) => _$VolumeattachmentstatusStorageV1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattachmentstatusStorageV1ToJson(this);
}
