...
part 'volumeattributesclass_storage_v1_alpha1.g.dart';
...
@JsonSerializable()
class VolumeattributesclassStorageV1Alpha1 {
    ...
    VolumeattributesclassStorageV1Alpha1({
        this.apiVersion,
    ...
    factory VolumeattributesclassStorageV1Alpha1.fromJson(Map<String, dynamic> json) => _$VolumeattributesclassStorageV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattributesclassStorageV1Alpha1ToJson(this);
}
...
final kindValues = EnumValues({
    "VolumeAttributesClass": Kind.VOLUME_ATTRIBUTES_CLASS
});
