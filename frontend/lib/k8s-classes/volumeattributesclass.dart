...
part 'volumeattributesclass.g.dart';
...
class Volumeattributesclass {
    ...
    factory Volumeattributesclass.fromJson(Map<String, dynamic> json) => _$VolumeattributesclassFromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattributesclassToJson(this);
}
