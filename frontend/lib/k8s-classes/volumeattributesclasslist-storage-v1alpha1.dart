...
part 'volumeattributesclasslist_storage_v1_alpha1.g.dart';


///VolumeAttributesClassList is a collection of VolumeAttributesClass objects.
@JsonSerializable()
class VolumeattributesclasslistStorageV1Alpha1 {
    ...
    @JsonKey(name: "items")
    List<IoK8SApiStorageV1Alpha1VolumeAttributesClass>? items;
    ...
    @JsonKey(name: "kind")
    VolumeattributesclasslistStorageV1Alpha1Kind? kind;
    ...
    VolumeattributesclasslistStorageV1Alpha1({
        this.apiVersion,
        required this.items,
        this.kind,
        this.metadata,
    ...
    factory VolumeattributesclasslistStorageV1Alpha1.fromJson(Map<String, dynamic> json) => _$VolumeattributesclasslistStorageV1Alpha1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattributesclasslistStorageV1Alpha1ToJson(this);
}
...
///VolumeAttributesClass represents a specification of mutable volume attributes defined by
///the CSI driver. The class can be specified during dynamic provisioning of
///PersistentVolumeClaims, and changed in the PersistentVolumeClaim spec after provisioning.
@JsonSerializable()
class IoK8SApiStorageV1Alpha1VolumeAttributesClass {
    ...
    factory IoK8SApiStorageV1Alpha1VolumeAttributesClass.fromJson(Map<String, dynamic> json) => _$IoK8SApiStorageV1Alpha1VolumeAttributesClassFromJson(json);

    Map<String, dynamic> toJson() => _$IoK8SApiStorageV1Alpha1VolumeAttributesClassToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum VolumeattributesclasslistStorageV1Alpha1Kind {
    @JsonValue("VolumeAttributesClassList")
    VOLUME_ATTRIBUTES_CLASS_LIST
}

final volumeattributesclasslistStorageV1Alpha1KindValues = EnumValues({
    "VolumeAttributesClassList": VolumeattributesclasslistStorageV1Alpha1Kind.VOLUME_ATTRIBUTES_CLASS_LIST
});
