...
part 'volumeattributesclasslist.g.dart';
...
class Volumeattributesclasslist {
    ...
    @JsonKey(name: "kind")
    VolumeattributesclasslistKind? kind;
    ...
    factory Volumeattributesclasslist.fromJson(Map<String, dynamic> json) => _$VolumeattributesclasslistFromJson(json);

    Map<String, dynamic> toJson() => _$VolumeattributesclasslistToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum VolumeattributesclasslistKind {
    @JsonValue("VolumeAttributesClassList")
    VOLUME_ATTRIBUTES_CLASS_LIST
}

final volumeattributesclasslistKindValues = EnumValues({
    "VolumeAttributesClassList": VolumeattributesclasslistKind.VOLUME_ATTRIBUTES_CLASS_LIST
});
