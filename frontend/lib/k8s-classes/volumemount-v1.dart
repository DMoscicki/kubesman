...
class VolumemountV1 {
    ...
    factory VolumemountV1.fromJson(Map<String, dynamic> json) => _$VolumemountV1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumemountV1ToJson(this);
}
