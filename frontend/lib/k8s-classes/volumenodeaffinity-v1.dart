...
class VolumenodeaffinityV1 {
    ...
    factory VolumenodeaffinityV1.fromJson(Map<String, dynamic> json) => _$VolumenodeaffinityV1FromJson(json);

    Map<String, dynamic> toJson() => _$VolumenodeaffinityV1ToJson(this);
}
