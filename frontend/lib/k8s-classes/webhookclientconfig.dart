...
part 'webhookclientconfig.g.dart';
...
class Webhookclientconfig {
    ...
    factory Webhookclientconfig.fromJson(Map<String, dynamic> json) => _$WebhookclientconfigFromJson(json);

    Map<String, dynamic> toJson() => _$WebhookclientconfigToJson(this);
}
