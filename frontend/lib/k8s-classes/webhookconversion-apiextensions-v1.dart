...
part 'webhookconversion_apiextensions_v1.g.dart';


///WebhookConversion describes how to call a conversion webhook
@JsonSerializable()
class WebhookconversionApiextensionsV1 {
    ...
    WebhookconversionApiextensionsV1({
        this.clientConfig,
        required this.conversionReviewVersions,
    });

    factory WebhookconversionApiextensionsV1.fromJson(Map<String, dynamic> json) => _$WebhookconversionApiextensionsV1FromJson(json);

    Map<String, dynamic> toJson() => _$WebhookconversionApiextensionsV1ToJson(this);
}
