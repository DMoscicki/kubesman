...
class WeightedpodaffinitytermV1 {
    ...
    factory WeightedpodaffinitytermV1.fromJson(Map<String, dynamic> json) => _$WeightedpodaffinitytermV1FromJson(json);

    Map<String, dynamic> toJson() => _$WeightedpodaffinitytermV1ToJson(this);
}
