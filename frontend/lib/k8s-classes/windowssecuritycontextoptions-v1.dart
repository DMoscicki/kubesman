...
part 'windowssecuritycontextoptions_v1.g.dart';


///WindowsSecurityContextOptions contain Windows-specific options and credentials.
@JsonSerializable()
class WindowssecuritycontextoptionsV1 {
    ...
    factory WindowssecuritycontextoptionsV1.fromJson(Map<String, dynamic> json) => _$WindowssecuritycontextoptionsV1FromJson(json);

    Map<String, dynamic> toJson() => _$WindowssecuritycontextoptionsV1ToJson(this);
}
