...
const AdmissionResponse$json = {
  ...
  '2': [
    ...
    {'1': 'auditAnnotations', '3': 6, '4': 3, '5': 11, '6': '.api.admission.v1.AdmissionResponse.AuditAnnotationsEntry', '10': 'auditAnnotations'},
...
final $typed_data.Uint8List admissionResponseDescriptor = $convert.base64Decode(
    ...
    'lSCXBhdGNoVHlwZRJlChBhdWRpdEFubm90YXRpb25zGAYgAygLMjkuYXBpLmFkbWlzc2lvbi52'
    'MS5BZG1pc3Npb25SZXNwb25zZS5BdWRpdEFubm90YXRpb25zRW50cnlSEGF1ZGl0QW5ub3RhdG'
    'lvbnMSGgoId2FybmluZ3MYByADKAlSCHdhcm5pbmdzGkMKFUF1ZGl0QW5ub3RhdGlvbnNFbnRy'
...
const AdmissionReview$json = {
  '1': 'AdmissionReview',
  '2': [
    {'1': 'request', '3': 1, '4': 1, '5': 11, '6': '.api.admission.v1.AdmissionRequest', '10': 'request'},
    {'1': 'response', '3': 2, '4': 1, '5': 11, '6': '.api.admission.v1.AdmissionResponse', '10': 'response'},
  ],
};
...
final $typed_data.Uint8List admissionReviewDescriptor = $convert.base64Decode(
    'Cg9BZG1pc3Npb25SZXZpZXcSPAoHcmVxdWVzdBgBIAEoCzIiLmFwaS5hZG1pc3Npb24udjEuQW'
    'RtaXNzaW9uUmVxdWVzdFIHcmVxdWVzdBI/CghyZXNwb25zZRgCIAEoCzIjLmFwaS5hZG1pc3Np'
    'b24udjEuQWRtaXNzaW9uUmVzcG9uc2VSCHJlc3BvbnNl');
