...
class AdmissionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdmissionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.admission.v1beta1'), createEmptyInstance: create)
...
class AdmissionResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdmissionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.admission.v1beta1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'uid')
    ...
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'auditAnnotations', protoName: 'auditAnnotations', entryClassName: 'AdmissionResponse.AuditAnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('api.admission.v1beta1'))
...
class AdmissionReview extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdmissionReview', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.admission.v1beta1'), createEmptyInstance: create)
