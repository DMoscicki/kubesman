...
class APIGroupDiscovery extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'APIGroupDiscovery', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.apidiscovery.v2'), createEmptyInstance: create)
...
class APIGroupDiscoveryList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'APIGroupDiscoveryList', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.apidiscovery.v2'), createEmptyInstance: create)
...
class APIResourceDiscovery extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'APIResourceDiscovery', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.apidiscovery.v2'), createEmptyInstance: create)
...
class APISubresourceDiscovery extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'APISubresourceDiscovery', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.apidiscovery.v2'), createEmptyInstance: create)
...
class APIVersionDiscovery extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'APIVersionDiscovery', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.apidiscovery.v2'), createEmptyInstance: create)
