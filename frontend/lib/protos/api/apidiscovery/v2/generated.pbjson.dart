...
//  source: api/apidiscovery/v2/generated.proto
//
// @dart = 2.12
...
const APIGroupDiscovery$json = {
  ...
  '2': [
    ...
    {'1': 'versions', '3': 2, '4': 3, '5': 11, '6': '.api.apidiscovery.v2.APIVersionDiscovery', '10': 'versions'},
  ],
};
...
final $typed_data.Uint8List aPIGroupDiscoveryDescriptor = $convert.base64Decode(
    ...
    'cuYXBpcy5tZXRhLnYxLk9iamVjdE1ldGFSCG1ldGFkYXRhEkQKCHZlcnNpb25zGAIgAygLMigu'
    'YXBpLmFwaWRpc2NvdmVyeS52Mi5BUElWZXJzaW9uRGlzY292ZXJ5Ugh2ZXJzaW9ucw==');
...
const APIGroupDiscoveryList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.apidiscovery.v2.APIGroupDiscovery', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List aPIGroupDiscoveryListDescriptor = $convert.base64Decode(
    ...
    'kucGtnLmFwaXMubWV0YS52MS5MaXN0TWV0YVIIbWV0YWRhdGESPAoFaXRlbXMYAiADKAsyJi5h'
    'cGkuYXBpZGlzY292ZXJ5LnYyLkFQSUdyb3VwRGlzY292ZXJ5UgVpdGVtcw==');
...
const APIResourceDiscovery$json = {
  ...
  '2': [
    ...
    {'1': 'subresources', '3': 8, '4': 3, '5': 11, '6': '.api.apidiscovery.v2.APISubresourceDiscovery', '10': 'subresources'},
  ],
};
...
final $typed_data.Uint8List aPIResourceDiscoveryDescriptor = $convert.base64Decode(
    ...
    'NhdGVnb3JpZXMSUAoMc3VicmVzb3VyY2VzGAggAygLMiwuYXBpLmFwaWRpc2NvdmVyeS52Mi5B'
    'UElTdWJyZXNvdXJjZURpc2NvdmVyeVIMc3VicmVzb3VyY2Vz');
...
const APIVersionDiscovery$json = {
  ...
  '2': [
    ...
    {'1': 'resources', '3': 2, '4': 3, '5': 11, '6': '.api.apidiscovery.v2.APIResourceDiscovery', '10': 'resources'},
...
final $typed_data.Uint8List aPIVersionDiscoveryDescriptor = $convert.base64Decode(
    'ChNBUElWZXJzaW9uRGlzY292ZXJ5EhgKB3ZlcnNpb24YASABKAlSB3ZlcnNpb24SRwoJcmVzb3'
    'VyY2VzGAIgAygLMikuYXBpLmFwaWRpc2NvdmVyeS52Mi5BUElSZXNvdXJjZURpc2NvdmVyeVIJ'
    'cmVzb3VyY2VzEhwKCWZyZXNobmVzcxgDIAEoCVIJZnJlc2huZXNz');
