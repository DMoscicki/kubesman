...
const ControllerRevisionList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.apps.v1.ControllerRevision', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List controllerRevisionListDescriptor = $convert.base64Decode(
    ...
    'YXBpLmFwcHMudjEuQ29udHJvbGxlclJldmlzaW9uUgVpdGVtcw==');
...
const DaemonSet$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.apps.v1.DaemonSetSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.apps.v1.DaemonSetStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List daemonSetDescriptor = $convert.base64Decode(
    ...
    'V0YS52MS5PYmplY3RNZXRhUghtZXRhZGF0YRIuCgRzcGVjGAIgASgLMhouYXBpLmFwcHMudjEu'
    'RGFlbW9uU2V0U3BlY1IEc3BlYxI0CgZzdGF0dXMYAyABKAsyHC5hcGkuYXBwcy52MS5EYWVtb2'
    '5TZXRTdGF0dXNSBnN0YXR1cw==');
...
const DaemonSetList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.apps.v1.DaemonSet', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List daemonSetListDescriptor = $convert.base64Decode(
    ...
    'lzLm1ldGEudjEuTGlzdE1ldGFSCG1ldGFkYXRhEiwKBWl0ZW1zGAIgAygLMhYuYXBpLmFwcHMu'
    'djEuRGFlbW9uU2V0UgVpdGVtcw==');
...
const DaemonSetSpec$json = {
  ...
  '2': [
    ...
    {'1': 'updateStrategy', '3': 3, '4': 1, '5': 11, '6': '.api.apps.v1.DaemonSetUpdateStrategy', '10': 'updateStrategy'},
...
final $typed_data.Uint8List daemonSetSpecDescriptor = $convert.base64Decode(
    ...
    'cGkuY29yZS52MS5Qb2RUZW1wbGF0ZVNwZWNSCHRlbXBsYXRlEkwKDnVwZGF0ZVN0cmF0ZWd5GA'
    'MgASgLMiQuYXBpLmFwcHMudjEuRGFlbW9uU2V0VXBkYXRlU3RyYXRlZ3lSDnVwZGF0ZVN0cmF0'
    'ZWd5EigKD21pblJlYWR5U2Vjb25kcxgEIAEoBVIPbWluUmVhZHlTZWNvbmRzEjIKFHJldmlzaW'
    '9uSGlzdG9yeUxpbWl0GAYgASgFUhRyZXZpc2lvbkhpc3RvcnlMaW1pdA==');
...
const DaemonSetStatus$json = {
  ...
  '2': [
    ...
    {'1': 'conditions', '3': 10, '4': 3, '5': 11, '6': '.api.apps.v1.DaemonSetCondition', '10': 'conditions'},
  ],
};
...
final $typed_data.Uint8List daemonSetStatusDescriptor = $convert.base64Decode(
    ...
    'PwoKY29uZGl0aW9ucxgKIAMoCzIfLmFwaS5hcHBzLnYxLkRhZW1vblNldENvbmRpdGlvblIKY2'
    '9uZGl0aW9ucw==');
...
const DaemonSetUpdateStrategy$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 9, '10': 'type'},
    {'1': 'rollingUpdate', '3': 2, '4': 1, '5': 11, '6': '.api.apps.v1.RollingUpdateDaemonSet', '10': 'rollingUpdate'},
  ],
};
...
final $typed_data.Uint8List daemonSetUpdateStrategyDescriptor = $convert.base64Decode(
    'ChdEYWVtb25TZXRVcGRhdGVTdHJhdGVneRISCgR0eXBlGAEgASgJUgR0eXBlEkkKDXJvbGxpbm'
    'dVcGRhdGUYAiABKAsyIy5hcGkuYXBwcy52MS5Sb2xsaW5nVXBkYXRlRGFlbW9uU2V0Ug1yb2xs'
    'aW5nVXBkYXRl');
...
const Deployment$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.apps.v1.DeploymentSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.apps.v1.DeploymentStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List deploymentDescriptor = $convert.base64Decode(
    ...
    '1ldGEudjEuT2JqZWN0TWV0YVIIbWV0YWRhdGESLwoEc3BlYxgCIAEoCzIbLmFwaS5hcHBzLnYx'
    'LkRlcGxveW1lbnRTcGVjUgRzcGVjEjUKBnN0YXR1cxgDIAEoCzIdLmFwaS5hcHBzLnYxLkRlcG'
    'xveW1lbnRTdGF0dXNSBnN0YXR1cw==');
...
const DeploymentList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.apps.v1.Deployment', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List deploymentListDescriptor = $convert.base64Decode(
    ...
    'Bpcy5tZXRhLnYxLkxpc3RNZXRhUghtZXRhZGF0YRItCgVpdGVtcxgCIAMoCzIXLmFwaS5hcHBz'
    'LnYxLkRlcGxveW1lbnRSBWl0ZW1z');
...
const DeploymentSpec$json = {
  ...
  '2': [
    ...
    {'1': 'strategy', '3': 4, '4': 1, '5': 11, '6': '.api.apps.v1.DeploymentStrategy', '10': 'strategy'},
...
final $typed_data.Uint8List deploymentSpecDescriptor = $convert.base64Decode(
    ...
    'IIdGVtcGxhdGUSOwoIc3RyYXRlZ3kYBCABKAsyHy5hcGkuYXBwcy52MS5EZXBsb3ltZW50U3Ry'
    'YXRlZ3lSCHN0cmF0ZWd5EigKD21pblJlYWR5U2Vjb25kcxgFIAEoBVIPbWluUmVhZHlTZWNvbm'
    'RzEjIKFHJldmlzaW9uSGlzdG9yeUxpbWl0GAYgASgFUhRyZXZpc2lvbkhpc3RvcnlMaW1pdBIW'
    'CgZwYXVzZWQYByABKAhSBnBhdXNlZBI4Chdwcm9ncmVzc0RlYWRsaW5lU2Vjb25kcxgJIAEoBV'
    'IXcHJvZ3Jlc3NEZWFkbGluZVNlY29uZHM=');
...
const DeploymentStatus$json = {
  ...
  '2': [
    ...
    {'1': 'conditions', '3': 6, '4': 3, '5': 11, '6': '.api.apps.v1.DeploymentCondition', '10': 'conditions'},
...
final $typed_data.Uint8List deploymentStatusDescriptor = $convert.base64Decode(
    ...
    'ChN1bmF2YWlsYWJsZVJlcGxpY2FzGAUgASgFUhN1bmF2YWlsYWJsZVJlcGxpY2FzEkAKCmNvbm'
    'RpdGlvbnMYBiADKAsyIC5hcGkuYXBwcy52MS5EZXBsb3ltZW50Q29uZGl0aW9uUgpjb25kaXRp'
    'b25zEiYKDmNvbGxpc2lvbkNvdW50GAggASgFUg5jb2xsaXNpb25Db3VudA==');
...
const DeploymentStrategy$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 9, '10': 'type'},
    {'1': 'rollingUpdate', '3': 2, '4': 1, '5': 11, '6': '.api.apps.v1.RollingUpdateDeployment', '10': 'rollingUpdate'},
  ],
};
...
final $typed_data.Uint8List deploymentStrategyDescriptor = $convert.base64Decode(
    'ChJEZXBsb3ltZW50U3RyYXRlZ3kSEgoEdHlwZRgBIAEoCVIEdHlwZRJKCg1yb2xsaW5nVXBkYX'
    'RlGAIgASgLMiQuYXBpLmFwcHMudjEuUm9sbGluZ1VwZGF0ZURlcGxveW1lbnRSDXJvbGxpbmdV'
    'cGRhdGU=');
...
const ReplicaSet$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.apps.v1.ReplicaSetSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.apps.v1.ReplicaSetStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List replicaSetDescriptor = $convert.base64Decode(
    ...
    '1ldGEudjEuT2JqZWN0TWV0YVIIbWV0YWRhdGESLwoEc3BlYxgCIAEoCzIbLmFwaS5hcHBzLnYx'
    'LlJlcGxpY2FTZXRTcGVjUgRzcGVjEjUKBnN0YXR1cxgDIAEoCzIdLmFwaS5hcHBzLnYxLlJlcG'
    'xpY2FTZXRTdGF0dXNSBnN0YXR1cw==');
...
const ReplicaSetList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.apps.v1.ReplicaSet', '10': 'items'},
  ],
};
...
const ReplicaSetStatus$json = {
  ...
  '2': [
    ...
    {'1': 'conditions', '3': 6, '4': 3, '5': 11, '6': '.api.apps.v1.ReplicaSetCondition', '10': 'conditions'},
  ],
};
...
final $typed_data.Uint8List replicaSetStatusDescriptor = $convert.base64Decode(
    ...
    'bmVyYXRpb24SQAoKY29uZGl0aW9ucxgGIAMoCzIgLmFwaS5hcHBzLnYxLlJlcGxpY2FTZXRDb2'
    '5kaXRpb25SCmNvbmRpdGlvbnM=');
...
const StatefulSet$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.apps.v1.StatefulSetSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.apps.v1.StatefulSetStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List statefulSetDescriptor = $convert.base64Decode(
    ...
    '5tZXRhLnYxLk9iamVjdE1ldGFSCG1ldGFkYXRhEjAKBHNwZWMYAiABKAsyHC5hcGkuYXBwcy52'
    'MS5TdGF0ZWZ1bFNldFNwZWNSBHNwZWMSNgoGc3RhdHVzGAMgASgLMh4uYXBpLmFwcHMudjEuU3'
    'RhdGVmdWxTZXRTdGF0dXNSBnN0YXR1cw==');
...
const StatefulSetList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.apps.v1.StatefulSet', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List statefulSetListDescriptor = $convert.base64Decode(
    ...
    'FwaXMubWV0YS52MS5MaXN0TWV0YVIIbWV0YWRhdGESLgoFaXRlbXMYAiADKAsyGC5hcGkuYXBw'
    'cy52MS5TdGF0ZWZ1bFNldFIFaXRlbXM=');
...
const StatefulSetSpec$json = {
  ...
  '2': [
    ...
    {'1': 'updateStrategy', '3': 7, '4': 1, '5': 11, '6': '.api.apps.v1.StatefulSetUpdateStrategy', '10': 'updateStrategy'},
    {'1': 'revisionHistoryLimit', '3': 8, '4': 1, '5': 5, '10': 'revisionHistoryLimit'},
    {'1': 'minReadySeconds', '3': 9, '4': 1, '5': 5, '10': 'minReadySeconds'},
    {'1': 'persistentVolumeClaimRetentionPolicy', '3': 10, '4': 1, '5': 11, '6': '.api.apps.v1.StatefulSetPersistentVolumeClaimRetentionPolicy', '10': 'persistentVolumeClaimRetentionPolicy'},
    {'1': 'ordinals', '3': 11, '4': 1, '5': 11, '6': '.api.apps.v1.StatefulSetOrdinals', '10': 'ordinals'},
  ],
};
...
final $typed_data.Uint8List statefulSetSpecDescriptor = $convert.base64Decode(
    ...
    'TWFuYWdlbWVudFBvbGljeRJOCg51cGRhdGVTdHJhdGVneRgHIAEoCzImLmFwaS5hcHBzLnYxLl'
    'N0YXRlZnVsU2V0VXBkYXRlU3RyYXRlZ3lSDnVwZGF0ZVN0cmF0ZWd5EjIKFHJldmlzaW9uSGlz'
    'dG9yeUxpbWl0GAggASgFUhRyZXZpc2lvbkhpc3RvcnlMaW1pdBIoCg9taW5SZWFkeVNlY29uZH'
    'MYCSABKAVSD21pblJlYWR5U2Vjb25kcxKQAQokcGVyc2lzdGVudFZvbHVtZUNsYWltUmV0ZW50'
    'aW9uUG9saWN5GAogASgLMjwuYXBpLmFwcHMudjEuU3RhdGVmdWxTZXRQZXJzaXN0ZW50Vm9sdW'
    '1lQ2xhaW1SZXRlbnRpb25Qb2xpY3lSJHBlcnNpc3RlbnRWb2x1bWVDbGFpbVJldGVudGlvblBv'
    'bGljeRI8CghvcmRpbmFscxgLIAEoCzIgLmFwaS5hcHBzLnYxLlN0YXRlZnVsU2V0T3JkaW5hbH'
    'NSCG9yZGluYWxz');
...
const StatefulSetStatus$json = {
  ...
  '2': [
    ...
    {'1': 'collisionCount', '3': 9, '4': 1, '5': 5, '10': 'collisionCount'},
    {'1': 'conditions', '3': 10, '4': 3, '5': 11, '6': '.api.apps.v1.StatefulSetCondition', '10': 'conditions'},
...
final $typed_data.Uint8List statefulSetStatusDescriptor = $convert.base64Decode(
    ...
    'bkNvdW50EkEKCmNvbmRpdGlvbnMYCiADKAsyIS5hcGkuYXBwcy52MS5TdGF0ZWZ1bFNldENvbm'
    'RpdGlvblIKY29uZGl0aW9ucxIsChFhdmFpbGFibGVSZXBsaWNhcxgLIAEoBVIRYXZhaWxhYmxl'
    'UmVwbGljYXM=');
...
const StatefulSetUpdateStrategy$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 9, '10': 'type'},
    {'1': 'rollingUpdate', '3': 2, '4': 1, '5': 11, '6': '.api.apps.v1.RollingUpdateStatefulSetStrategy', '10': 'rollingUpdate'},
  ],
};
...
final $typed_data.Uint8List statefulSetUpdateStrategyDescriptor = $convert.base64Decode(
    'ChlTdGF0ZWZ1bFNldFVwZGF0ZVN0cmF0ZWd5EhIKBHR5cGUYASABKAlSBHR5cGUSUwoNcm9sbG'
    'luZ1VwZGF0ZRgCIAEoCzItLmFwaS5hcHBzLnYxLlJvbGxpbmdVcGRhdGVTdGF0ZWZ1bFNldFN0'
    'cmF0ZWd5Ug1yb2xsaW5nVXBkYXRl');
