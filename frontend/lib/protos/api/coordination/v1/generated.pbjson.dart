...
const Lease$json = {
  ...
  '2': [
    ...
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.coordination.v1.LeaseSpec', '10': 'spec'},
  ],
};
...
final $typed_data.Uint8List leaseDescriptor = $convert.base64Decode(
    ...
    'YxLk9iamVjdE1ldGFSCG1ldGFkYXRhEjIKBHNwZWMYAiABKAsyHi5hcGkuY29vcmRpbmF0aW9u'
    'LnYxLkxlYXNlU3BlY1IEc3BlYw==');
...
const LeaseList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.coordination.v1.Lease', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List leaseListDescriptor = $convert.base64Decode(
    ...
    'V0YS52MS5MaXN0TWV0YVIIbWV0YWRhdGESMAoFaXRlbXMYAiADKAsyGi5hcGkuY29vcmRpbmF0'
    'aW9uLnYxLkxlYXNlUgVpdGVtcw==');
