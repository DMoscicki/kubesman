...
class Lease extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Lease', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.coordination.v1beta1'), createEmptyInstance: create)
...
class LeaseList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LeaseList', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.coordination.v1beta1'), createEmptyInstance: create)
...
class LeaseSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LeaseSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.coordination.v1beta1'), createEmptyInstance: create)
