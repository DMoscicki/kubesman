...
class Event extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Event', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.events.v1beta1'), createEmptyInstance: create)
...
class EventList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventList', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.events.v1beta1'), createEmptyInstance: create)
...
class EventSeries extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventSeries', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.events.v1beta1'), createEmptyInstance: create)
