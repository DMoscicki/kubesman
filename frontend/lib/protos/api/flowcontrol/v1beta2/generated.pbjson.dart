...
const FlowSchema$json = {
  ...
  '2': [
    ...
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.FlowSchemaSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.FlowSchemaStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List flowSchemaDescriptor = $convert.base64Decode(
    ...
    'dHJvbC52MWJldGEyLkZsb3dTY2hlbWFTcGVjUgRzcGVjEkEKBnN0YXR1cxgDIAEoCzIpLmFwaS'
    '5mbG93Y29udHJvbC52MWJldGEyLkZsb3dTY2hlbWFTdGF0dXNSBnN0YXR1cw==');
...
const FlowSchemaList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.FlowSchema', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List flowSchemaListDescriptor = $convert.base64Decode(
    ...
    'Y29udHJvbC52MWJldGEyLkZsb3dTY2hlbWFSBWl0ZW1z');

@$core.Deprecated('Use flowSchemaSpecDescriptor instead')
const FlowSchemaSpec$json = {
  '1': 'FlowSchemaSpec',
  '2': [
    {'1': 'priorityLevelConfiguration', '3': 1, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.PriorityLevelConfigurationReference', '10': 'priorityLevelConfiguration'},
    {'1': 'matchingPrecedence', '3': 2, '4': 1, '5': 5, '10': 'matchingPrecedence'},
    {'1': 'distinguisherMethod', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.FlowDistinguisherMethod', '10': 'distinguisherMethod'},
    {'1': 'rules', '3': 4, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.PolicyRulesWithSubjects', '10': 'rules'},
  ],
};
...
final $typed_data.Uint8List flowSchemaSpecDescriptor = $convert.base64Decode(
    ...
    'FwaS5mbG93Y29udHJvbC52MWJldGEyLlByaW9yaXR5TGV2ZWxDb25maWd1cmF0aW9uUmVmZXJl'
    ...
    'YXBpLmZsb3djb250cm9sLnYxYmV0YTIuRmxvd0Rpc3Rpbmd1aXNoZXJNZXRob2RSE2Rpc3Rpbm'
    'd1aXNoZXJNZXRob2QSRgoFcnVsZXMYBCADKAsyMC5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMi5Q'
...
const FlowSchemaStatus$json = {
  '1': 'FlowSchemaStatus',
  '2': [
    {'1': 'conditions', '3': 1, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.FlowSchemaCondition', '10': 'conditions'},
  ],
};
...
final $typed_data.Uint8List flowSchemaStatusDescriptor = $convert.base64Decode(
    ...
    'wudjFiZXRhMi5GbG93U2NoZW1hQ29uZGl0aW9uUgpjb25kaXRpb25z');
...
const LimitResponse$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 9, '10': 'type'},
    {'1': 'queuing', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.QueuingConfiguration', '10': 'queuing'},
  ],
};
...
final $typed_data.Uint8List limitResponseDescriptor = $convert.base64Decode(
    ...
    'FwaS5mbG93Y29udHJvbC52MWJldGEyLlF1ZXVpbmdDb25maWd1cmF0aW9uUgdxdWV1aW5n');
...
const LimitedPriorityLevelConfiguration$json = {
  ...
  '2': [
    ...
    {'1': 'limitResponse', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.LimitResponse', '10': 'limitResponse'},
...
final $typed_data.Uint8List limitedPriorityLevelConfigurationDescriptor = $convert.base64Decode(
    ...
    'ZRgCIAEoCzImLmFwaS5mbG93Y29udHJvbC52MWJldGEyLkxpbWl0UmVzcG9uc2VSDWxpbWl0Um'
...
const PolicyRulesWithSubjects$json = {
  ...
  '2': [
    {'1': 'subjects', '3': 1, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.Subject', '10': 'subjects'},
    {'1': 'resourceRules', '3': 2, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.ResourcePolicyRule', '10': 'resourceRules'},
    {'1': 'nonResourceRules', '3': 3, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.NonResourcePolicyRule', '10': 'nonResourceRules'},
  ],
};
...
final $typed_data.Uint8List policyRulesWithSubjectsDescriptor = $convert.base64Decode(
    ...
    '9udHJvbC52MWJldGEyLlN1YmplY3RSCHN1YmplY3RzElEKDXJlc291cmNlUnVsZXMYAiADKAsy'
    'Ky5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMi5SZXNvdXJjZVBvbGljeVJ1bGVSDXJlc291cmNlUn'
    'VsZXMSWgoQbm9uUmVzb3VyY2VSdWxlcxgDIAMoCzIuLmFwaS5mbG93Y29udHJvbC52MWJldGEy'
...
const PriorityLevelConfiguration$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.PriorityLevelConfigurationSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.PriorityLevelConfigurationStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationDescriptor = $convert.base64Decode(
    ...
    'KAsyNy5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMi5Qcmlvcml0eUxldmVsQ29uZmlndXJhdGlvbl'
    'NwZWNSBHNwZWMSUQoGc3RhdHVzGAMgASgLMjkuYXBpLmZsb3djb250cm9sLnYxYmV0YTIuUHJp'
...
const PriorityLevelConfigurationList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.PriorityLevelConfiguration', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationListDescriptor = $convert.base64Decode(
    ...
    'AiADKAsyMy5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMi5Qcmlvcml0eUxldmVsQ29uZmlndXJhdG'
    'lvblIFaXRlbXM=');
...
const PriorityLevelConfigurationSpec$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 9, '10': 'type'},
    {'1': 'limited', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.LimitedPriorityLevelConfiguration', '10': 'limited'},
    {'1': 'exempt', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.ExemptPriorityLevelConfiguration', '10': 'exempt'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationSpecDescriptor = $convert.base64Decode(
    ...
    'dsaW1pdGVkGAIgASgLMjouYXBpLmZsb3djb250cm9sLnYxYmV0YTIuTGltaXRlZFByaW9yaXR5'
    'TGV2ZWxDb25maWd1cmF0aW9uUgdsaW1pdGVkElEKBmV4ZW1wdBgDIAEoCzI5LmFwaS5mbG93Y2'
    '9udHJvbC52MWJldGEyLkV4ZW1wdFByaW9yaXR5TGV2ZWxDb25maWd1cmF0aW9uUgZleGVtcHQ=');
...
const PriorityLevelConfigurationStatus$json = {
  ...
  '2': [
    {'1': 'conditions', '3': 1, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta2.PriorityLevelConfigurationCondition', '10': 'conditions'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationStatusDescriptor = $convert.base64Decode(
    ...
    'wuYXBpLmZsb3djb250cm9sLnYxYmV0YTIuUHJpb3JpdHlMZXZlbENvbmZpZ3VyYXRpb25Db25k'
...
const Subject$json = {
  ...
  '2': [
    ...
    {'1': 'user', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.UserSubject', '10': 'user'},
    {'1': 'group', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.GroupSubject', '10': 'group'},
    {'1': 'serviceAccount', '3': 4, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta2.ServiceAccountSubject', '10': 'serviceAccount'},
  ],
};
...
final $typed_data.Uint8List subjectDescriptor = $convert.base64Decode(
    ...
    '9udHJvbC52MWJldGEyLlVzZXJTdWJqZWN0UgR1c2VyEjsKBWdyb3VwGAMgASgLMiUuYXBpLmZs'
    'b3djb250cm9sLnYxYmV0YTIuR3JvdXBTdWJqZWN0UgVncm91cBJWCg5zZXJ2aWNlQWNjb3VudB'
    'gEIAEoCzIuLmFwaS5mbG93Y29udHJvbC52MWJldGEyLlNlcnZpY2VBY2NvdW50U3ViamVjdFIO'
    'c2VydmljZUFjY291bnQ=');
