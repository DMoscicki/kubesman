...
const FlowSchema$json = {
  ...
  '2': [
    ...
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.FlowSchemaSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.FlowSchemaStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List flowSchemaDescriptor = $convert.base64Decode(
    ...
    'dHJvbC52MWJldGEzLkZsb3dTY2hlbWFTcGVjUgRzcGVjEkEKBnN0YXR1cxgDIAEoCzIpLmFwaS'
    '5mbG93Y29udHJvbC52MWJldGEzLkZsb3dTY2hlbWFTdGF0dXNSBnN0YXR1cw==');
...
const FlowSchemaList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.FlowSchema', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List flowSchemaListDescriptor = $convert.base64Decode(
    ...
    'Y29udHJvbC52MWJldGEzLkZsb3dTY2hlbWFSBWl0ZW1z');

@$core.Deprecated('Use flowSchemaSpecDescriptor instead')
const FlowSchemaSpec$json = {
  '1': 'FlowSchemaSpec',
  '2': [
    {'1': 'priorityLevelConfiguration', '3': 1, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.PriorityLevelConfigurationReference', '10': 'priorityLevelConfiguration'},
    {'1': 'matchingPrecedence', '3': 2, '4': 1, '5': 5, '10': 'matchingPrecedence'},
    {'1': 'distinguisherMethod', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.FlowDistinguisherMethod', '10': 'distinguisherMethod'},
    {'1': 'rules', '3': 4, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.PolicyRulesWithSubjects', '10': 'rules'},
  ],
};
...
final $typed_data.Uint8List flowSchemaSpecDescriptor = $convert.base64Decode(
    ...
    'FwaS5mbG93Y29udHJvbC52MWJldGEzLlByaW9yaXR5TGV2ZWxDb25maWd1cmF0aW9uUmVmZXJl'
    ...
    'YXBpLmZsb3djb250cm9sLnYxYmV0YTMuRmxvd0Rpc3Rpbmd1aXNoZXJNZXRob2RSE2Rpc3Rpbm'
    'd1aXNoZXJNZXRob2QSRgoFcnVsZXMYBCADKAsyMC5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMy5Q'
...
const FlowSchemaStatus$json = {
  '1': 'FlowSchemaStatus',
  '2': [
    {'1': 'conditions', '3': 1, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.FlowSchemaCondition', '10': 'conditions'},
  ],
};
...
final $typed_data.Uint8List flowSchemaStatusDescriptor = $convert.base64Decode(
    ...
    'wudjFiZXRhMy5GbG93U2NoZW1hQ29uZGl0aW9uUgpjb25kaXRpb25z');
...
const LimitResponse$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 9, '10': 'type'},
    {'1': 'queuing', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.QueuingConfiguration', '10': 'queuing'},
  ],
};
...
final $typed_data.Uint8List limitResponseDescriptor = $convert.base64Decode(
    ...
    'FwaS5mbG93Y29udHJvbC52MWJldGEzLlF1ZXVpbmdDb25maWd1cmF0aW9uUgdxdWV1aW5n');
...
const LimitedPriorityLevelConfiguration$json = {
  ...
  '2': [
    {'1': 'nominalConcurrencyShares', '3': 1, '4': 1, '5': 5, '10': 'nominalConcurrencyShares'},
    {'1': 'limitResponse', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.LimitResponse', '10': 'limitResponse'},
...
final $typed_data.Uint8List limitedPriorityLevelConfigurationDescriptor = $convert.base64Decode(
    ...
    'N5U2hhcmVzGAEgASgFUhhub21pbmFsQ29uY3VycmVuY3lTaGFyZXMSTAoNbGltaXRSZXNwb25z'
    'ZRgCIAEoCzImLmFwaS5mbG93Y29udHJvbC52MWJldGEzLkxpbWl0UmVzcG9uc2VSDWxpbWl0Um'
...
const PolicyRulesWithSubjects$json = {
  ...
  '2': [
    {'1': 'subjects', '3': 1, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.Subject', '10': 'subjects'},
    {'1': 'resourceRules', '3': 2, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.ResourcePolicyRule', '10': 'resourceRules'},
    {'1': 'nonResourceRules', '3': 3, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.NonResourcePolicyRule', '10': 'nonResourceRules'},
  ],
};
...
final $typed_data.Uint8List policyRulesWithSubjectsDescriptor = $convert.base64Decode(
    ...
    '9udHJvbC52MWJldGEzLlN1YmplY3RSCHN1YmplY3RzElEKDXJlc291cmNlUnVsZXMYAiADKAsy'
    'Ky5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMy5SZXNvdXJjZVBvbGljeVJ1bGVSDXJlc291cmNlUn'
    'VsZXMSWgoQbm9uUmVzb3VyY2VSdWxlcxgDIAMoCzIuLmFwaS5mbG93Y29udHJvbC52MWJldGEz'
...
const PriorityLevelConfiguration$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.PriorityLevelConfigurationSpec', '10': 'spec'},
    {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.PriorityLevelConfigurationStatus', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationDescriptor = $convert.base64Decode(
    ...
    'KAsyNy5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMy5Qcmlvcml0eUxldmVsQ29uZmlndXJhdGlvbl'
    'NwZWNSBHNwZWMSUQoGc3RhdHVzGAMgASgLMjkuYXBpLmZsb3djb250cm9sLnYxYmV0YTMuUHJp'
...
const PriorityLevelConfigurationList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.PriorityLevelConfiguration', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationListDescriptor = $convert.base64Decode(
    ...
    'AiADKAsyMy5hcGkuZmxvd2NvbnRyb2wudjFiZXRhMy5Qcmlvcml0eUxldmVsQ29uZmlndXJhdG'
    'lvblIFaXRlbXM=');
...
const PriorityLevelConfigurationSpec$json = {
  ...
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 9, '10': 'type'},
    {'1': 'limited', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.LimitedPriorityLevelConfiguration', '10': 'limited'},
    {'1': 'exempt', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.ExemptPriorityLevelConfiguration', '10': 'exempt'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationSpecDescriptor = $convert.base64Decode(
    ...
    'dsaW1pdGVkGAIgASgLMjouYXBpLmZsb3djb250cm9sLnYxYmV0YTMuTGltaXRlZFByaW9yaXR5'
    'TGV2ZWxDb25maWd1cmF0aW9uUgdsaW1pdGVkElEKBmV4ZW1wdBgDIAEoCzI5LmFwaS5mbG93Y2'
    '9udHJvbC52MWJldGEzLkV4ZW1wdFByaW9yaXR5TGV2ZWxDb25maWd1cmF0aW9uUgZleGVtcHQ=');
...
const PriorityLevelConfigurationStatus$json = {
  ...
  '2': [
    {'1': 'conditions', '3': 1, '4': 3, '5': 11, '6': '.api.flowcontrol.v1beta3.PriorityLevelConfigurationCondition', '10': 'conditions'},
  ],
};
...
final $typed_data.Uint8List priorityLevelConfigurationStatusDescriptor = $convert.base64Decode(
    ...
    'wuYXBpLmZsb3djb250cm9sLnYxYmV0YTMuUHJpb3JpdHlMZXZlbENvbmZpZ3VyYXRpb25Db25k'
...
const Subject$json = {
  ...
  '2': [
    ...
    {'1': 'user', '3': 2, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.UserSubject', '10': 'user'},
    {'1': 'group', '3': 3, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.GroupSubject', '10': 'group'},
    {'1': 'serviceAccount', '3': 4, '4': 1, '5': 11, '6': '.api.flowcontrol.v1beta3.ServiceAccountSubject', '10': 'serviceAccount'},
  ],
};
...
final $typed_data.Uint8List subjectDescriptor = $convert.base64Decode(
    ...
    '9udHJvbC52MWJldGEzLlVzZXJTdWJqZWN0UgR1c2VyEjsKBWdyb3VwGAMgASgLMiUuYXBpLmZs'
    'b3djb250cm9sLnYxYmV0YTMuR3JvdXBTdWJqZWN0UgVncm91cBJWCg5zZXJ2aWNlQWNjb3VudB'
    'gEIAEoCzIuLmFwaS5mbG93Y29udHJvbC52MWJldGEzLlNlcnZpY2VBY2NvdW50U3ViamVjdFIO'
    'c2VydmljZUFjY291bnQ=');
