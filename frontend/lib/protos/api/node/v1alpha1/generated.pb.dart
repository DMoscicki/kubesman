...
class Overhead extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Overhead', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1alpha1'), createEmptyInstance: create)
    ..m<$core.String, $0.Quantity>(1, _omitFieldNames ? '' : 'podFixed', protoName: 'podFixed', entryClassName: 'Overhead.PodFixedEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.Quantity.create, valueDefaultOrMaker: $0.Quantity.getDefault, packageName: const $pb.PackageName('api.node.v1alpha1'))
...
class RuntimeClass extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeClass', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1alpha1'), createEmptyInstance: create)
    ..aOM<$1.ObjectMeta>(1, _omitFieldNames ? '' : 'metadata', subBuilder: $1.ObjectMeta.create)
    ..aOM<RuntimeClassSpec>(2, _omitFieldNames ? '' : 'spec', subBuilder: RuntimeClassSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  RuntimeClassSpec get spec => $_getN(1);
  @$pb.TagNumber(2)
  set spec(RuntimeClassSpec v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSpec() => $_has(1);
  @$pb.TagNumber(2)
  void clearSpec() => clearField(2);
  @$pb.TagNumber(2)
  RuntimeClassSpec ensureSpec() => $_ensure(1);
}
...
class RuntimeClassList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeClassList', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1alpha1'), createEmptyInstance: create)
...
class RuntimeClassSpec extends $pb.GeneratedMessage {
  factory RuntimeClassSpec({
    $core.String? runtimeHandler,
    Overhead? overhead,
    Scheduling? scheduling,
  }) {
    final $result = create();
    if (runtimeHandler != null) {
      $result.runtimeHandler = runtimeHandler;
    }
    if (overhead != null) {
  ...
  RuntimeClassSpec._() : super();
  factory RuntimeClassSpec.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RuntimeClassSpec.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeClassSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'runtimeHandler', protoName: 'runtimeHandler')
    ..aOM<Overhead>(2, _omitFieldNames ? '' : 'overhead', subBuilder: Overhead.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RuntimeClassSpec clone() => RuntimeClassSpec()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeClassSpec copyWith(void Function(RuntimeClassSpec) updates) => super.copyWith((message) => updates(message as RuntimeClassSpec)) as RuntimeClassSpec;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RuntimeClassSpec create() => RuntimeClassSpec._();
  RuntimeClassSpec createEmptyInstance() => create();
  static $pb.PbList<RuntimeClassSpec> createRepeated() => $pb.PbList<RuntimeClassSpec>();
  @$core.pragma('dart2js:noInline')
  static RuntimeClassSpec getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RuntimeClassSpec>(create);
  static RuntimeClassSpec? _defaultInstance;
  ...
  @$pb.TagNumber(1)
  $core.String get runtimeHandler => $_getSZ(0);
  @$pb.TagNumber(1)
  set runtimeHandler($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasRuntimeHandler() => $_has(0);
  @$pb.TagNumber(1)
  void clearRuntimeHandler() => clearField(1);
  ...
  /// +optional
  @$pb.TagNumber(2)
  Overhead get overhead => $_getN(1);
  @$pb.TagNumber(2)
  set overhead(Overhead v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOverhead() => $_has(1);
  @$pb.TagNumber(2)
  void clearOverhead() => clearField(2);
  @$pb.TagNumber(2)
  Overhead ensureOverhead() => $_ensure(1);
  ...
  /// +optional
  @$pb.TagNumber(3)
  Scheduling get scheduling => $_getN(2);
  @$pb.TagNumber(3)
  set scheduling(Scheduling v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasScheduling() => $_has(2);
  @$pb.TagNumber(3)
  void clearScheduling() => clearField(3);
  @$pb.TagNumber(3)
  Scheduling ensureScheduling() => $_ensure(2);
}
...
class Scheduling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Scheduling', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1alpha1'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'nodeSelector', protoName: 'nodeSelector', entryClassName: 'Scheduling.NodeSelectorEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('api.node.v1alpha1'))
