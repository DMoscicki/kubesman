...
class Overhead extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Overhead', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, $0.Quantity>(1, _omitFieldNames ? '' : 'podFixed', protoName: 'podFixed', entryClassName: 'Overhead.PodFixedEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.Quantity.create, valueDefaultOrMaker: $0.Quantity.getDefault, packageName: const $pb.PackageName('api.node.v1beta1'))
...
class RuntimeClass extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeClass', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1beta1'), createEmptyInstance: create)
...
class RuntimeClassList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeClassList', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1beta1'), createEmptyInstance: create)
...
class Scheduling extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Scheduling', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.node.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, _omitFieldNames ? '' : 'nodeSelector', protoName: 'nodeSelector', entryClassName: 'Scheduling.NodeSelectorEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('api.node.v1beta1'))
