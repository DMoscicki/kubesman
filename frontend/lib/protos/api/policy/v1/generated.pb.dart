...
class Eviction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Eviction', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.policy.v1'), createEmptyInstance: create)
...
class PodDisruptionBudget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PodDisruptionBudget', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.policy.v1'), createEmptyInstance: create)
    ..aOM<$0.ObjectMeta>(1, _omitFieldNames ? '' : 'metadata', subBuilder: $0.ObjectMeta.create)
...
class PodDisruptionBudgetList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PodDisruptionBudgetList', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.policy.v1'), createEmptyInstance: create)
...
class PodDisruptionBudgetSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PodDisruptionBudgetSpec', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.policy.v1'), createEmptyInstance: create)
