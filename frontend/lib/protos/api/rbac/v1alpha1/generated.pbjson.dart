...
const ClusterRole$json = {
  ...
  '2': [
    ...
    {'1': 'rules', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1alpha1.PolicyRule', '10': 'rules'},
    {'1': 'aggregationRule', '3': 3, '4': 1, '5': 11, '6': '.api.rbac.v1alpha1.AggregationRule', '10': 'aggregationRule'},
  ],
};
...
final $typed_data.Uint8List clusterRoleDescriptor = $convert.base64Decode(
    ...
    '5tZXRhLnYxLk9iamVjdE1ldGFSCG1ldGFkYXRhEjMKBXJ1bGVzGAIgAygLMh0uYXBpLnJiYWMu'
    'djFhbHBoYTEuUG9saWN5UnVsZVIFcnVsZXMSTAoPYWdncmVnYXRpb25SdWxlGAMgASgLMiIuYX'
    'BpLnJiYWMudjFhbHBoYTEuQWdncmVnYXRpb25SdWxlUg9hZ2dyZWdhdGlvblJ1bGU=');
...
const ClusterRoleBinding$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'subjects', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1alpha1.Subject', '10': 'subjects'},
    {'1': 'roleRef', '3': 3, '4': 1, '5': 11, '6': '.api.rbac.v1alpha1.RoleRef', '10': 'roleRef'},
  ],
};
...
final $typed_data.Uint8List clusterRoleBindingDescriptor = $convert.base64Decode(
    ...
    'tnLmFwaXMubWV0YS52MS5PYmplY3RNZXRhUghtZXRhZGF0YRI2CghzdWJqZWN0cxgCIAMoCzIa'
    'LmFwaS5yYmFjLnYxYWxwaGExLlN1YmplY3RSCHN1YmplY3RzEjQKB3JvbGVSZWYYAyABKAsyGi'
    '5hcGkucmJhYy52MWFscGhhMS5Sb2xlUmVmUgdyb2xlUmVm');
...
const ClusterRoleBindingList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1alpha1.ClusterRoleBinding', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List clusterRoleBindingListDescriptor = $convert.base64Decode(
    ...
    'J5LnBrZy5hcGlzLm1ldGEudjEuTGlzdE1ldGFSCG1ldGFkYXRhEjsKBWl0ZW1zGAIgAygLMiUu'
    'YXBpLnJiYWMudjFhbHBoYTEuQ2x1c3RlclJvbGVCaW5kaW5nUgVpdGVtcw==');
...
const ClusterRoleList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1alpha1.ClusterRole', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List clusterRoleListDescriptor = $convert.base64Decode(
    ...
    'FwaXMubWV0YS52MS5MaXN0TWV0YVIIbWV0YWRhdGESNAoFaXRlbXMYAiADKAsyHi5hcGkucmJh'
    'Yy52MWFscGhhMS5DbHVzdGVyUm9sZVIFaXRlbXM=');
...
const PolicyRule$json = {
  ...
  '2': [
    ...
    {'1': 'apiGroups', '3': 3, '4': 3, '5': 9, '10': 'apiGroups'},
    {'1': 'resources', '3': 4, '4': 3, '5': 9, '10': 'resources'},
    {'1': 'resourceNames', '3': 5, '4': 3, '5': 9, '10': 'resourceNames'},
...
final $typed_data.Uint8List policyRuleDescriptor = $convert.base64Decode(
    'CgpQb2xpY3lSdWxlEhQKBXZlcmJzGAEgAygJUgV2ZXJicxIcCglhcGlHcm91cHMYAyADKAlSCW'
    'FwaUdyb3VwcxIcCglyZXNvdXJjZXMYBCADKAlSCXJlc291cmNlcxIkCg1yZXNvdXJjZU5hbWVz'
    'GAUgAygJUg1yZXNvdXJjZU5hbWVzEigKD25vblJlc291cmNlVVJMcxgGIAMoCVIPbm9uUmVzb3'
    'VyY2VVUkxz');
...
final $typed_data.Uint8List roleDescriptor = $convert.base64Decode(
    ...
    'EuT2JqZWN0TWV0YVIIbWV0YWRhdGESMwoFcnVsZXMYAiADKAsyHS5hcGkucmJhYy52MWFscGhh'
    'MS5Qb2xpY3lSdWxlUgVydWxlcw==');
...
final $typed_data.Uint8List roleBindingDescriptor = $convert.base64Decode(
    ...
    '5tZXRhLnYxLk9iamVjdE1ldGFSCG1ldGFkYXRhEjYKCHN1YmplY3RzGAIgAygLMhouYXBpLnJi'
    'YWMudjFhbHBoYTEuU3ViamVjdFIIc3ViamVjdHMSNAoHcm9sZVJlZhgDIAEoCzIaLmFwaS5yYm'
    'FjLnYxYWxwaGExLlJvbGVSZWZSB3JvbGVSZWY=');
...
const RoleBindingList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1alpha1.RoleBinding', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List roleBindingListDescriptor = $convert.base64Decode(
    ...
    'FwaXMubWV0YS52MS5MaXN0TWV0YVIIbWV0YWRhdGESNAoFaXRlbXMYAiADKAsyHi5hcGkucmJh'
    'Yy52MWFscGhhMS5Sb2xlQmluZGluZ1IFaXRlbXM=');
...
const RoleList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1alpha1.Role', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List roleListDescriptor = $convert.base64Decode(
    ...
    'RhLnYxLkxpc3RNZXRhUghtZXRhZGF0YRItCgVpdGVtcxgCIAMoCzIXLmFwaS5yYmFjLnYxYWxw'
    'aGExLlJvbGVSBWl0ZW1z');
...
final $typed_data.Uint8List subjectDescriptor = $convert.base64Decode(
    'CgdTdWJqZWN0EhIKBGtpbmQYASABKAlSBGtpbmQSHgoKYXBpVmVyc2lvbhgCIAEoCVIKYXBpVm'
    'Vyc2lvbhISCgRuYW1lGAMgASgJUgRuYW1lEhwKCW5hbWVzcGFjZRgEIAEoCVIJbmFtZXNwYWNl');
