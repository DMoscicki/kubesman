...
const ClusterRole$json = {
  ...
  '2': [
    ...
    {'1': 'rules', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1beta1.PolicyRule', '10': 'rules'},
    {'1': 'aggregationRule', '3': 3, '4': 1, '5': 11, '6': '.api.rbac.v1beta1.AggregationRule', '10': 'aggregationRule'},
  ],
};
...
final $typed_data.Uint8List clusterRoleDescriptor = $convert.base64Decode(
    ...
    '5tZXRhLnYxLk9iamVjdE1ldGFSCG1ldGFkYXRhEjIKBXJ1bGVzGAIgAygLMhwuYXBpLnJiYWMu'
    'djFiZXRhMS5Qb2xpY3lSdWxlUgVydWxlcxJLCg9hZ2dyZWdhdGlvblJ1bGUYAyABKAsyIS5hcG'
    'kucmJhYy52MWJldGExLkFnZ3JlZ2F0aW9uUnVsZVIPYWdncmVnYXRpb25SdWxl');
...
const ClusterRoleBinding$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ObjectMeta', '10': 'metadata'},
    {'1': 'subjects', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1beta1.Subject', '10': 'subjects'},
    {'1': 'roleRef', '3': 3, '4': 1, '5': 11, '6': '.api.rbac.v1beta1.RoleRef', '10': 'roleRef'},
  ],
};
...
final $typed_data.Uint8List clusterRoleBindingDescriptor = $convert.base64Decode(
    ...
    'tnLmFwaXMubWV0YS52MS5PYmplY3RNZXRhUghtZXRhZGF0YRI1CghzdWJqZWN0cxgCIAMoCzIZ'
    'LmFwaS5yYmFjLnYxYmV0YTEuU3ViamVjdFIIc3ViamVjdHMSMwoHcm9sZVJlZhgDIAEoCzIZLm'
    'FwaS5yYmFjLnYxYmV0YTEuUm9sZVJlZlIHcm9sZVJlZg==');
...
const ClusterRoleBindingList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1beta1.ClusterRoleBinding', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List clusterRoleBindingListDescriptor = $convert.base64Decode(
    ...
    'YXBpLnJiYWMudjFiZXRhMS5DbHVzdGVyUm9sZUJpbmRpbmdSBWl0ZW1z');
...
const ClusterRoleList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1beta1.ClusterRole', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List clusterRoleListDescriptor = $convert.base64Decode(
    ...
    'FwaXMubWV0YS52MS5MaXN0TWV0YVIIbWV0YWRhdGESMwoFaXRlbXMYAiADKAsyHS5hcGkucmJh'
    'Yy52MWJldGExLkNsdXN0ZXJSb2xlUgVpdGVtcw==');
...
final $typed_data.Uint8List roleDescriptor = $convert.base64Decode(
    ...
    'EuT2JqZWN0TWV0YVIIbWV0YWRhdGESMgoFcnVsZXMYAiADKAsyHC5hcGkucmJhYy52MWJldGEx'
    'LlBvbGljeVJ1bGVSBXJ1bGVz');
...
final $typed_data.Uint8List roleBindingDescriptor = $convert.base64Decode(
    ...
    '5tZXRhLnYxLk9iamVjdE1ldGFSCG1ldGFkYXRhEjUKCHN1YmplY3RzGAIgAygLMhkuYXBpLnJi'
    'YWMudjFiZXRhMS5TdWJqZWN0UghzdWJqZWN0cxIzCgdyb2xlUmVmGAMgASgLMhkuYXBpLnJiYW'
    'MudjFiZXRhMS5Sb2xlUmVmUgdyb2xlUmVm');
...
const RoleBindingList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1beta1.RoleBinding', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List roleBindingListDescriptor = $convert.base64Decode(
    ...
    'FwaXMubWV0YS52MS5MaXN0TWV0YVIIbWV0YWRhdGESMwoFaXRlbXMYAiADKAsyHS5hcGkucmJh'
    'Yy52MWJldGExLlJvbGVCaW5kaW5nUgVpdGVtcw==');
...
const RoleList$json = {
  ...
  '2': [
    {'1': 'metadata', '3': 1, '4': 1, '5': 11, '6': '.apimachinery.pkg.apis.meta.v1.ListMeta', '10': 'metadata'},
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.rbac.v1beta1.Role', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List roleListDescriptor = $convert.base64Decode(
    ...
    'RhLnYxLkxpc3RNZXRhUghtZXRhZGF0YRIsCgVpdGVtcxgCIAMoCzIWLmFwaS5yYmFjLnYxYmV0'
    'YTEuUm9sZVIFaXRlbXM=');
