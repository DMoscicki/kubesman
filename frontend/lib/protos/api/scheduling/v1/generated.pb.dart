...
class PriorityClass extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriorityClass', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.scheduling.v1'), createEmptyInstance: create)
...
class PriorityClassList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PriorityClassList', package: const $pb.PackageName(_omitMessageNames ? '' : 'api.scheduling.v1'), createEmptyInstance: create)
