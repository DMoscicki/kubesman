...
const PriorityClassList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.scheduling.v1alpha1.PriorityClass', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List priorityClassListDescriptor = $convert.base64Decode(
    ...
    'cuYXBpcy5tZXRhLnYxLkxpc3RNZXRhUghtZXRhZGF0YRI8CgVpdGVtcxgCIAMoCzImLmFwaS5z'
    'Y2hlZHVsaW5nLnYxYWxwaGExLlByaW9yaXR5Q2xhc3NSBWl0ZW1z');
