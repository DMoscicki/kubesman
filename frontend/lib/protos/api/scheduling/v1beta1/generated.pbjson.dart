...
const PriorityClassList$json = {
  ...
  '2': [
    ...
    {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.api.scheduling.v1beta1.PriorityClass', '10': 'items'},
  ],
};
...
final $typed_data.Uint8List priorityClassListDescriptor = $convert.base64Decode(
    ...
    'cuYXBpcy5tZXRhLnYxLkxpc3RNZXRhUghtZXRhZGF0YRI7CgVpdGVtcxgCIAMoCzIlLmFwaS5z'
    'Y2hlZHVsaW5nLnYxYmV0YTEuUHJpb3JpdHlDbGFzc1IFaXRlbXM=');
