...
class ContainerMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ContainerMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'metrics.pkg.apis.metrics.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..m<$core.String, $0.Quantity>(2, _omitFieldNames ? '' : 'usage', entryClassName: 'ContainerMetrics.UsageEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.Quantity.create, valueDefaultOrMaker: $0.Quantity.getDefault, packageName: const $pb.PackageName('metrics.pkg.apis.metrics.v1alpha1'))
...
class NodeMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NodeMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'metrics.pkg.apis.metrics.v1alpha1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $0.Quantity>(4, _omitFieldNames ? '' : 'usage', entryClassName: 'NodeMetrics.UsageEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.Quantity.create, valueDefaultOrMaker: $0.Quantity.getDefault, packageName: const $pb.PackageName('metrics.pkg.apis.metrics.v1alpha1'))
    ..hasRequiredFields = false
  ;
...
class NodeMetricsList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'NodeMetricsList', package: const $pb.PackageName(_omitMessageNames ? '' : 'metrics.pkg.apis.metrics.v1alpha1'), createEmptyInstance: create)
...
class PodMetrics extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PodMetrics', package: const $pb.PackageName(_omitMessageNames ? '' : 'metrics.pkg.apis.metrics.v1alpha1'), createEmptyInstance: create)
    ..aOM<$1.ObjectMeta>(1, _omitFieldNames ? '' : 'metadata', subBuilder: $1.ObjectMeta.create)
    ..aOM<$1.Time>(2, _omitFieldNames ? '' : 'timestamp', subBuilder: $1.Time.create)
    ..aOM<$1.Duration>(3, _omitFieldNames ? '' : 'window', subBuilder: $1.Duration.create)
...
class PodMetricsList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PodMetricsList', package: const $pb.PackageName(_omitMessageNames ? '' : 'metrics.pkg.apis.metrics.v1alpha1'), createEmptyInstance: create)
    ..aOM<$1.ListMeta>(1, _omitFieldNames ? '' : 'metadata', subBuilder: $1.ListMeta.create)
