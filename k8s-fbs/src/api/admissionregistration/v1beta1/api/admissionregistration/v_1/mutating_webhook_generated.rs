...
use super::*;
pub enum MutatingWebhookOffset {}
#[derive(Copy, Clone, PartialEq)]

pub struct MutatingWebhook<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for MutatingWebhook<'a> {
  type Inner = MutatingWebhook<'a>;
  #[inline]
...
impl<'a> MutatingWebhook<'a> {
  ...
  pub const VT_REINVOCATIONPOLICY: flatbuffers::VOffsetT = 24;
  pub const VT_MATCHCONDITIONS: flatbuffers::VOffsetT = 26;

  #[inline]
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    MutatingWebhook { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args MutatingWebhookArgs<'args>
  ) -> flatbuffers::WIPOffset<MutatingWebhook<'bldr>> {
    let mut builder = MutatingWebhookBuilder::new(_fbb);
    if let Some(x) = args.matchConditions { builder.add_matchConditions(x); }
    if let Some(x) = args.reinvocationPolicy { builder.add_reinvocationPolicy(x); }
  ...
  pub fn name(&self) -> &'a str {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MutatingWebhook::VT_NAME, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn clientConfig(&self) -> WebhookClientConfig<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<WebhookClientConfig>>(MutatingWebhook::VT_CLIENTCONFIG, Some(Default::default())).unwrap()}
  }
  #[inline]
  pub fn rules(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RuleWithOperations<'a>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RuleWithOperations>>>>(MutatingWebhook::VT_RULES, Some(Default::default())).unwrap()}
  }
  #[inline]
  pub fn failurePolicy(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MutatingWebhook::VT_FAILUREPOLICY, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn matchPolicy(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MutatingWebhook::VT_MATCHPOLICY, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn namespaceSelector(&self) -> super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector>>(MutatingWebhook::VT_NAMESPACESELECTOR, Some(Default::default())).unwrap()}
  }
  #[inline]
  pub fn objectSelector(&self) -> super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector>>(MutatingWebhook::VT_OBJECTSELECTOR, Some(Default::default())).unwrap()}
  }
  #[inline]
  pub fn sideEffects(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MutatingWebhook::VT_SIDEEFFECTS, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn timeoutSeconds(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(MutatingWebhook::VT_TIMEOUTSECONDS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn admissionReviewVersions(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MutatingWebhook::VT_ADMISSIONREVIEWVERSIONS, Some(Default::default())).unwrap()}
  }
  #[inline]
  pub fn reinvocationPolicy(&self) -> &'a str {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MutatingWebhook::VT_REINVOCATIONPOLICY, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn matchConditions(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MatchCondition<'a>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MatchCondition>>>>(MutatingWebhook::VT_MATCHCONDITIONS, Some(Default::default())).unwrap()}
  }
}

impl flatbuffers::Verifiable for MutatingWebhook<'_> {
  #[inline]
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RuleWithOperations>>>>("rules", Self::VT_RULES, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("reinvocationPolicy", Self::VT_REINVOCATIONPOLICY, false)?
...
pub struct MutatingWebhookArgs<'a> {
    pub name: Option<flatbuffers::WIPOffset<&'a str>>,
    pub clientConfig: Option<flatbuffers::WIPOffset<WebhookClientConfig<'a>>>,
    pub rules: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RuleWithOperations<'a>>>>>,
...
impl Serialize for MutatingWebhook<'_> {
  fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("MutatingWebhook", 12)?;
      ...
      s.serialize_field("reinvocationPolicy", &self.reinvocationPolicy())?;
      s.serialize_field("matchConditions", &self.matchConditions())?;
    s.end()
  }
}

pub struct MutatingWebhookBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MutatingWebhookBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_NAME, name);
  }
  #[inline]
  pub fn add_clientConfig(&mut self, clientConfig: flatbuffers::WIPOffset<WebhookClientConfig<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<WebhookClientConfig>>(MutatingWebhook::VT_CLIENTCONFIG, clientConfig);
  }
  #[inline]
  pub fn add_rules(&mut self, rules: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<RuleWithOperations<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_RULES, rules);
  }
  #[inline]
  pub fn add_failurePolicy(&mut self, failurePolicy: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_FAILUREPOLICY, failurePolicy);
  }
  #[inline]
  pub fn add_matchPolicy(&mut self, matchPolicy: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_MATCHPOLICY, matchPolicy);
  }
  #[inline]
  pub fn add_namespaceSelector(&mut self, namespaceSelector: flatbuffers::WIPOffset<super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector>>(MutatingWebhook::VT_NAMESPACESELECTOR, namespaceSelector);
  }
  #[inline]
  pub fn add_objectSelector(&mut self, objectSelector: flatbuffers::WIPOffset<super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<super::super::super::apimachinery::pkg::apis::meta::v_1::LabelSelector>>(MutatingWebhook::VT_OBJECTSELECTOR, objectSelector);
  }
  #[inline]
  pub fn add_sideEffects(&mut self, sideEffects: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_SIDEEFFECTS, sideEffects);
  }
  #[inline]
  pub fn add_timeoutSeconds(&mut self, timeoutSeconds: i32) {
    self.fbb_.push_slot::<i32>(MutatingWebhook::VT_TIMEOUTSECONDS, timeoutSeconds, 0);
  }
  #[inline]
  pub fn add_admissionReviewVersions(&mut self, admissionReviewVersions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_ADMISSIONREVIEWVERSIONS, admissionReviewVersions);
  }
  #[inline]
  pub fn add_reinvocationPolicy(&mut self, reinvocationPolicy: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_REINVOCATIONPOLICY, reinvocationPolicy);
  }
  #[inline]
  pub fn add_matchConditions(&mut self, matchConditions: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MatchCondition<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MutatingWebhook::VT_MATCHCONDITIONS, matchConditions);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MutatingWebhookBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<MutatingWebhook<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for MutatingWebhook<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("MutatingWebhook");
      ...
      ds.field("reinvocationPolicy", &self.reinvocationPolicy());
