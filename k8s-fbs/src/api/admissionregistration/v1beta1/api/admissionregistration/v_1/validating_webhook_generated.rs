...
impl<'a> ValidatingWebhook<'a> {
  ...
  pub fn rules(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RuleWithOperations<'a>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RuleWithOperations>>>>(ValidatingWebhook::VT_RULES, Some(Default::default())).unwrap()}
  }
  #[inline]
