...
impl<'a> MutatingWebhook<'a> {
  ...
  pub fn rules(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<super::v_1::RuleWithOperations<'a>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<super::v_1::RuleWithOperations>>>>(MutatingWebhook::VT_RULES, Some(Default::default())).unwrap()}
  }
  #[inline]
