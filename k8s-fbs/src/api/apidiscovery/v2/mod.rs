...
pub mod api {
  ...
  pub mod apidiscovery {
    ...
    pub mod v_2 {
      use super::*;
      mod apigroup_discovery_generated;
      pub use self::apigroup_discovery_generated::*;
      mod apigroup_discovery_list_generated;
      pub use self::apigroup_discovery_list_generated::*;
      mod apiresource_discovery_generated;
      pub use self::apiresource_discovery_generated::*;
      mod apisubresource_discovery_generated;
      pub use self::apisubresource_discovery_generated::*;
      mod apiversion_discovery_generated;
      pub use self::apiversion_discovery_generated::*;
    } // v_2
  } // apidiscovery
} // api
