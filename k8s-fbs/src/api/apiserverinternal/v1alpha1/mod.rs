...
pub mod api {
  ...
  pub mod apiserverinternal {
    ...
    pub mod v_1alpha_1 {
      use super::*;
      mod server_storage_version_generated;
      pub use self::server_storage_version_generated::*;
      mod storage_version_generated;
      pub use self::storage_version_generated::*;
      mod storage_version_condition_generated;
      pub use self::storage_version_condition_generated::*;
      mod storage_version_list_generated;
      pub use self::storage_version_list_generated::*;
      mod storage_version_spec_generated;
      pub use self::storage_version_spec_generated::*;
      mod storage_version_status_generated;
      pub use self::storage_version_status_generated::*;
    } // v_1alpha_1
  } // apiserverinternal
} // api
