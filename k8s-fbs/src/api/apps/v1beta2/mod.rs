...
pub mod api {
  ...
  pub mod apps {
    ...
    pub mod v_1beta_2 {
      ...
      mod controller_revision_generated;
      pub use self::controller_revision_generated::*;
      mod controller_revision_list_generated;
      pub use self::controller_revision_list_generated::*;
      ...
      mod rolling_update_stateful_set_strategy_generated;
      pub use self::rolling_update_stateful_set_strategy_generated::*;
      mod scale_generated;
      ...
      mod stateful_set_generated;
      pub use self::stateful_set_generated::*;
      mod stateful_set_condition_generated;
      pub use self::stateful_set_condition_generated::*;
      mod stateful_set_list_generated;
      pub use self::stateful_set_list_generated::*;
      mod stateful_set_ordinals_generated;
      pub use self::stateful_set_ordinals_generated::*;
      mod stateful_set_persistent_volume_claim_retention_policy_generated;
      pub use self::stateful_set_persistent_volume_claim_retention_policy_generated::*;
      mod stateful_set_spec_generated;
      pub use self::stateful_set_spec_generated::*;
      mod stateful_set_status_generated;
      pub use self::stateful_set_status_generated::*;
      mod stateful_set_update_strategy_generated;
      pub use self::stateful_set_update_strategy_generated::*;
    } // v_1beta_2
  } // apps
  pub mod core {
    use super::*;
