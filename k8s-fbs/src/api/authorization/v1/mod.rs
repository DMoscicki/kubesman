...
pub mod api {
  ...
  pub mod authorization {
    ...
    pub mod v_1 {
      use super::*;
      pub mod subject_access_review_spec_ {
        use super::*;
        mod extra_entry_generated;
        pub use self::extra_entry_generated::*;
      } // subject_access_review_spec_
      mod extra_value_generated;
      pub use self::extra_value_generated::*;
      mod local_subject_access_review_generated;
      pub use self::local_subject_access_review_generated::*;
      mod non_resource_attributes_generated;
      pub use self::non_resource_attributes_generated::*;
      mod non_resource_rule_generated;
      pub use self::non_resource_rule_generated::*;
      mod resource_attributes_generated;
      pub use self::resource_attributes_generated::*;
      mod resource_rule_generated;
      pub use self::resource_rule_generated::*;
      mod self_subject_access_review_generated;
      pub use self::self_subject_access_review_generated::*;
      mod self_subject_access_review_spec_generated;
      pub use self::self_subject_access_review_spec_generated::*;
      mod self_subject_rules_review_generated;
      pub use self::self_subject_rules_review_generated::*;
      mod self_subject_rules_review_spec_generated;
      pub use self::self_subject_rules_review_spec_generated::*;
      mod subject_access_review_generated;
      pub use self::subject_access_review_generated::*;
      mod subject_access_review_spec_generated;
      pub use self::subject_access_review_spec_generated::*;
      mod subject_access_review_status_generated;
      pub use self::subject_access_review_status_generated::*;
      mod subject_rules_review_status_generated;
      pub use self::subject_rules_review_status_generated::*;
    } // v_1
  } // authorization
} // api
