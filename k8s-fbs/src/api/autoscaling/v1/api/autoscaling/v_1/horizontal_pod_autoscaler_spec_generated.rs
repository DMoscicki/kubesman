...
impl<'a> HorizontalPodAutoscalerSpec<'a> {
  ...
  pub const VT_TARGETCPUUTILIZATIONPERCENTAGE: flatbuffers::VOffsetT = 10;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_targetCPUUtilizationPercentage(args.targetCPUUtilizationPercentage);
  ...
  pub fn targetCPUUtilizationPercentage(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(HorizontalPodAutoscalerSpec::VT_TARGETCPUUTILIZATIONPERCENTAGE, Some(0)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for HorizontalPodAutoscalerSpec<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i32>("targetCPUUtilizationPercentage", Self::VT_TARGETCPUUTILIZATIONPERCENTAGE, false)?
     .finish();
    Ok(())
  }
}
pub struct HorizontalPodAutoscalerSpecArgs<'a> {
    ...
    pub minReplicas: i32,
    pub maxReplicas: i32,
    pub targetCPUUtilizationPercentage: i32,
}
...
impl Serialize for HorizontalPodAutoscalerSpec<'_> {
  ...
  where
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("HorizontalPodAutoscalerSpec", 4)?;
      ...
      s.serialize_field("targetCPUUtilizationPercentage", &self.targetCPUUtilizationPercentage())?;
    s.end()
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HorizontalPodAutoscalerSpecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_targetCPUUtilizationPercentage(&mut self, targetCPUUtilizationPercentage: i32) {
    self.fbb_.push_slot::<i32>(HorizontalPodAutoscalerSpec::VT_TARGETCPUUTILIZATIONPERCENTAGE, targetCPUUtilizationPercentage, 0);
  }
  #[inline]
...
impl core::fmt::Debug for HorizontalPodAutoscalerSpec<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("HorizontalPodAutoscalerSpec");
      ...
      ds.field("targetCPUUtilizationPercentage", &self.targetCPUUtilizationPercentage());
      ds.finish()
  }
}
