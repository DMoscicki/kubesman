...
pub mod api {
  ...
  pub mod batch {
    ...
    pub mod v_1 {
      use super::*;
      mod cron_job_generated;
      pub use self::cron_job_generated::*;
      mod cron_job_list_generated;
      pub use self::cron_job_list_generated::*;
      mod cron_job_spec_generated;
      pub use self::cron_job_spec_generated::*;
      mod cron_job_status_generated;
      pub use self::cron_job_status_generated::*;
      mod job_generated;
      pub use self::job_generated::*;
      mod job_condition_generated;
      pub use self::job_condition_generated::*;
      mod job_list_generated;
      pub use self::job_list_generated::*;
      mod job_spec_generated;
      pub use self::job_spec_generated::*;
      mod job_status_generated;
      pub use self::job_status_generated::*;
      mod job_template_spec_generated;
      pub use self::job_template_spec_generated::*;
      mod pod_failure_policy_generated;
      pub use self::pod_failure_policy_generated::*;
      mod pod_failure_policy_on_exit_codes_requirement_generated;
      pub use self::pod_failure_policy_on_exit_codes_requirement_generated::*;
      mod pod_failure_policy_on_pod_conditions_pattern_generated;
      pub use self::pod_failure_policy_on_pod_conditions_pattern_generated::*;
      mod pod_failure_policy_rule_generated;
      pub use self::pod_failure_policy_rule_generated::*;
      mod success_policy_generated;
      pub use self::success_policy_generated::*;
      mod success_policy_rule_generated;
      pub use self::success_policy_rule_generated::*;
      mod uncounted_terminated_pods_generated;
      pub use self::uncounted_terminated_pods_generated::*;
    } // v_1
  } // batch
  pub mod core {
    use super::*;
