...
impl<'a> DataEntry<'a> {
  ...
  pub fn key(&self) -> &'a str {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(DataEntry::VT_KEY, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &DataEntry) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> flatbuffers::Vector<'a, u8> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(DataEntry::VT_VALUE, Some(Default::default())).unwrap()}
  }
}
...
pub struct DataEntryBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DataEntryBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(DataEntry::VT_KEY, key);
  }
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> DataEntryBuilder<'a, 'b, A> {
