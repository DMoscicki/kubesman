...
pub mod api {
  ...
  pub mod certificates {
    ...
    pub mod v_1 {
      use super::*;
      pub mod certificate_signing_request_spec_ {
        use super::*;
        mod extra_entry_generated;
        pub use self::extra_entry_generated::*;
      } // certificate_signing_request_spec_
      mod certificate_signing_request_generated;
      pub use self::certificate_signing_request_generated::*;
      mod certificate_signing_request_condition_generated;
      pub use self::certificate_signing_request_condition_generated::*;
      mod certificate_signing_request_list_generated;
      pub use self::certificate_signing_request_list_generated::*;
      mod certificate_signing_request_spec_generated;
      pub use self::certificate_signing_request_spec_generated::*;
      mod certificate_signing_request_status_generated;
      pub use self::certificate_signing_request_status_generated::*;
