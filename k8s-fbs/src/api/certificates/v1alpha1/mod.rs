...
pub mod api {
  ...
  pub mod certificates {
    ...
    pub mod v_1alpha_1 {
      use super::*;
      mod cluster_trust_bundle_generated;
      pub use self::cluster_trust_bundle_generated::*;
      mod cluster_trust_bundle_list_generated;
      pub use self::cluster_trust_bundle_list_generated::*;
      mod cluster_trust_bundle_spec_generated;
      pub use self::cluster_trust_bundle_spec_generated::*;
    } // v_1alpha_1
  } // certificates
} // api
