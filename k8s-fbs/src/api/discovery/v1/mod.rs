...
pub mod api {
  ...
  pub mod discovery {
    ...
    pub mod v_1 {
      ...
      pub mod endpoint_ {
        use super::*;
        mod deprecated_topology_entry_generated;
        pub use self::deprecated_topology_entry_generated::*;
      } // endpoint_
      mod endpoint_generated;
      pub use self::endpoint_generated::*;
      mod endpoint_conditions_generated;
      pub use self::endpoint_conditions_generated::*;
      mod endpoint_hints_generated;
      pub use self::endpoint_hints_generated::*;
      mod endpoint_port_generated;
      pub use self::endpoint_port_generated::*;
      mod endpoint_slice_generated;
      pub use self::endpoint_slice_generated::*;
      mod endpoint_slice_list_generated;
      pub use self::endpoint_slice_list_generated::*;
      mod for_zone_generated;
      pub use self::for_zone_generated::*;
    } // v_1
  } // discovery
} // api
