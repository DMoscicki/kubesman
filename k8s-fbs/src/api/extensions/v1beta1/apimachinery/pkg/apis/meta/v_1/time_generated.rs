...
impl<'a> Time<'a> {
  ...
  pub fn seconds(&self) -> i64 {
    ...
    unsafe { self._tab.get::<i64>(Time::VT_SECONDS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn nanos(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(Time::VT_NANOS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TimeBuilder<'a, 'b, A> {
  ...
  pub fn add_seconds(&mut self, seconds: i64) {
    self.fbb_.push_slot::<i64>(Time::VT_SECONDS, seconds, 0);
  }
  #[inline]
  pub fn add_nanos(&mut self, nanos: i32) {
    self.fbb_.push_slot::<i32>(Time::VT_NANOS, nanos, 0);
  }
  #[inline]
