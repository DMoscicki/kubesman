...
impl<'a> LimitedPriorityLevelConfiguration<'a> {
  pub const VT_ASSUREDCONCURRENCYSHARES: flatbuffers::VOffsetT = 4;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_assuredConcurrencyShares(args.assuredConcurrencyShares);
    builder.finish()
  }
  ...
  pub fn assuredConcurrencyShares(&self) -> i32 {
    ...
    unsafe { self._tab.get::<i32>(LimitedPriorityLevelConfiguration::VT_ASSUREDCONCURRENCYSHARES, Some(0)).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for LimitedPriorityLevelConfiguration<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<i32>("assuredConcurrencyShares", Self::VT_ASSUREDCONCURRENCYSHARES, false)?
...
pub struct LimitedPriorityLevelConfigurationArgs<'a> {
    pub assuredConcurrencyShares: i32,
...
impl Serialize for LimitedPriorityLevelConfiguration<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("LimitedPriorityLevelConfiguration", 4)?;
      s.serialize_field("assuredConcurrencyShares", &self.assuredConcurrencyShares())?;
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LimitedPriorityLevelConfigurationBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_assuredConcurrencyShares(&mut self, assuredConcurrencyShares: i32) {
    self.fbb_.push_slot::<i32>(LimitedPriorityLevelConfiguration::VT_ASSUREDCONCURRENCYSHARES, assuredConcurrencyShares, 0);
  }
  #[inline]
...
impl core::fmt::Debug for LimitedPriorityLevelConfiguration<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("LimitedPriorityLevelConfiguration");
      ds.field("assuredConcurrencyShares", &self.assuredConcurrencyShares());
