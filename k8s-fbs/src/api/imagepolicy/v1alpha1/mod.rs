...
pub mod api {
  ...
  pub mod imagepolicy {
    ...
    pub mod v_1alpha_1 {
      use super::*;
      pub mod image_review_spec_ {
        use super::*;
        mod annotations_entry_generated;
        pub use self::annotations_entry_generated::*;
      } // image_review_spec_
      pub mod image_review_status_ {
        use super::*;
        mod audit_annotations_entry_generated;
        pub use self::audit_annotations_entry_generated::*;
      } // image_review_status_
      mod image_review_generated;
      pub use self::image_review_generated::*;
      mod image_review_container_spec_generated;
      pub use self::image_review_container_spec_generated::*;
      mod image_review_spec_generated;
      pub use self::image_review_spec_generated::*;
      mod image_review_status_generated;
      pub use self::image_review_status_generated::*;
    } // v_1alpha_1
  } // imagepolicy
} // api
