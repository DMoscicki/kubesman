...
impl<'a> IngressSpec<'a> {
  ...
  pub const VT_DEFAULTBACKEND: flatbuffers::VOffsetT = 6;
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.defaultBackend { builder.add_defaultBackend(x); }
  ...
  #[inline]
  pub fn defaultBackend(&self) -> IngressBackend<'a> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<IngressBackend>>(IngressSpec::VT_DEFAULTBACKEND, Some(Default::default())).unwrap()}
  }
  #[inline]
...
impl flatbuffers::Verifiable for IngressSpec<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<IngressBackend>>("defaultBackend", Self::VT_DEFAULTBACKEND, false)?
...
pub struct IngressSpecArgs<'a> {
    ...
    pub defaultBackend: Option<flatbuffers::WIPOffset<IngressBackend<'a>>>,
...
impl Serialize for IngressSpec<'_> {
    ...
    S: Serializer,
  {
    let mut s = serializer.serialize_struct("IngressSpec", 4)?;
      ...
      s.serialize_field("defaultBackend", &self.defaultBackend())?;
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> IngressSpecBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_defaultBackend(&mut self, defaultBackend: flatbuffers::WIPOffset<IngressBackend<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<IngressBackend>>(IngressSpec::VT_DEFAULTBACKEND, defaultBackend);
  }
  #[inline]
...
impl core::fmt::Debug for IngressSpec<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("IngressSpec");
      ...
      ds.field("defaultBackend", &self.defaultBackend());
