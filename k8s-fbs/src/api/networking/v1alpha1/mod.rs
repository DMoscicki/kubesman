...
pub mod api {
  ...
  pub mod networking {
    ...
    pub mod v_1alpha_1 {
      ...
      mod ipaddress_list_generated;
      pub use self::ipaddress_list_generated::*;
      mod ipaddress_spec_generated;
      pub use self::ipaddress_spec_generated::*;
      mod parent_reference_generated;
      pub use self::parent_reference_generated::*;
      mod service_cidr_generated;
      pub use self::service_cidr_generated::*;
      mod service_cidrlist_generated;
      pub use self::service_cidrlist_generated::*;
      mod service_cidrspec_generated;
      pub use self::service_cidrspec_generated::*;
      mod service_cidrstatus_generated;
      pub use self::service_cidrstatus_generated::*;
    } // v_1alpha_1
  } // networking
} // api
