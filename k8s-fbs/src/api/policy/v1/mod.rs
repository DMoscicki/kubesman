...
pub mod api {
  ...
  pub mod policy {
    ...
    pub mod v_1 {
      use super::*;
      pub mod pod_disruption_budget_status_ {
        use super::*;
        mod disrupted_pods_entry_generated;
        pub use self::disrupted_pods_entry_generated::*;
      } // pod_disruption_budget_status_
      mod eviction_generated;
      pub use self::eviction_generated::*;
      mod pod_disruption_budget_generated;
      pub use self::pod_disruption_budget_generated::*;
      mod pod_disruption_budget_list_generated;
      pub use self::pod_disruption_budget_list_generated::*;
      mod pod_disruption_budget_spec_generated;
      pub use self::pod_disruption_budget_spec_generated::*;
      mod pod_disruption_budget_status_generated;
      pub use self::pod_disruption_budget_status_generated::*;
    } // v_1
  } // policy
} // api
