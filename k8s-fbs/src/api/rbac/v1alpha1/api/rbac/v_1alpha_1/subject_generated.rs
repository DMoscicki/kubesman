...
impl<'a> Subject<'a> {
  ...
  pub fn apiVersion(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Subject::VT_APIVERSION, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn name(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Subject::VT_NAME, Some(&"0")).unwrap()}
  }
  #[inline]
  pub fn namespace(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Subject::VT_NAMESPACE, Some(&"0")).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SubjectBuilder<'a, 'b, A> {
  ...
  pub fn add_apiVersion(&mut self, apiVersion: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Subject::VT_APIVERSION, apiVersion);
  }
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Subject::VT_NAME, name);
  }
  #[inline]
  pub fn add_namespace(&mut self, namespace: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Subject::VT_NAMESPACE, namespace);
  }
  #[inline]
