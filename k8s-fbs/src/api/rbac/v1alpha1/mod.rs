...
pub mod api {
  ...
  pub mod rbac {
    ...
    pub mod v_1alpha_1 {
      use super::*;
      mod aggregation_rule_generated;
      pub use self::aggregation_rule_generated::*;
      mod cluster_role_generated;
      pub use self::cluster_role_generated::*;
      mod cluster_role_binding_generated;
      pub use self::cluster_role_binding_generated::*;
      mod cluster_role_binding_list_generated;
      pub use self::cluster_role_binding_list_generated::*;
      mod cluster_role_list_generated;
      pub use self::cluster_role_list_generated::*;
      mod policy_rule_generated;
      pub use self::policy_rule_generated::*;
      mod role_generated;
      pub use self::role_generated::*;
      mod role_binding_generated;
      pub use self::role_binding_generated::*;
      mod role_binding_list_generated;
      pub use self::role_binding_list_generated::*;
      mod role_list_generated;
      pub use self::role_list_generated::*;
      mod role_ref_generated;
      pub use self::role_ref_generated::*;
