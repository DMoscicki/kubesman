...
pub mod api {
  ...
  pub mod storage {
    ...
    pub mod v_1beta_1 {
      use super::*;
      pub mod storage_class_ {
        use super::*;
        mod parameters_entry_generated;
        pub use self::parameters_entry_generated::*;
      } // storage_class_
      pub mod volume_attachment_status_ {
        use super::*;
        mod attachment_metadata_entry_generated;
        pub use self::attachment_metadata_entry_generated::*;
      } // volume_attachment_status_
      mod csidriver_generated;
      pub use self::csidriver_generated::*;
      mod csidriver_list_generated;
      pub use self::csidriver_list_generated::*;
      mod csidriver_spec_generated;
      pub use self::csidriver_spec_generated::*;
      mod csinode_generated;
      pub use self::csinode_generated::*;
      mod csinode_driver_generated;
      pub use self::csinode_driver_generated::*;
      mod csinode_list_generated;
      pub use self::csinode_list_generated::*;
      mod csinode_spec_generated;
      pub use self::csinode_spec_generated::*;
      mod csistorage_capacity_generated;
      pub use self::csistorage_capacity_generated::*;
      mod csistorage_capacity_list_generated;
      pub use self::csistorage_capacity_list_generated::*;
      mod storage_class_generated;
      pub use self::storage_class_generated::*;
      mod storage_class_list_generated;
      pub use self::storage_class_list_generated::*;
      mod token_request_generated;
      pub use self::token_request_generated::*;
      mod volume_attachment_generated;
      pub use self::volume_attachment_generated::*;
      mod volume_attachment_list_generated;
      pub use self::volume_attachment_list_generated::*;
      mod volume_attachment_source_generated;
      pub use self::volume_attachment_source_generated::*;
      mod volume_attachment_spec_generated;
      pub use self::volume_attachment_spec_generated::*;
      mod volume_attachment_status_generated;
      pub use self::volume_attachment_status_generated::*;
      mod volume_error_generated;
      pub use self::volume_error_generated::*;
      mod volume_node_resources_generated;
      pub use self::volume_node_resources_generated::*;
    } // v_1beta_1
  } // storage
} // api
