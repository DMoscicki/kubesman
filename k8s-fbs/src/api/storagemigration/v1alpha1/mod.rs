...
pub mod api {
  ...
  pub mod storagemigration {
    ...
    pub mod v_1alpha_1 {
      ...
      mod migration_condition_generated;
      pub use self::migration_condition_generated::*;
      mod storage_version_migration_generated;
      pub use self::storage_version_migration_generated::*;
      mod storage_version_migration_list_generated;
      pub use self::storage_version_migration_list_generated::*;
      mod storage_version_migration_spec_generated;
      pub use self::storage_version_migration_spec_generated::*;
      mod storage_version_migration_status_generated;
      pub use self::storage_version_migration_status_generated::*;
    } // v_1alpha_1
  } // storagemigration
} // api
