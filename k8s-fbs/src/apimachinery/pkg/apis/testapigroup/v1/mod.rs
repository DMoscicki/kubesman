    ...
    pub mod apis {
      ...
      pub mod testapigroup {
        ...
        pub mod v_1 {
          ...
          mod carp_generated;
          pub use self::carp_generated::*;
          mod carp_condition_generated;
          pub use self::carp_condition_generated::*;
          mod carp_list_generated;
          pub use self::carp_list_generated::*;
          mod carp_spec_generated;
          pub use self::carp_spec_generated::*;
          mod carp_status_generated;
          pub use self::carp_status_generated::*;
        } // v_1
      } // testapigroup
    } // apis
    pub mod runtime {
