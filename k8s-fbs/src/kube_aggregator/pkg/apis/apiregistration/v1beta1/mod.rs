  ...
  pub mod pkg {
    ...
    pub mod apis {
      ...
      pub mod apiregistration {
        ...
        pub mod v_1beta_1 {
          use super::*;
          mod apiservice_generated;
          pub use self::apiservice_generated::*;
          mod apiservice_condition_generated;
          pub use self::apiservice_condition_generated::*;
          mod apiservice_list_generated;
          pub use self::apiservice_list_generated::*;
          mod apiservice_spec_generated;
          pub use self::apiservice_spec_generated::*;
          mod apiservice_status_generated;
          pub use self::apiservice_status_generated::*;
