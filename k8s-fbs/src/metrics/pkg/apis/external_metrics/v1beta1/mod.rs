  ...
  pub mod pkg {
    ...
    pub mod apis {
      ...
      pub mod external_metrics {
        ...
        pub mod v_1beta_1 {
          use super::*;
          pub mod external_metric_value_ {
            use super::*;
            mod metric_labels_entry_generated;
            pub use self::metric_labels_entry_generated::*;
          } // external_metric_value_
          mod external_metric_value_generated;
          pub use self::external_metric_value_generated::*;
          mod external_metric_value_list_generated;
          pub use self::external_metric_value_list_generated::*;
        } // v_1beta_1
      } // external_metrics
    } // apis
  } // pkg
