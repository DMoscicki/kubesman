  ...
  pub mod pkg {
    ...
    pub mod apis {
      ...
      pub mod metrics {
        ...
        pub mod v_1beta_1 {
          use super::*;
          pub mod container_metrics_ {
            use super::*;
            mod usage_entry_generated;
            pub use self::usage_entry_generated::*;
          } // container_metrics_
          pub mod node_metrics_ {
            use super::*;
            mod usage_entry_generated;
            pub use self::usage_entry_generated::*;
          } // node_metrics_
          mod container_metrics_generated;
          pub use self::container_metrics_generated::*;
          mod node_metrics_generated;
          pub use self::node_metrics_generated::*;
          mod node_metrics_list_generated;
          pub use self::node_metrics_list_generated::*;
          mod pod_metrics_generated;
          pub use self::pod_metrics_generated::*;
          mod pod_metrics_list_generated;
          pub use self::pod_metrics_list_generated::*;
        } // v_1beta_1
      } // metrics
    } // apis
  } // pkg
